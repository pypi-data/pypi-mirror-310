...
from edri.config.setting import TOKEN_LENGTH, ENVIRONMENT
...
class EDRI:
    ...
    def start_api(self, middlewares: list[Middleware] | None = None, json_encoder: Type[JSONEncoder] | None = None) -> None:
        """
        ...
        if json_encoder is None:
            from edri.utility.json_encoder import JSONEncoder

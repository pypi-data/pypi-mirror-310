...
class local_optimize(optimize_base):
    ...
    def optimization(self):
        ...
        print("cost : ")
        print(self._func(self.x_optimize,*self._args))
        print("\n")
...
def _main():
    ...
    opt1 = local_optimize(func,init,args = (a,b,c,d,),bounds = bounds,max_run = 100,delay = 0.02,method = method1,val_only = True, log = "inherit",msg = None)
    opt1.optimization()
    opt2 = local_optimize(func,init,args = (a,b,c,d,),bounds = bounds,max_run = 10,delay = 0.02,method = method2,val_only = True, log = True,msg = None,opt_inherit = opt1)

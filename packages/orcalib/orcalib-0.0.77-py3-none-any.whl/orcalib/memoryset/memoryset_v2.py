...
class LabeledMemorysetV2:
    ...
    def __init__(
        ...
        previous_config = disconnected_repository.get_config()
    ...
    def to_list(self, limit: int | None = None) -> list[LabeledMemory]:
        ...
        """
        return self.repository.to_list(limit)
    ...
    def insert(
        ...
        *,
        ...
        for chunk in chunked(transformed_data, batch_size):
            self.repository.insert(list(chunk))
    ...
    def lookup(
        ...
        *,
        ...
        if count == 0:
            ...
            memories_batch = self.repository.lookup(embedded_query, k=count, use_cache=use_cache)
            if not all(len(memories) == count for memories in memories_batch):
    ...
    def get(self, memory_id: str, exists: bool = False) -> LabeledMemory | None:
        ...
        """
        memory = self.repository[memory_id]
    ...
    def update(self, memory_id: str, updates: dict[str, Any]) -> None:
        ...
        self.repository.upsert(transformed_memory)

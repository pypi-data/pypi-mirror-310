...
class EmbeddingTrainingArgumentsForClassification(EmbeddingTrainingArguments):
...
def finetune_for_classification(
    ...
    training_args: EmbeddingTrainingArguments = EmbeddingTrainingArgumentsForClassification(),
) -> None:
    """
    ...
    max_seq_length = min(
        ...
        training_args.max_seq_length or tokenizer.model_max_length,
    )
...
class EmbeddingTrainingArgumentsWithTriplets(EmbeddingTrainingArguments):
    """Training arguments for finetuning an embedding model with triplets."""
...
def finetune_with_triplets(
    ...
    train_dataset: Dataset,
    eval_dataset: Dataset,
    training_args: EmbeddingTrainingArguments = EmbeddingTrainingArgumentsWithTriplets(),
) -> None:
    """
    ...
    model.max_seq_length = min(
        ...
        training_args.max_seq_length or model.max_seq_length,
    )

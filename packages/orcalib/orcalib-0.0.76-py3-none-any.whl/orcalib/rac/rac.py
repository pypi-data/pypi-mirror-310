    ...
    def _record_curate_data(
        ...
        record_model_input_output(
            ...
            [
                ...
                for txt, lbl in zip(inputs, expected_labels)
            ],
    ...
    def predict_batch(
        ...
        if run_ids:
            self._record_curate_data(
                inputs, expected_labels, run_ids, memory_ids, predicted_labels, logits, feedback_callback  # type: ignore -- expected_labels is not None b/c run_ids would be None if it was
            )

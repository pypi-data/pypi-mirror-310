...
input_origin_data_jsonl = "/home/work_nfs15/asr_data/data/chat_data/web_text_2019_text/train_20W_1.jsonl"
origin_wav_dir_path = "/home/work_nfs15/asr_data/data/chat_data/web_text_2019_text/train_20W_1_wav"
...
for item in utils_file.tqdm(info_dict_list, desc="Generating text dict from jsonl"):
    text_dict[item["key"]] = item["A"]

# 得到data.list
data_list_path = "/home/work_nfs15/asr_data/data/chat_data/web_text_2019_text/common_format/train_20W_1/data.list"
do_get_formatted_datalist_for_chat_task(wav_dict, text_dict, "web_text_2019__text_train_20W_1")

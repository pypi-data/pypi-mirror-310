...
def do_copy_directory_only_codefile_with_true_suffix(source_dir, destination_dir, true_suffix_tuple: tuple=('.ipynb', '.py', '.sh', '.yaml', '.pl')):
    # 创建目标目录
    ...
    for item in tqdm(os.listdir(source_dir), desc='copy_directory_only_codefile', total=len(os.listdir(source_dir))):
        ...
        # 如果是子目录
            ...
            # 递归复制子目录
            do_copy_directory_only_codefile_with_true_suffix(item_path, destination_path, true_suffix_tuple)


def do_copy_directory_only_codefile_with_false_suffix(source_dir, destination_dir, false_suffix_tuple: tuple=('.pt', '.tar', '.gz')):
    # 创建目标目录
    destination_path = os.path.join(destination_dir, os.path.basename(source_dir))
    os.makedirs(destination_path, exist_ok=True)
    ...
    for item in tqdm(os.listdir(source_dir), desc='copy_directory_only_codefile', total=len(os.listdir(source_dir))):
        ...
        # 如果是子目录
            ...
            # 递归复制子目录
            do_copy_directory_only_codefile_with_false_suffix(item_path, destination_path, false_suffix_tuple)

...
def create_from_text(
    ...
    # Search for motion by prompt
    motion = Motion(prompt, api_instance_motions)

    # Use found motion .smpl file to create avatar
    uploader = Uploader()
    asset_id = motion.create_avatar(api_instance_avatars, uploader, timeout)

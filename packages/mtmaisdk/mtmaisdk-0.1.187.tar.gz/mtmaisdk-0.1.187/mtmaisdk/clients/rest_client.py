...
from mtmaisdk.clients.rest.api.workflow_runs_api import WorkflowRunsApi
...
class AsyncRestApi:
    ...
    def default_api(self):
        if self._deault_api is None:
            self._deault_api = DefaultApi(self.api_client)
        return self._deault_api
    ...
    async def hellotest123(self):
        return await self.api_client.

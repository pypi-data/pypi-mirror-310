...
from tests.helpers import TestApplication, TestOpenfundCommand
...
@pytest.fixture
def openfund_cmd_tester(poetry: Poetry) -> TestOpenfundCommand:
    return TestOpenfundCommand(poetry)

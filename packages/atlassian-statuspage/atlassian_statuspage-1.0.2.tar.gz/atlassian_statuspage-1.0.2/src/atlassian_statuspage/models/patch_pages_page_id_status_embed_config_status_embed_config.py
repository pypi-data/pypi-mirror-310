...
class PatchPagesPageIdStatusEmbedConfigStatusEmbedConfig(object):
    ...
    def __init__(self, position=None, incident_background_color=None, incident_text_color=None, maintenance_background_color=None, maintenance_text_color=None):  # noqa: E501
        """PatchPagesPageIdStatusEmbedConfigStatusEmbedConfig - a model defined in Swagger"""  # noqa: E501
        self._position = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchPagesPageIdStatusEmbedConfigStatusEmbedConfig, dict):

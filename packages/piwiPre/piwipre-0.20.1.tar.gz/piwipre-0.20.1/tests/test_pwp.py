...
class PwpTester:
    ...
    def program_7(self):
        ...
        LOGGER.test_msg('')
        LOGGER.test_msg('Verify --language en is taken into account form months on a french host')
    ...
    def program_907(self):
        ...
        self.assert_trace(f"Saved last run location in {os.path.abspath('tests/results/HOME')}/.piwiPre.last.")

...
def init():
    ...
    # model = "/root/models/qwen2_vl_ocr_220w_fix_loadall_baseline_hf/"
...
def get_vl_request(
    ...
    *,
    ...
    if isinstance(messages, str):
        ...
        # images_info = conv.get_images_info(preprocessor=context.get("preprocessor"),
        #                                    min_pixels=context.get("min_pixels"),
        #                                    max_pixels=context.get("max_pixels"),
        #                                    fps=context.get("fps"))
        # vl_request.images_info = images_info
        ...
        generate_config = {
            ...
            "do_sample": True,
            "early_stopping": False if os.getenv("VL_DEBUG") == "1" else True,
            "top_k": top_k,
            "top_p": top_p,
            "max_length": (
                max_tokens
    ...
    for gen_result in gen:
        ...
        print(
            "id: {}, vl_status:{}, as_status: {}, output: {}".format(
                ...
                as_status,
                (
                    # context.get("tokenizer").detokenize(vl_request.output_ids)

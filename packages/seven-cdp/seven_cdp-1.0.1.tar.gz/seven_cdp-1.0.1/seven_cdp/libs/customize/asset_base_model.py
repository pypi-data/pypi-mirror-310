...
@LastEditTime: 2024-11-18 16:04:19
...
from seven_cdp.models.db_models.member.member_asset_model import *
from seven_cdp.models.db_models.member.member_asset_log_model import *
from seven_cdp.models.db_models.member.member_asset_valid_model import *
...
class AssetBaseModel():
    ...
    def get_member_asset_list(self, one_ids, business_id, asset_type=0):
        ...
        member_asset_model = MemberAssetModel(context=self.context).set_sub_table(str(asset_type))
    ...
    def get_user_asset(self, business_id, one_id, asset_type, asset_object_id=""):
        """
    ...
    def get_asset_log_list(self,
        ...
        member_asset_log_model = MemberAssetLogModel(context=self.context).set_sub_table(str(asset_type))

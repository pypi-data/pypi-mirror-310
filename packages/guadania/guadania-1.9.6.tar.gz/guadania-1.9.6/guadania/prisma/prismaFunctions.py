...
def code_issues_branch_scans(prismaSession, categories=[]):
    """
    Valores aceptables en categories:
    [IacMisconfiguration, IacExternalModule, ImageReferencerVul,
    ImageReferencerLicenses, Vulnerabilities, Licenses,
    Secrets, BuildIntegrityRepo, BuildIntegrityOrg, BuildIntegrity, Weaknesses]
    """

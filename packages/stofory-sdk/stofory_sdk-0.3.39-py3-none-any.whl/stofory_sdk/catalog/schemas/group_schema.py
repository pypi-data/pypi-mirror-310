...
from .category_name_schema import CategoryNameCreateRequest
...
class MassCategoryGroupRequest(Struct, forbid_unknown_fields=True):
    to_add: list[CategoryGroupCreateRequest]
    to_delete: list[int]
    to_update: Any


class MassCategoryGroupResponse(Struct, forbid_unknown_fields=True):
    added: list[int]
    deleted: list[int]
    updated: list[int]

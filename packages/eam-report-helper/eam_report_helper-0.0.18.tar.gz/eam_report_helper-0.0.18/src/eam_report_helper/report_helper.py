    ...
    def build_report(self, report_id: str) -> list:
        ...
        match report_id:
            ...
            case 'dc9b4bb1-91d6-4b37-aa9d-ee53cc7209b5':
                print(os.environ['B2C_USER_MANAGEMENT_APP_CLIENT_ID'])
                print(os.environ['B2C_USER_MANAGEMENT_APP_CLIENT_SECRET'])
                print(os.environ['B2C_TENANT_ID'])
                print(os.environ['B2C_EXTENSION_APP_CLIENT_ID'])
                results = FormReportHelper(self.db, self.b2c_helper).get_form_report(

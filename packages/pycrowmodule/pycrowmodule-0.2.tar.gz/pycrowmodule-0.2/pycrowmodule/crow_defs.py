'''Crow/AAP Alarm IP / Serial Module Status Definition'''
...
SERIAL_COMMANDS = {
    'arm': 'KEYS_R',
    'stay': 'KEYS_S',
    'disarm': 'KEYS_', # Add ' codeE'
    'get_memory_events': 'MEM',
    'exit_memory_events': 'E',
    'panic': 'KEYS_N',
    'toggle_chime': 'KEYS_H',
    'quick_arm_a': 'KEYS_A',
    'quick_arm_b': 'KEYS_B',
    'toggle_output_x': 'KEYS_C',
    'keys': 'KEYS',
    'status': '?',    
}
...
# OUTPUT MESSAGES
    ...
    r'OC(?P<data>\d+)': {'name': 'Output Off', 'handler': 'output_state_change', 'attr': 'open', 'status': False}, #OUTPUT OFF for IP module
    r'OR(?P<data>\d+)': {'name': 'Output Off', 'handler': 'output_state_change', 'attr': 'open', 'status': False}, #OUTPUT OFF for Serial module

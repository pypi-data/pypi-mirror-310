...
class Collection(UserList, ClassFamily):
    ...
    # Do we allow numeric (index-type) filters?
    ...
    def select(self, *filter):
        ...
        that might contain multiple states doesn't allow numeric (index-type)
        filters.
        """
        selector = Selector(filter, index_ok=self.index_filter_ok)

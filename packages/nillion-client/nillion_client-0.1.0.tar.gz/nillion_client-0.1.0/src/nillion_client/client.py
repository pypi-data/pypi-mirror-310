...
class VmClient:
    ...
    @classmethod
    async def create(
        cls, key: secp256k1.PrivateKey, network: Network, payer: Payer
    ) -> "VmClient":
        """
        ...
        .. code-block:: py3
            ...
            client = await VmClient.create(private_key, network, payer)
        """
        client = cls(key, network, payer, _raise_if_called=False)
    ...
    async def get_payment_receipt(
        self, signed_quote: SignedQuote, tx_hash
    ) -> SignedReceipt:
        """
        ...
        """
        request = PaymentReceiptRequest(signed_quote=signed_quote, tx_hash=tx_hash)

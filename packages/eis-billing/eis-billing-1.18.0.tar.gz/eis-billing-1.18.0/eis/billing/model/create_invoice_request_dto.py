...
class CreateInvoiceRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, invoice_number, account_number, policy_code, policy_number, type, metadata, billing_interval_from, billing_interval_to, due_date, *args, **kwargs):  # noqa: E501
        """CreateInvoiceRequestDto - a model defined in OpenAPI

        Args:
            invoice_number (str): Unique number for the invoice. If not set, the system will automatically assign a value.
    ...
    @convert_js_args_to_python_args
    def __init__(self, invoice_number, account_number, policy_code, policy_number, type, metadata, billing_interval_from, billing_interval_to, due_date, *args, **kwargs):  # noqa: E501
        """CreateInvoiceRequestDto - a model defined in OpenAPI

...
class TimesliceDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, policy_objects, _from, to, created_at, updated_at, premium, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            to (datetime): Timeslice validity end.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, policy_objects, _from, to, created_at, updated_at, premium, *args, **kwargs):  # noqa: E501
        """TimesliceDto - a model defined in OpenAPI

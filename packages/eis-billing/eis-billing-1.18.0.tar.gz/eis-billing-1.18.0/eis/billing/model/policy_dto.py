...
class PolicyDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, policy_number, internal_policy_number, product_version_id, product_id, account_code, status, holder, created_at, updated_at, versions, product_name, product_slug, partner_links, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            partner_links ([str]): Linked partners.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, policy_number, internal_policy_number, product_version_id, product_id, account_code, status, holder, created_at, updated_at, versions, product_name, product_slug, partner_links, *args, **kwargs):  # noqa: E501
        """PolicyDto - a model defined in OpenAPI

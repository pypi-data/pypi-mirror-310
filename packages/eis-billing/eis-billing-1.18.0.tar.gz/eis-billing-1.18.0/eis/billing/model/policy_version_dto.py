...
class PolicyVersionDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_current, metadata, created_at, updated_at, timeline, is_draft, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_current, metadata, created_at, updated_at, timeline, is_draft, *args, **kwargs):  # noqa: E501
        """PolicyVersionDto - a model defined in OpenAPI

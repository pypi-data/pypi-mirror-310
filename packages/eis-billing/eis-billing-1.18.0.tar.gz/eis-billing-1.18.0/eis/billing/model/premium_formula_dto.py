...
class PremiumFormulaDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, product_version_id, group, name, expression, type, unit, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, product_version_id, group, name, expression, type, unit, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PremiumFormulaDto - a model defined in OpenAPI

...
class LineCapType:
    ...
    @classmethod
    @property
    def ROUND_CAP(cls) -> LineCapType:
        '''Round cap type.'''
        ...
    
    @classmethod
    @property
    def SQUARE_CAP(cls) -> LineCapType:
        '''Square cap type.'''
        ...
    
    @classmethod
    @property
    def BUTT_CAP(cls) -> LineCapType:
        '''Butt cap type.'''
        ...
...
class LineJoinType:
    ...
    @classmethod
    @property
    def BEVEL_JOIN(cls) -> LineJoinType:
        '''Bevel join type.'''
        ...
    
    @classmethod
    @property
    def ROUND_JOIN(cls) -> LineJoinType:
        '''Rounnd join type.'''
        ...
    
    @classmethod
    @property
    def MITER_JOIN(cls) -> LineJoinType:
        '''Miter join type.'''
        ...

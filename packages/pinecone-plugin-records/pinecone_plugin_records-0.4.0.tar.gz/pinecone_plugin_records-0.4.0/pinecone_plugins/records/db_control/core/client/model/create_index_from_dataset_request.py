...
class CreateIndexFromDatasetRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, dimension, spec, *args, **kwargs):  # noqa: E501
        """CreateIndexFromDatasetRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            dataset_name (str): The name of the dataset to create the index from. This must correlate to the collection name.. [optional]  # noqa: E501
        """

...
class DBQueryBuilder(ABC):
    ...
    def validate_custom_query(self, query: str) -> bool:
        ...
        # 위험한 키워드 체크
        if any(keyword in query_upper for keyword in self.dangerous_keywords):
            return False
...
class PostgreSQLQueryBuilder(DBQueryBuilder):
    ...
    def validate_custom_query(self, query: str) -> bool:
        ...
        if any(keyword in query_upper for keyword in postgres_dangerous):
            return False
...
class MySQLQueryBuilder(DBQueryBuilder):
    ...
    def validate_custom_query(self, query: str) -> bool:
        ...
        if any(keyword in query_upper for keyword in mysql_dangerous):
            return False
...
class MSSQLQueryBuilder(DBQueryBuilder):
    ...
    def validate_custom_query(self, query: str) -> bool:
        ...
        if any(keyword in query_upper for keyword in mssql_dangerous):
            return False
...
class OracleQueryBuilder(DBQueryBuilder):
    ...
    def validate_custom_query(self, query: str) -> bool:
        ...
        query_upper = query.upper()
        oracle_dangerous = {
            'EXECUTE IMMEDIATE', 'DBMS_', 'UTL_',
        }

        return not any(keyword in query_upper for keyword in oracle_dangerous)

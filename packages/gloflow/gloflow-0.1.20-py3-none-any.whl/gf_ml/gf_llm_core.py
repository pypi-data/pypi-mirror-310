...
#--------------------------------------------
def dalle3_request(p_api_key_str):

	# Set the API endpoint for DALL·E 3
	api_endpoint = "https://api.openai.com/v1/engines/dall-e-3/completions"

	# Define the text description for the image
	prompt_str = "A surreal landscape with floating islands and pink clouds."
	...
	if response.status_code == 200:
		...
		image_url = response.json()["choices"][0]["text"]

import mychatgpt
from mychatgpt import julia, yoko, watson, C, GPT, client
...
import mychatgpt
simple_encrypter('256648' , mychatgpt.api_key )
#%%


from mychatgpt import client
import openai
try:
...
client.with_streaming_response.chat()
#%%

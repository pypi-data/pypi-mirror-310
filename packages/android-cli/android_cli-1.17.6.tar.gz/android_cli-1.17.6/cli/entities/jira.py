...
class Jira:
    ...
    def create_release_and_add_issues(self, issues_due_date, version_name):
        ...
        try:
            issues = self.get_issues_by_due_date(due_date=issues_due_date, project_keys=['PR', 'NPR', 'BUG', 'SEC','EM'])
    ...
    def update_release_tickets_live(self):
        ...
        try:
            ...
            issues = self.get_issues_by_due_date(due_date, project_keys=['PR', 'NPR', 'BUG', 'SEC', 'EM'])
            for issue in issues:

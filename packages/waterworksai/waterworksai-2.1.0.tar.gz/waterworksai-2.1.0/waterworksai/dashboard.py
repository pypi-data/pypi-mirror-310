...
def pipe_network(pipe_gdf, api_key, id_col=None, construction_col=None, renovation_col=None, material_col=None, dimension_col=None, length_col=None, jupyter_mode=None, raw=False):
    from tools import PipeNetwork
    if raw is True:
        pass
    else:

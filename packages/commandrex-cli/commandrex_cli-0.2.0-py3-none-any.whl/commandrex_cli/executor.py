...
class CommandExecutor:
    ...
    def _prepare_command(self, command: Command) -> List[str]:
        ...
        needs_shell = self.command_mapping.needs_shell(executable, self.platform_info)
        
        if needs_shell:
            # For shell commands, wrap in appropriate shell
            cmd_list = [
            ...
            # For non-shell commands, return direct command list
    ...
    def execute(self, command: Command) -> CommandResult:
        ...
        try:
            ...
            # Determine if we should use shell based on the command
            use_shell = self.command_mapping.needs_shell(command.executable, self.platform_info)

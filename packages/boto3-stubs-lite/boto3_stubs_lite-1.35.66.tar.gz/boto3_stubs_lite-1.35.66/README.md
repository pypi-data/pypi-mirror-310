...
Type annotations for [boto3 1.35.66](https://pypi.org/project/boto3/)
...
- `boto3-stubs-lite[full]` - Type annotations for all 393 services in one
  package (recommended).
- `boto3-stubs-lite[all]` - Type annotations for all 393 services in separate
  packages.

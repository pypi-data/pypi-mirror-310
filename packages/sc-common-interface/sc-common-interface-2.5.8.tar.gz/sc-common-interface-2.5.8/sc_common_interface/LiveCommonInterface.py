...
if __name__=="__main__":
  data = {
    ...
    "data": {
        ...
        "list": [
            {
                "id": "6741acc0cfda6a000ead3544",
                "image": "https://shoplineimg.com/61a87c9763b70c005106fbd0/6741acb473b250000b26861a/50xf.webp?source_format=jpeg\u0026cheap_resize=1",
                "title": "无库存组合商品",
                "recommend": {
                    "isActivity": True,
                    "recommendTime": True
                ...
                "combinationList": [
                    {
                        "id": "943947ecdfff37355535ecea0bd17c11",
                        "price": {
                            "originCents": 900,
                            "origin": "900 ₫",
                            "salesCents": 500,
                        ...
                        "products": [
                            {
                                "spuId": "674153b778cb880011e7dc9b",
                                "skuId": "674153b778cb880011e7dc9b",
                                "count": 2,
                                "name": "商品名称1732334518",
                                "quantity": 99,
                            ...
                            {
                                "spuId": "65e855cbaf49be000ee315a9",
                                "skuId": "65e855cbaf49be000ee315a9",
                                "count": 2,
                                "name": "无库存商品（不要删除）",
                                "quantity": 0,
                                "unlimitedQuantity": True
                ...
                "childrenInfo": {
                    "65e855cbaf49be000ee315a9": {
                        "necessaryQuantity": 2,
                        "variations": []
                    },
                    "674153b778cb880011e7dc9b": {
                        "necessaryQuantity": 2,
                        "variations": []
                    }
                },
            ...
            {
                "id": "670fbd3dac9b6acdb37c8192",
                "image": "https://shoplineimg.com/61a87c9763b70c005106fbd0/670fbd1fac9b6a65377c874a/50xf.webp?source_format=jpeg\u0026cheap_resize=1",
                "title": "dyy组合商品变动-子商品从无规格变成多规格",
                "recommend": {
                    "isActivity": True,
                    "recommendTime": "2024-11-23T20:26:54+08:00"
                },
                "effectiveKey": True,
                "defaultKey": "C",
                "combinationList": [
                    {
                        "id": "fc37396e6a9d294cec87752911092300",
                        "price": {
                            "originCents": 222,
                            "origin": "222 ₫",
                            "salesCents": 90,
                        ...
                        "products": [
                            {
                                "spuId": "670fbced7fb2d151ef8f665a",
                                "skuId": "670fc098b34584000d03a595",
                                "count": 2,
                                "name": "dyy商品从无规格变成多规格(蓝)",
                                "quantity": -1,
                                "unlimitedQuantity": True
                            },
                            {
                ...
                "childrenInfo": {
                    ...
                    "670fbced7fb2d151ef8f665a": {
                        "necessaryQuantity": 2,
                        "variations": [
                            "670fc098b34584000d03a595",
                            "670fc098b34584000d03a596"
                        ]
                    }
                },
                "status": "active"
            ...
            {
                "id": "670f9464ac9b6ad8fd7c806b",
                "image": "https://shoplineimg.com/61a87c9763b70c005106fbd0/670f9448ac9b6ad4297c80df/50xf.webp?source_format=jpeg\u0026cheap_resize=1",
                "title": "dyy组合商品变动（子商品下的子规格被删除）0000",
                "recommend": {
                    "isActivity": True,
                    "recommendTime": True
                },
                ...
                "combinationList": [
                    {
                        "id": "b7d9e9e56797242331a71e39f5b8ed4b",
                        "price": {
                            "originCents": 100,
                            "origin": "100 ₫",
                            "salesCents": 90,
                        ...
                        "products": [
                            {
                                "spuId": "670f94397fb2d18edc8f61bc",
                                "skuId": "670f9439a6ddbb00093ef3fa",
                                "count": 2,
                                "name": "dyy商品变动（子规格被删除）(紫色)",
                                "quantity": -1,
                                "unlimitedQuantity": True
                            }
                        ],
                ...
                "childrenInfo": {
                    "670f94397fb2d18edc8f61bc": {
                        "necessaryQuantity": 2,
                        "variations": [
                            "670f9439a6ddbb00093ef3fa"
                        ]
                    }
                },
                "status": "active"
    ...
    "traceId": "019833d17de727ab192e0fe3582c372e"
}
  keyword, product_id,combination_id, __ = get_stock_product_set(data)
  print(keyword)
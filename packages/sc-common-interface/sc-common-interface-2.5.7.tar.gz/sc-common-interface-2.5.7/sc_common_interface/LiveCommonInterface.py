...
if __name__=="__main__":
   data = {'headers': {'authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9..FwtntG1dAYWNUcEZf6WSehXQveEw_rvTSGPEM3xV9FA', 'lang': 'en', 'Content-Type': 'application/json'}, 'product_id': '66f413a8f1e8240039b7bdf6', 'env': 'https://front-service.shoplinestg.com', 'sales_id': '67088', 'key': '4f6b54deff90cdc9966cbe7b82731b3b'}
   res = change_product_set_keyword_status(data)
   print(res)
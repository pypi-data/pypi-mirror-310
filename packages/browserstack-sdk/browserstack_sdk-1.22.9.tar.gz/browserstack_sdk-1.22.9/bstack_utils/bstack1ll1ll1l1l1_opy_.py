...
import threading
bstack1ll1ll111ll_opy_ = 1000
bstack1ll1ll1ll1l_opy_ = 5
bstack1ll1ll111l1_opy_ = 30
bstack1ll1ll11ll1_opy_ = 2
class bstack1ll1ll1l1ll_opy_:
    def __init__(self, handler, bstack1ll1ll11l11_opy_=bstack1ll1ll111ll_opy_, bstack1ll1ll11l1l_opy_=bstack1ll1ll1ll1l_opy_):
        self.queue = []
    ...
    def bstack1ll1ll1ll11_opy_(self):
        self.timer = threading.Timer(self.bstack1ll1ll11l1l_opy_, self.bstack1ll1ll11lll_opy_)
        self.timer.start()
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack1ll1ll11l11_opy_:
                t = threading.Thread(target=self.bstack1ll1ll11lll_opy_)
                t.start()
                self.bstack1ll1ll1l11l_opy_()
    def bstack1ll1ll11lll_opy_(self):
        if len(self.queue) <= 0:
            return
        data = self.queue[:self.bstack1ll1ll11l11_opy_]
        del self.queue[:self.bstack1ll1ll11l11_opy_]
        self.handler(data)
    def shutdown(self):
        self.bstack1ll1ll1l111_opy_()

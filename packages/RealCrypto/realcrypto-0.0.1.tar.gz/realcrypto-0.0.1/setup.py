...
if sys.platform == 'win32':
    ...
    if not os.path.exists(os.path.join(library_path, "lib")):
...
extensions = [
  Extension("RealCrypto", ["RealCrypto/*.pyx"],
...
class CustomBuildExt(build_ext):
    ...
    def get_ext_filename(self, ext_name):
        ...
        设置pyd安装目录
        """
        return os.path.join("RealCrypto", super().get_ext_filename(ext_name))


with open("README.md", "r", encoding="utf-8") as f:
  long_description = f.read()

setup(name='RealCrypto',
      version='0.0.1',
      ...
      # package_dir = {'':'RealCrypto'},
      # package_data={
      #   "RealCrypto":["*.pyi"]
      # },
      # include_package_data=True,
      # exclude_package_data={"RealCrypto":["*.cpp", "*.hpp"]},
      # script_args=['build_ext', '-b', 'RealCrypto'],

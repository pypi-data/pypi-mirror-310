...
def unescape(entry: Union[str, bytes], errors: Literal["strict", "ignore"] = "strict") -> str:
    """
    ...
    return entry.encode("unicode-escape", errors=errors).decode("unicode-escape", errors=errors)


def escape(entry: Union[str, bytes], errors: Literal["strict", "ignore"] = "strict") -> str:
    """

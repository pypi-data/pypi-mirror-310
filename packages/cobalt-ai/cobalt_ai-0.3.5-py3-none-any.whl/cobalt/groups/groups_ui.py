...
class GroupDisplay(w.Box):
    ...
    def update_displayed_groups(self):
        ...
        for list_item in self.list_item_group.children:
            list_item.on_event("mouseover", list_item.show_edit_icon)
            list_item.on_event("mouseout", list_item.hide_edit_icon)
...
class GroupItem(v.ListItem):
    def __init__(
        ...
        self.edit_icon = MenuButton(
            icon=True, button_label=button_label, menu=self.edit_menu
        )

            ...
            "NodeGroups": [
                {
                    ...
                    "LaunchTemplateSpecification": {
                        "LaunchTemplateId": partitions_config["Partitions"][0]["NodeGroups"][0]["LaunchTemplateSpecification"]["LaunchTemplateId"], #noqa
                        "Version": "$Latest"
                    },
                    "LaunchTemplateOverrides": [
                        {
                            "InstanceType": partition["nodeType"]
                        }
                    ],

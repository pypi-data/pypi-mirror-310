...
class Interface():
    ...
    def find_yield_initial_flux(self,model_info, model, model_control_info):
        ...
        metabolites = model.reactions.get_by_id('biomass').reactants
    ...
    def check_control(self, model_info, model, check_model, model_control_info, model_check_info):
        ...
        reducing_data = self.get_reducing_power_initial_flux(model_info, model, model_check_info)
        energy_data = self.get_energy_initial_flux(model_info, model, model_check_info)

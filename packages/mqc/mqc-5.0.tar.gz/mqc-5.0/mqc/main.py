...
class ModelCheck():
    ...
    def model_check_pear(self):
        ...
        pear_data = pear_interface.check_control(model_pre_process.model_info, controler.model, controler.check_model, self.model_control_info, self.model_check_info)
        return pear_data
...
def pear(a,b):
    ...
    pear_data = modelCheck.model_check_pear()
    print(pear_data)
    t2 = time.time()
    print("Total time: ", t2-t1)
    return pear_data
...
if __name__ == '__main__':
    ...
    pear('/home/dengxg/project/mqc/mqc/local_test_data/other/mg1655_EC.xml','tmp/other/mg1655_EC')

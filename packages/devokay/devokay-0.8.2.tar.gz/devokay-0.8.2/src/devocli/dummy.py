...
from devocli.pcs_postbuild import cmd_regist as register_pcs_postbuild
...
# python src/devocli/dummy.py pcs.build.store --params official-pc-10001 --target /Users/fallenink/Desktop/Developer/devokay-py/tmp1 --encrypt False

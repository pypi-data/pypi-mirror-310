...
@pro_aws_provider()
def events():from localstack.services.events.provider import EventsProvider as A;B=A();return Service.for_provider(B)
...
def events_legacy():from localstack.pro.core.services.events.provider import EventsProviderPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider()

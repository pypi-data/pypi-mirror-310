...
class FLAvgGamma:
    ...
    def avg_fl_gamma(self):
        ...
        E2, gamma2, occ2, occ_condition2, dos2 = FLAvgGamma.fl_gamma_occ_dos2(self)
        avg_gamma2 = integrate.simpson(gamma2 * occ2 * dos2, E2)
        return avg_gamma, avg_gamma2, occ_condition

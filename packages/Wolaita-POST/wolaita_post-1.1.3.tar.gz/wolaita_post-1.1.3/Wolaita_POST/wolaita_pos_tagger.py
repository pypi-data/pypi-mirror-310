...
class WolaitaPOSTagger:
    ...
    def __init__(self, model_path, word_vector_path, word_tokenizer_path, tag_tokenizer_path):
        """
        Initialize the tagger by loading the required models and tokenizers.
        """
        try:
    ...
    def _get_embedding(self, word):
        ...
        Assigns a random embedding for OOV words and tracks them.
        """
    ...
    def get_embedding_matrix(self):
        ...
        Logs OOV statistics and provides warnings if OOV percentage is high.
        """
        ...
        if self.oov_words:
            print("Sample OOV words:", self.oov_words[:10])

        # Warning for high OOV percentage
        if oov_percentage > 30.0:

...
The lite version `toolmate_lite` runs faster and supports Android Termux.  It lacks some of the features, such as local vector database retrieval, equipped with the full version `toolmate`.

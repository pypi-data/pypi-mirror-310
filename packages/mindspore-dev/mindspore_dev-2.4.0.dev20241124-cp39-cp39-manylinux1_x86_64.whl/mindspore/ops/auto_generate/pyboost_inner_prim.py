...
from mindspore._c_expression import UnstackExtPrim_
...
class _PyboostUnstackExtPrim(UnstackExtPrim_):
    def __call__(self, input_x, axis):

        return _convert_stub(super().__call__([input_x, axis]))


unstack_ext_impl = _PyboostUnstackExtPrim()

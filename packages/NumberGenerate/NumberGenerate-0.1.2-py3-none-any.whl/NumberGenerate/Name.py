...
# from db import CommonlyUsedSurname

# 百家姓
CommonlyUsedSurname = "赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞仁袁柳酆鲍史唐费廉岑薛雷贺倪汤滕殷罗毕郝邬安常乐于时傅皮卞齐康伍余元卜顾孟平黄和穆萧尹姚邵湛汪祁毛禹狄米贝明臧计伏成戴谈宋茅庞熊纪舒屈项祝董梁杜阮蓝闵席季麻强贾路娄危江童颜梅盛郎林刁钟徐邱骆高夏蔡田樊胡凌霍虞万支柯咎管卢莫经房裘缪干解鹰宗丁宣贲邓郁单杭洪包诸左石崔吉钮龚程嵇邢滑裴陆荣翁荀羊於惠甄曲家封芮羿储靳汲邴糜松井段富巫乌焦巴弓牧隗山谷车侯宓蓬全郗班仰秋仲伊宫宁仇栾暴甘钭厉戎祖武符刘景詹束龙叶幸司韶郜黎蓟博印宿白怀蒲台从鄂索咸籍赖卓蔺屠蒙池乔阴郁胥能苍双闻莘党翟谭贡劳逄姬申扶堵冉宰郦雍却璩桑桂濮牛寿通边扈燕冀郏浦尚农温别庄晏柴瞿阎充慕连茹习宦艾鱼容向古易慎戈廖庾终暨居衡步都耿满弘匡国文寇广禄阙东殴殳沃利蔚越夔隆师巩厍聂晁勾敖融冷訾辛阚那简饶空曾毋沙乜养鞠须丰巢关蒯相查后荆红游竺权逯盖後桓公万俟司马上官欧阳夏侯诸葛闻人东方赫连皇甫尉迟公羊澹台公冶宗政濮阳淳于单于太叔申屠公孙仲孙轩辕令狐钟离宇文长孙慕容鲜于闾丘司徒司空亓官司寇仉督子车颛孙端木巫马公西漆雕乐正壤驷公良拓拔夹谷宰父谷粱晋楚闫法汝鄢涂钦段干百里东郭南门呼延归海羊舌微生岳帅缑亢况后有琴梁丘左丘东门西门商牟佘佴伯赏南宫墨哈谯笪年爱阳佟第五言福"
# 生僻字
RARE_WORDS = ['奡', '靉', '叆', '仌', '昺', '竝', '霦', '犇', '愊', '贲', '琲', '礴', '埗', '別', '骉', '錶', '旵',
              '玚', '棽', '琤', '翀', '珵', '楮', '偲', '赪', '瑒', '篪', '珹', '捵', '茝', '鷐', '铖', '宬', '査',
              '嶒', '耑', '昳', '菂', '頔', '遆', '珰', '龘', '俤', '叇', '槙', '璗', '惇', '峩', '仹', '汎', '沨',
              '昉', '璠', '雰', '峯', '洑', '茀', '渢', '棻', '棻', '頫', '玍', '冮', '芶', '姏', '堽', '粿', '筦',
              '嘏', '釭', '郃', '浛', '訸', '嗃', '瓛', '翃', '隺', '鋐', '滈', '翚', '翯', '竑', '姮', '葓', '皜',
              '袆', '淏', '皞', '翙', '銲', '鉷', '澒', '澔', '閤', '婳', '黃', '峘', '鸻', '鈜', '褘', '锽', '谹',
              '嫮', '冏', '泂', '劼', '莙', '濬', '暕', '珒', '椈', '珺', '璟', '競', '煚', '傑', '玦', '鑑', '瑨',
              '瑨', '琎', '勣', '寯', '烱', '浕', '斚', '倢', '瑴', '畯', '雋', '傢', '峤', '凱', '堃', '蒯', '鹍',
              '崑', '焜', '姱', '衎', '鵾', '愷', '鎧', '玏', '呂', '俍', '冧', '倞', '琍', '綝', '壘', '孋', '瓅',
              '璘', '粦', '琍', '麗', '樑', '秝', '鍊', '崚', '链', '镠', '皊', '箖', '菻', '竻', '鸰', '琭', '瓈',
              '騄', '浬', '瑠', '嶺', '稜', '欐', '昽', '劢', '忞', '旻', '旼', '濛', '嫚', '媺', '铓', '鋩', '洺',
              '媌', '媔', '祃', '牻', '慜', '霂', '楙', '媄', '瑂', '婻', '寗', '嫟', '秾', '迺', '柟', '薿', '枏',
              '芃', '玭', '玶', '罴', '毰', '珮', '蘋', '慿', '弸', '掽', '逄', '砯', '玘', '佺', '耹', '踆', '骎',
              '啟', '蒨', '慬', '勍', '嵚', '婍', '璆', '碏', '焌', '駸', '綪', '锜', '荍', '釥', '嶔', '啓', '汭',
              '瑈', '瑢', '讱', '镕', '婼', '叡', '蒻', '羢', '瀼', '屾', '昇', '妽', '珅', '姼', '甡', '湦', '骦',
              '塽', '挻', '甦', '鉥', '燊', '遂', '陞', '莦', '湜', '奭', '佀', '聖', '骕', '琡', '沺', '凃', '禔',
              '慆', '弢', '颋', '譚', '曈', '榃', '湉', '珽', '瑱', '橦', '镋', '渟', '黇', '頲', '畑', '媞', '鰧',
              '卍', '彣', '炆', '溦', '娬', '韡', '暐', '偉', '湋', '妏', '硙', '珷', '娒', '仚', '旴', '忺', '炘',
              '昍', '烜', '爔', '斅', '豨', '勲', '敩', '虓', '鈃', '禤', '燮', '瑄', '晞', '賢', '翾', '譞', '諕',
              '璿', '琇', '晛', '焮', '珣', '晅', '郤', '禼', '皛', '哓', '肸', '谞', '迿', '咲', '婞', '昫', '缐',
              '姁', '猇', '欻', '箮', '翛', '暁', '乂', '冘', '弌', '贠', '伝', '伃', '杙', '沄', '旸', '玙', '玥',
              '垚', '訚', '堯', '溁', '嫈', '澐', '颺', '熤', '儀', '赟', '祎', '瑀', '湧', '燚', '嬿', '鋆', '嫄',
              '愔', '贇', '彧', '崟', '韻', '龑', '颙', '晹', '媖', '顒', '禕', '羕', '炀', '弇', '湲', '霙', '嫕',
              '浥', '飏', '峣', '曣', '億', '雲', '愔', '洢', '暘', '钖', '垟', '詠', '燿', '鹓', '歈', '貟', '瑩',
              '燏', '暎', '畇', '娫', '矞', '祐', '溳', '崯', '颍', '煬', '靷', '谳', '異', '軏', '繄', '烝', '梽',
              '喆', '禛', '誌', '曌', '衠', '淽', '枬', '詟', '炤', '昝', '珘', '赒']
# 常用汉字
COMMON_WORDS = ['一', '乙', '二', '十', '丁', '厂', '七', '卜', '人', '入', '八', '九', '几', '儿', '了', '力', '乃',
                ...
                '罐']
# 次常用汉字
SECONDARY_COMMON_WORDS = ['匕', '刁', '丐', '歹', '戈', '夭', '仑', '讥', '冗', '邓', '艾', '夯', '凸', '卢', '叭',
                          '叽', '皿', '凹', '囚', '矢', '乍', '尔', '冯', '玄', '邦', '迂', '邢', '芋', '芍', '吏',
                          '夷', '吁', '吕', '吆', '屹', '廷', '迄', '臼', '仲', '伦', '伊', '肋', '旭', '匈', '凫',
                          '妆', '亥', '汛', '讳', '讶', '讹', '讼', '诀', '弛', '阱', '驮', '驯', '纫', '玖', '玛',
                          '韧', '抠', '扼', '汞', '扳', '抡', '坎', '坞', '抑', '拟', '抒', '芙', '芜', '苇', '芥',
                          '芯', '芭', '杖', '杉', '巫', '杈', '甫', '匣', '轩', '卤', '肖', '吱', '吠', '呕', '呐',
                          '吟', '呛', '吻', '吭', '邑', '囤', '吮', '岖', '牡', '佑', '佃', '伺', '囱', '肛', '肘',
                          '甸', '狈', '鸠', '彤', '灸', '刨', '庇', '吝', '庐', '闰', '兑', '灼', '沐', '沛', '汰',
                          '沥', '沦', '汹', '沧', '沪', '忱', '诅', '诈', '罕', '屁', '坠', '妓', '姊', '妒', '纬',
                          '玫', '卦', '坷', '坯', '拓', '坪', '坤', '拄', '拧', '拂', '拙', '拇', '拗', '茉', '昔',
                          '苛', '苫', '苟', '苞', '茁', '苔', '枉', '枢', '枚', '枫', '杭', '郁', '矾', '奈', '奄',
                          '殴', '歧', '卓', '昙', '哎', '咕', '呵', '咙', '呻', '咒', '咆', '咖', '帕', '账', '贬',
                          '贮', '氛', '秉', '岳', '侠', '侥', '侣', '侈', '卑', '刽', '刹', '肴', '觅', '忿', '瓮',
                          '肮', '肪', '狞', '庞', '疟', '疙', '疚', '卒', '氓', '炬', '沽', '沮', '泣', '泞', '泌',
                          '沼', '怔', '怯', '宠', '宛', '衩', '祈', '诡', '帚', '屉', '弧', '弥', '陋', '陌', '函',
                          '姆', '虱', '叁', '绅', '驹', '绊', '绎', '契', '贰', '玷', '玲', '珊', '拭', '拷', '拱',
                          '挟', '垢', '垛', '拯', '荆', '茸', '茬', '荚', '茵', '茴', '荞', '荠', '荤', '荧', '荔',
                          '栈', '柑', '栅', '柠', '枷', '勃', '柬', '砂', '泵', '砚', '鸥', '轴', '韭', '虐', '昧',
                          '盹', '咧', '昵', '昭', '盅', '勋', '哆', '咪', '哟', '幽', '钙', '钝', '钠', '钦', '钧',
                          '钮', '毡', '氢', '秕', '俏', '俄', '俐', '侯', '徊', '衍', '胚', '胧', '胎', '狰', '饵',
                          '峦', '奕', '咨', '飒', '闺', '闽', '籽', '娄', '烁', '炫', '洼', '柒', '涎', '洛', '恃',
                          '恍', '恬', '恤', '宦', '诫', '诬', '祠', '诲', '屏', '屎', '逊', '陨', '姚', '娜', '蚤',
                          '骇', '耘', '耙', '秦', '匿', '埂', '捂', '捍', '袁', '捌', '挫', '挚', '捣', '捅', '埃',
                          '耿', '聂', '荸', '莽', '莱', '莉', '莹', '莺', '梆', '栖', '桦', '栓', '桅', '桩', '贾',
                          '酌', '砸', '砰', '砾', '殉', '逞', '哮', '唠', '哺', '剔', '蚌', '蚜', '畔', '蚣', '蚪',
                          '蚓', '哩', '圃', '鸯', '唁', '哼', '唆', '峭', '唧', '峻', '赂', '赃', '钾', '铆', '氨',
                          '秫', '笆', '俺', '赁', '倔', '殷', '耸', '舀', '豺', '豹', '颁', '胯', '胰', '脐', '脓',
                          '逛', '卿', '鸵', '鸳', '馁', '凌', '凄', '衷', '郭', '斋', '疹', '紊', '瓷', '羔', '烙',
                          '浦', '涡', '涣', '涤', '涧', '涕', '涩', '悍', '悯', '窍', '诺', '诽', '袒', '谆', '祟',
                          '恕', '娩', '骏', '琐', '麸', '琉', '琅', '措', '捺', '捶', '赦', '埠', '捻', '掐', '掂',
                          '掖', '掷', '掸', '掺', '勘', '聊', '娶', '菱', '菲', '萎', '菩', '萤', '乾', '萧', '萨',
                          '菇', '彬', '梗', '梧', '梭', '曹', '酝', '酗', '厢', '硅', '硕', '奢', '盔', '匾', '颅',
                          '彪', '眶', '晤', '曼', '晦', '冕', '啡', '畦', '趾', '啃', '蛆', '蚯', '蛉', '蛀', '唬',
                          '啰', '唾', '啤', '啥', '啸', '崎', '逻', '崔', '崩', '婴', '赊', '铐', '铛', '铝', '铡',
                          '铣', '铭', '矫', '秸', '秽', '笙', '笤', '偎', '傀', '躯', '兜', '衅', '徘', '徙', '舶',
                          '舷', '舵', '敛', '翎', '脯', '逸', '凰', '猖', '祭', '烹', '庶', '庵', '痊', '阎', '阐',
                          '眷', '焊', '焕', '鸿', '涯', '淑', '淌', '淮', '淆', '渊', '淫', '淳', '淤', '淀', '涮',
                          '涵', '惦', '悴', '惋', '寂', '窒', '谍', '谐', '裆', '袱', '祷', '谒', '谓', '谚', '尉',
                          '堕', '隅', '婉', '颇', '绰', '绷', '综', '绽', '缀', '巢', '琳', '琢', '琼', '揍', '堰',
                          '揩', '揽', '揖', '彭', '揣', '搀', '搓', '壹', '搔', '葫', '募', '蒋', '蒂', '韩', '棱',
                          '椰', '焚', '椎', '棺', '榔', '椭', '粟', '棘', '酣', '酥', '硝', '硫', '颊', '雳', '翘',
                          '凿', '棠', '晰', '鼎', '喳', '遏', '晾', '畴', '跋', '跛', '蛔', '蜒', '蛤', '鹃', '喻',
                          '啼', '喧', '嵌', '赋', '赎', '赐', '锉', '锌', '甥', '掰', '氮', '氯', '黍', '筏', '牍',
                          '粤', '逾', '腌', '腋', '腕', '猩', '猬', '惫', '敦', '痘', '痢', '痪', '竣', '翔', '奠',
                          '遂', '焙', '滞', '湘', '渤', '渺', '溃', '溅', '湃', '愕', '惶', '寓', '窖', '窘', '雇',
                          '谤', '犀', '隘', '媒', '媚', '婿', '缅', '缆', '缔', '缕', '骚', '瑟', '鹉', '瑰', '搪',
                          '聘', '斟', '靴', '靶', '蓖', '蒿', '蒲', '蓉', '楔', '椿', '楷', '榄', '楞', '楣', '酪',
                          '碘', '硼', '碉', '辐', '辑', '频', '睹', '睦', '瞄', '嗜', '嗦', '暇', '畸', '跷', '跺',
                          '蜈', '蜗', '蜕', '蛹', '嗅', '嗡', '嗤', '署', '蜀', '幌', '锚', '锥', '锨', '锭', '锰',
                          '稚', '颓', '筷', '魁', '衙', '腻', '腮', '腺', '鹏', '肄', '猿', '颖', '煞', '雏', '馍',
                          '馏', '禀', '痹', '廓', '痴', '靖', '誊', '漓', '溢', '溯', '溶', '滓', '溺', '寞', '窥',
                          '窟', '寝', '褂', '裸', '谬', '媳', '嫉', '缚', '缤', '剿', '赘', '熬', '赫', '蔫', '摹',
                          '蔓', '蔗', '蔼', '熙', '蔚', '兢', '榛', '榕', '酵', '碟', '碴', '碱', '碳', '辕', '辖',
                          '雌', '墅', '嘁', '踊', '蝉', '嘀', '幔', '镀', '舔', '熏', '箍', '箕', '箫', '舆', '僧',
                          '孵', '瘩', '瘟', '彰', '粹', '漱', '漩', '漾', '慷', '寡', '寥', '谭', '褐', '褪', '隧',
                          '嫡', '缨', '撵', '撩', '撮', '撬', '擒', '墩', '撰', '鞍', '蕊', '蕴', '樊', '樟', '橄',
                          '敷', '豌', '醇', '磕', '磅', '碾', '憋', '嘶', '嘲', '嘹', '蝠', '蝎', '蝌', '蝗', '蝙',
                          '嘿', '幢', '镊', '镐', '稽', '篓', '膘', '鲤', '鲫', '褒', '瘪', '瘤', '瘫', '凛', '澎',
                          '潭', '潦', '澳', '潘', '澈', '澜', '澄', '憔', '懊', '憎', '翩', '褥', '谴', '鹤', '憨',
                          '履', '嬉', '豫', '缭', '撼', '擂', '擅', '蕾', '薛', '薇', '擎', '翰', '噩', '橱', '橙',
                          '瓢', '蟥', '霍', '霎', '辙', '冀', '踱', '蹂', '蟆', '螃', '螟', '噪', '鹦', '黔', '穆',
                          '篡', '篷', '篙', '篱', '儒', '膳', '鲸', '瘾', '瘸', '糙', '燎', '濒', '憾', '懈', '窿',
                          '缰', '壕', '藐', '檬', '檐', '檩', '檀', '礁', '磷', '瞭', '瞬', '瞳', '瞪', '曙', '蹋',
                          '蟋', '蟀', '嚎', '赡', '镣', '魏', '簇', '儡', '徽', '爵', '朦', '臊', '鳄', '糜', '癌',
                          '懦', '豁', '臀', '藕', '藤', '瞻', '嚣', '鳍', '癞', '瀑', '襟', '璧', '戳', '攒', '孽',
                          '蘑', '藻', '鳖', '蹭', '蹬', '簸', '簿', '蟹', '靡', '癣', '羹', '鬓', '攘', '蠕', '巍',
                          '鳞', '糯', '譬', '霹', '躏', '髓', '蘸', '镶', '瓤', '矗']
...
class NameGenerate:
    ...
    def __init__(
        ...
        """
        self.CommonlyUsedSurname = CommonlyUsedSurname
        self.word_pinyin_list = []
        if all_words:
            chinese_words = self.generate_chinese_word()
            self.add_words(words=chinese_words)
        if rare_word:
            self.add_words(RARE_WORDS)
        if common_words:
            self.add_words(COMMON_WORDS)
        if secondary_common_words:
            self.add_words(SECONDARY_COMMON_WORDS)
    ...
    def add_words(self, words: list):
        ...
        :return:
        """
        for chinese_word in words:
            data = {'word': chinese_word, 'pinyin': pinyin(chinese_word, style=Style.NORMAL)[0][0]}
            try:
                self.word_pinyin_list.index(data)
            except ValueError:
                self.word_pinyin_list.append(data)
    ...
    def generate_chinese_word():
        ...
        for head in range(0xB0, 0xF8):
            for body in range(0xA1, 0xFE):
                ...
                string = "%x" % val
                try:
                    chs = codecs.decode(bytes.fromhex(string), 'gbk')
                    chinese_words.append(chs)
                except UnicodeDecodeError:
                    continue

        return chinese_words

    def search_words(self, word_pinyin: str = "*"):
        words = []
        for word_pinyin_list in self.word_pinyin_list:
            if word_pinyin != "*":
                if word_pinyin_list['pinyin'].startswith(word_pinyin):
                    words.append(word_pinyin_list['word'])
            else:
                words.append(word_pinyin_list['word'])
        return words
    ...
    def get_names(self, name: list):
        ...
        for index, word in enumerate(name):
            if self.is_search(word) is False:
                words.append([word])
                continue

            search_words = self.search_words(word)
            if index == 0:
                n_search_words = [search_word for search_word in search_words if
                                  search_word in self.CommonlyUsedSurname]
                words.append(n_search_words)
            else:
                words.append(search_words)

        return self.combine_words(words)


if __name__ == "__main__":
    Name = NameGenerate()
    print(len(Name.get_names(['黄', 'z', 'c'])), Name.get_names(['黄', 'z', 'c']))

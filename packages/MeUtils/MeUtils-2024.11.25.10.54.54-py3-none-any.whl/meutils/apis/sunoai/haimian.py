...
async def create_task(request: HaimianRequest, token: Optional[str] = None):
    ...
    params = {
        ...
        'aid': '588628',
        'app_id': '588628',
        'app_version': '1.0.0.722',
        'channel': 'online',
        'region': 'CN',
        'device_platform': 'web',
        'msToken': 'TiTBue3WkVndBDUquFaAVoAX5BHcxziQ_UJxJFlNQd-xRzCBuEiB_zWb27uR7PRSQhHOcMLo0ICWV0i6mJMBpyZQhcfuslQqyWLquUHL6cP5DMQaWatG',
        'a_bogus': 'YjmZQQzkdEdBhDE85UALfY3quLCPY0tb0ajLMDgPSxAYWL39HMTv9exYJhk4KujjNG%2FpIejjy4hbO3xprQQ70Hwf7Wsx%2F2CZs640t-Pg-nSSs1feeLbQrsJx-kz5Feep5JV3EcvhqJKczbEk09C9-iIlO6ZCcHgjxiSmtn3Fvv6%3D'
    }
    payload = request.model_dump()
    # proxies = await get_one_proxy()
    proxies = {'http://': 'http://154.12.35.201:38443', 'https://': 'http://154.12.35.201:38443'}
    logger.debug(proxies)
    async with httpx.AsyncClient(base_url=BASE_URL, headers=headers, params=params, timeout=30,

...
def test_basic_parenthesized_power():
    ...
    assert group[0].number.integer == 2
    assert group[0].power[0].number.integer == 3 and group[0].power[0].variable is None
...
def test_long_and_parenthesized_power():
    ...
    assert len(group) == 5
    assert group[0].variable.name == "x" and not group[0].number.is_negative and group[0].power[0].number.integer == 2
    assert group[1].number.integer == 3 and group[1].variable is None
...
def test_different_variable_power():
    ...
    assert len(group) == 1
    assert group[0].number.integer == 2 and group[0].variable.name == "m"
    assert group[0].power[0].number.integer == 4 and group[0].power[0].variable.name == "x"
...
def test_basic_double_digit_power():
    ...
    assert len(group) == 1
    assert group[0].number.integer == 10
    assert group[0].power[0].number.integer == 10


def test_parenthesized_and_nested_power():
    group: list[parser.Group] = parser.parse_group("5 + 2x^(3^-4y + 6)", groups_only=True)

    assert group[0].number.integer == 5
    assert group[1].number.integer == 2 and group[1].variable.name == "x"
    assert group[1].power[0].number.integer == 3 and group[1].power[0].variable is None and not group[1].power[
        0].number.is_negative
    assert group[1].power[0].power[0].number.integer == 4 and group[1].power[0].power[0].number.is_negative and \
           group[1].power[0].power[0].variable.name == "y"
    assert group[1].power[1].number.integer == 6 and group[1].power[1].variable is None and not group[1].power[
...
def test_nested_power():
    ...
    assert len(group) == 2
    assert group[1].power[0].number.integer == 3 and group[1].power[0].variable is None
    assert group[1].power[0].power[0].number.integer == 4 and group[1].power[0].power[0].variable.name == "y" and \
...
def test_complex_power():
    ...
    assert group[0].variable.name == "x" and group[0].number.integer == 2 and group[0].power[0].variable is None and \
           group[0].power[0].number.integer == 62
    assert group[1].number.integer == 3 and group[1].variable is None and not group[1].number.is_negative

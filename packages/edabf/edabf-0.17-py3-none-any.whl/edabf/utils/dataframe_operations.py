...
def map_data_type(data_type, examples=None):
    ...
    date_types = ["datetime", "date", "timestamp", "datetime64", "timedelta", "datetime64[ns]", "datetime(time_unit='ns', time_zone=none)", "TIMESTAMP WITH TIME ZONE", "Datetime(time_unit='ns', time_zone='UTC')"]

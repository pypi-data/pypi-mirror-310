...
def read_sql_query_chunked(engine, query, chunk_size=100000):
    """
    ...
    # Leer la base de datos en chunks
    for chunk in pd.read_sql_query(query_data, engine, chunksize=chunk_size):
        # Validar y convertir las columnas que contienen UUIDs
        chunk = validate_and_convert_uuids(chunk)

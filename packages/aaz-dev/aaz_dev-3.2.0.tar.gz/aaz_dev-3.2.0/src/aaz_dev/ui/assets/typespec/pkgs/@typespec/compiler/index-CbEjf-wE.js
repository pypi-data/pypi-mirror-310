import { b as getAnyExtensionFromPath, n as normalizePath, j as joinPaths, g as getDirectoryPath } from './path-utils-3cuVtir1.js';
...
try {
    ...
    // @ts-ignore
    manifest = (await import('./manifest-DdlH7QV-.js')).default;
}
catch {
...
export { typespecVersion as A, DuplicateTracker as D, IdentifierKind as I, ListenerFlow as L, MultiKeyMap as M, NoTarget as N, Queue as Q, ResolutionResultFlags as R, SyntaxKind as S, TwoLevelMap as T, createRekeyableMap as a, createSourceFile as b, createDiagnostic as c, isDefined as d, createDiagnosticCreator as e, deepFreeze as f, deepClone as g, doIO as h, isArray as i, resolveTspMain as j, MANIFEST as k, loadFile as l, mutate as m, deepEquals as n, omitUndefined as o, mapEquals as p, findProjectRoot as q, reportDiagnostic as r, getNormalizedRealPath as s, distinctArray as t, isWhitespaceStringOrUndefined as u, tryParseJson as v, firstNonWhitespaceCharacterIndex as w, getSourceFileKindFromExt as x, cadlVersion as y, paramMessage as z };

...
const std::string& LoadgenVersion() {
  static const std::string str = "4.1.29";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-11-22T13:50:50.202437";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-11-22T13:50:50.202461";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "6e1bcfd74f";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-11-22T13:50:19Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(6e1bcfd74f4c70dfae7a899d963e644625208653 Update VERSION.txt)LGVG_RSLD";
  return str;
}
...
036d392854b57dad03b1f24df2dd4de14f9d4af0 /VERSION.txt

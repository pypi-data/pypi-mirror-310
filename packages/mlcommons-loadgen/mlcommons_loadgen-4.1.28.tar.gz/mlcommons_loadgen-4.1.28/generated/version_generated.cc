...
const std::string& LoadgenVersion() {
  static const std::string str = "4.1.28";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-11-22T12:18:49.325644";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-11-22T12:18:49.325669";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "03911ac715";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-11-22T12:18:19Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(03911ac7150e7c356b0cf49ab16aa1c4214294b4 Increment version to 4.1.28)LGVG_RSLD";
  return str;
}
...
ccef644c418a398ded7519d6867be64c2f04cbbd /VERSION.txt

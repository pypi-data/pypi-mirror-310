...
def serve(
    ...
    serve(model, model_name=model_name, host=host, port=port, tensor_parallel_size=parallal_size, quantization=quantization, load_format=load_format, enforce_eager=enforce_eager)

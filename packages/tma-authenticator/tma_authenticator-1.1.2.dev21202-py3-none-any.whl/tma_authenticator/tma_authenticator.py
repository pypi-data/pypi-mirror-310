...
class TMAAuthenticator():
    ...
    # @cached(
    #     cache=Cache.MEMORY,
    #     key_builder=lambda _, authorization, extra_tokens_validation: f"{authorization}:{str(extra_tokens_validation)}",
    #     ttl=300  # Cache time-to-live in seconds, adjust as necessary
    # )
    @cached(
        cache=Cache.MEMORY,

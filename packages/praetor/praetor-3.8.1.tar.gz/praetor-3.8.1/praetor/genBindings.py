...
praetor_settings.blacklist.extend(['os.stat', 'os.environ', 'os.path.isfile', 'haslib.md5', 'datetime.datetime.now',
                                   'inspect.signature', 'inspect.Parameter.empty', 'final_globals.items', 'uuid.uuid4',

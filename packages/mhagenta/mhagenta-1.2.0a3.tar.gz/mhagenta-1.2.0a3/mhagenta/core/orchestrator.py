...
def run_wrapper(orchestrator: Orchestrator,
    ...
    wrapper = client.images.pull('docker', orchestrator.WRAPPER_IMAGE_TAG)
    client.containers.run(image=wrapper,
                          name='mha-wrapper',
                          ...
                          privileged=True,
                          remove=True,
                          command=['/bin/sh', f'{orchestrator._save_dir}/src/run_orchestrator.sh']
                          )

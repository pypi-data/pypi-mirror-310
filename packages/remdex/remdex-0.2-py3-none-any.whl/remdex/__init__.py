...
class FedAvgClientTrain(framework.FedAvgClient):
    train_executor = None
    batch_generator_executor = None
    batch_train_executor = None
    evaluate_executor = None
    get_params_executor = None
    update_params_executor = None
    return_models_execuutor = None
    def __init__(self):
        super().__init__()
    def train(self):
    ...
    def update_params(self, parameters: List[List]):
        return self.update_params_executor()
    def save(self):
        return super().save()
    def return_models(self) -> List[framework.Model]:
        return self.return_models_execuutor() 
    def start(self, server_address: str):
        return super().start(server_address)
...
class FedSgdClientTrain(framework.FedSgdClient):
    train_executor = None
    optimize_executor = None
    batch_generator_executor = None
    batch_train_executor = None
    evaluate_executor = None
    return_models_executor = None
    def __init__(self):
        super().__init__()
    def train(self) -> List[framework.Gradients]:
        return super().train()

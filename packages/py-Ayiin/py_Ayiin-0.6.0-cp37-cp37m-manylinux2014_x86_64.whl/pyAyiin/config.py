...
class Config:
    ...
    # Anti Spambot Config
    ANTI_SPAMBOT = strToBool(getenv("ANTI_SPAMBOT", "False"))
    ANTI_SPAMBOT_SHOUT = strToBool(getenv("ANTI_SPAMBOT_SHOUT", "False"))
    ...
    # Clean Welcome
    CLEAN_WELCOME = strToBool(getenv("CLEAN_WELCOME", "True"))

...
class setup:
    ...
    def getbanddomain():
        ...
        status,webitem=systekcwebplus.getbanddomain(addtype='kcwebplus')
        if status:
    ...
    def banddomainall():
        ...
        status,msg=systekcwebplus.banddomainall(domain=domain,proxy_pass=proxy_pass,addtype='kcwebplus')
        if status:
            return successjson()
        else:

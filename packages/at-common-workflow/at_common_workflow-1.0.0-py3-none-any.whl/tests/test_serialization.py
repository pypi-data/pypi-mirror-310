...
async def task_with_params(context, multiplier: int):
    value = context.get("input", 0)
    context.set("output", value * multiplier)

async def task_with_deps(context):

...
class UserProfile(BaseModel):
    ...
    avatar = models.ImageField(upload_to='avatar/%Y/%m', default='/static/core/images/logo.png', verbose_name=_('头像'))
    ...
    phone = models.CharField(max_length=11, verbose_name=_('手机号'), null=True, blank=True, unique=True)
...
class UserAddress(BaseModel):
    ...
    phone = models.CharField(max_length=11, verbose_name=_('手机号'))

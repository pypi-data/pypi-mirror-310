...
class LlmClient:
    def __init__(self, openai_key):
        self.geminy_client = self._initialize_gemini(None)
    ...
    def ask_gemini(self, prompt: str, document=None):
        ...
        if document is None:
            ...
            # Generate the response
            model_response = self.geminy_client.generate_content(
                [document, prompt], generation_config=self.model_config, stream=True,
            )
    ...
    def get_unified_json_genai(self, prompt, parameters=None, document=None):
    ...
    def prompt_excel_extraction(self, excel_structured_text, schema):

...
#
# Generated by SIP 6.8.7.dev5+g8d3fd639
#
...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    def inputMethodEvent(self, e: typing.Optional[QtGui.QInputMethodEvent]) -> None: ...
    ...
    def toMimeData(self, text: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], rectangular: bool) -> typing.Optional[QtCore.QMimeData]: ...
    def fromMimeData(self, source: typing.Optional[QtCore.QMimeData]) -> typing.Tuple[QtCore.QByteArray, bool]: ...
    ...
    def SendScintillaPtrResult(self, msg: int) -> typing.Optional[PyQt6.sip.voidptr]: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: typing.Any = ..., lParam: int = ...) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, lParam: typing.Optional[PyQt6.sip.voidptr]) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, lParam: typing.Optional[bytes]) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, lParam: typing.Optional[bytes]) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: typing.Optional[bytes], lParam: typing.Optional[bytes]) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, cpMin: int, cpMax: int, lpstrText: typing.Optional[bytes]) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, hdc: typing.Optional[QtGui.QPainter], rc: QtCore.QRect, cpMin: int, cpMax: int) -> int: ...
    @typing.overload
    ...
    def replaceVerticalScrollBar(self, scrollBar: typing.Optional[QtWidgets.QScrollBar]) -> None: ...
    def replaceHorizontalScrollBar(self, scrollBar: typing.Optional[QtWidgets.QScrollBar]) -> None: ...
    @staticmethod
    def pool() -> typing.Optional['QsciScintillaBase']: ...
...
class QsciScintilla(QsciScintillaBase):
    ...
    @typing.overload
    def setMarginWidth(self, margin: int, s: typing.Optional[str]) -> None: ...
    ...
    def replaceSelectedText(self, text: typing.Optional[str]) -> None: ...
    def removeSelectedText(self) -> None: ...
    def redo(self) -> None: ...
    def paste(self) -> None: ...
    def moveToMatchingBrace(self) -> None: ...
    def insertAt(self, text: typing.Optional[str], line: int, index: int) -> None: ...
    def insert(self, text: typing.Optional[str]) -> None: ...
    ...
    def write(self, io: typing.Optional[QtCore.QIODevice]) -> bool: ...
    def wrapIndentMode(self) -> 'QsciScintilla.WrapIndentMode': ...
    def wrapMode(self) -> 'QsciScintilla.WrapMode': ...
    def wordCharacters(self) -> typing.Optional[str]: ...
    ...
    def standardCommands(self) -> typing.Optional['QsciCommandSet']: ...
    def showUserList(self, id: int, list: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    ...
    @typing.overload
    def setMarginText(self, line: int, text: typing.Optional[str], style: int) -> None: ...
    @typing.overload
    def setMarginText(self, line: int, text: typing.Optional[str], style: 'QsciStyle') -> None: ...
    @typing.overload
    def setMarginText(self, line: int, text: 'QsciStyledText') -> None: ...
    @typing.overload
    def setMarginText(self, line: int, text: collections.abc.Iterable['QsciStyledText']) -> None: ...
    ...
    def setContractedFolds(self, folds: collections.abc.Iterable[int]) -> None: ...
    ...
    def setAutoCompletionWordSeparators(self, separators: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
    def setAutoCompletionFillups(self, fillups: typing.Optional[str]) -> None: ...
    ...
    def replace(self, replaceStr: typing.Optional[str]) -> None: ...
    @typing.overload
    ...
    def read(self, io: typing.Optional[QtCore.QIODevice]) -> bool: ...
    ...
    def lexer(self) -> typing.Optional['QsciLexer']: ...
    def length(self) -> int: ...
    def lines(self) -> int: ...
    def lineLength(self, line: int) -> int: ...
    def lineIndexFromPosition(self, position: int) -> typing.Tuple[typing.Optional[int], typing.Optional[int]]: ...
    ...
    def getSelection(self) -> typing.Tuple[typing.Optional[int], typing.Optional[int], typing.Optional[int], typing.Optional[int]]: ...
    def getCursorPosition(self) -> typing.Tuple[typing.Optional[int], typing.Optional[int]]: ...
    ...
    def findFirstInSelection(self, expr: typing.Optional[str], re: bool, cs: bool, wo: bool, forward: bool = ..., show: bool = ..., posix: bool = ..., cxx11: bool = ...) -> bool: ...
    def findFirst(self, expr: typing.Optional[str], re: bool, cs: bool, wo: bool, wrap: bool, forward: bool = ..., line: int = ..., index: int = ..., show: bool = ..., posix: bool = ..., cxx11: bool = ...) -> bool: ...
    ...
    @typing.overload
    def annotate(self, line: int, text: typing.Optional[str], style: int) -> None: ...
    @typing.overload
    def annotate(self, line: int, text: typing.Optional[str], style: 'QsciStyle') -> None: ...
    @typing.overload
    def annotate(self, line: int, text: 'QsciStyledText') -> None: ...
    @typing.overload
    def annotate(self, line: int, text: collections.abc.Iterable['QsciStyledText']) -> None: ...
    def apiContext(self, pos: int) -> typing.Tuple[list[str], int, int]: ...
...
class QsciAbstractAPIs(QtCore.QObject):
    ...
    def callTips(self, context: collections.abc.Iterable[typing.Optional[str]], commas: int, style: QsciScintilla.CallTipsStyle, shifts: collections.abc.Iterable[int]) -> list[str]: ...
    def autoCompletionSelected(self, selection: typing.Optional[str]) -> None: ...
    def updateAutoCompletionList(self, context: collections.abc.Iterable[typing.Optional[str]], list: collections.abc.Iterable[typing.Optional[str]]) -> list[str]: ...
    def lexer(self) -> typing.Optional['QsciLexer']: ...
...
class QsciAPIs(QsciAbstractAPIs):
    ...
    def savePrepared(self, filename: typing.Optional[str] = ...) -> bool: ...
    def loadPrepared(self, filename: typing.Optional[str] = ...) -> bool: ...
    def isPrepared(self, filename: typing.Optional[str] = ...) -> bool: ...
    def defaultPreparedName(self) -> str: ...
    def cancelPreparation(self) -> None: ...
    def prepare(self) -> None: ...
    def remove(self, entry: typing.Optional[str]) -> None: ...
    def load(self, fname: typing.Optional[str]) -> bool: ...
    def clear(self) -> None: ...
    def add(self, entry: typing.Optional[str]) -> None: ...
...
class QsciCommandSet(PyQt6.sip.wrapper):
    ...
    def find(self, command: QsciCommand.Command) -> typing.Optional[QsciCommand]: ...
    def boundTo(self, key: int) -> typing.Optional[QsciCommand]: ...
...
class QsciLexer(QtCore.QObject):
    ...
    def writeProperties(self, qs: QtCore.QSettings, prefix: typing.Optional[str]) -> bool: ...
    def readProperties(self, qs: QtCore.QSettings, prefix: typing.Optional[str]) -> bool: ...
    ...
    def setAPIs(self, apis: typing.Optional[QsciAbstractAPIs]) -> None: ...
    def refreshProperties(self) -> None: ...
    def editor(self) -> typing.Optional[QsciScintilla]: ...
    ...
    def keywords(self, set: int) -> typing.Optional[str]: ...
    ...
    def blockStartKeyword(self) -> typing.Tuple[typing.Optional[bytes], typing.Optional[int]]: ...
    def blockStart(self) -> typing.Tuple[typing.Optional[bytes], typing.Optional[int]]: ...
    def blockLookback(self) -> int: ...
    def blockEnd(self) -> typing.Tuple[typing.Optional[bytes], typing.Optional[int]]: ...
    def autoIndentStyle(self) -> int: ...
    def autoCompletionWordSeparators(self) -> list[str]: ...
    def autoCompletionFillups(self) -> typing.Optional[bytes]: ...
    def apis(self) -> typing.Optional[QsciAbstractAPIs]: ...
    def lexerId(self) -> int: ...
    def lexer(self) -> typing.Optional[str]: ...
...
class QsciLexerCustom(QsciLexer):
    ...
    def styleBitsNeeded(self) -> int: ...
    def setEditor(self, editor: typing.Optional[QsciScintilla]) -> None: ...
...
class QsciLexerRuby(QsciLexer):
    ...
    def blockEnd(self) -> typing.Tuple[typing.Optional[bytes], typing.Optional[int]]: ...
    def description(self, style: int) -> str: ...
    def keywords(self, a0: int) -> typing.Optional[str]: ...
    def defaultPaper(self, style: int) -> QtGui.QColor: ...
    def defaultFont(self, style: int) -> QtGui.QFont: ...
    def defaultEolFill(self, style: int) -> bool: ...
    def defaultColor(self, style: int) -> QtGui.QColor: ...
...
class QsciMacro(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QsciScintilla]) -> None: ...
    @typing.overload
    def __init__(self, asc: typing.Optional[str], parent: typing.Optional[QsciScintilla]) -> None: ...

    def endRecording(self) -> None: ...
    def startRecording(self) -> None: ...
    def play(self) -> None: ...
    def save(self) -> str: ...
    def load(self, asc: typing.Optional[str]) -> bool: ...
    def clear(self) -> None: ...
...
class QsciPrinter(QtPrintSupport.QPrinter):
    ...
    def wrapMode(self) -> QsciScintilla.WrapMode: ...
    @typing.overload
    def printRange(self, qsb: typing.Optional[QsciScintillaBase], painter: QtGui.QPainter, from_: int = ..., to: int = ...) -> int: ...
    @typing.overload
    def printRange(self, qsb: typing.Optional[QsciScintillaBase], from_: int = ..., to: int = ...) -> int: ...
...
class QsciStyle(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, style: int, description: typing.Optional[str], color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], paper: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], font: QtGui.QFont, eolFill: bool = ...) -> None: ...
    @typing.overload
...
class QsciStyledText(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, text: typing.Optional[str], style: int) -> None: ...
    @typing.overload
    def __init__(self, text: typing.Optional[str], style: QsciStyle) -> None: ...
    @typing.overload

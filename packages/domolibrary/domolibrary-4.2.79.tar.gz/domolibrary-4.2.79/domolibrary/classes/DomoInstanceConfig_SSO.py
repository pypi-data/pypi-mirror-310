...
class SSOConfig_UpdateError(dmde.ClassError):
    def __init__(self, errors_obj, res: rgd.ResponseGetData, cls_instance, domo_instance):
        message = json.dumps(errors_obj)
        super().__init__(res=res, message=message, cls_instance=cls_instance, entity_id=domo_instance)
...
class SSO_Config:
    ...
    @classmethod
    def _parent_from_json(cls, 
                          auth : dmda.DomoAuth,
                          obj : dict ,
                          raw : dict, # raw api response 
                          debug_prn : bool = False,  
                          **kwargs #parameters that will be passed to the class object (must be attributes of the class)
                          ):
        new_obj = {

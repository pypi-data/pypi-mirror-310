...
# %% auto 0
__all__ = ['Groups_GET_Error', 'SearchGroups_Error', 'search_groups_by_name', 'get_all_groups', 'get_group_by_id',
...
class Groups_GET_Error(dmde.RouteError):
    def __init__(
        self,
...
async def search_groups_by_name(
    ...
    if not res.is_success:
        raise Groups_GET_Error(res=res)

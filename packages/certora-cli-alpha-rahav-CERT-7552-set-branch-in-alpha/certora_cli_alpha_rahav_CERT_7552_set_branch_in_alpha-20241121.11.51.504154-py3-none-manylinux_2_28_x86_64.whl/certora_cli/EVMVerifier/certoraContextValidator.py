...
class CertoraContextValidator:
    ...
    def check_args_post_argparse(self) -> None:
        ...
        if package_name == Util.ALPHA_PACKAGE_NAME and not context.prover_version:
            raise Util.CertoraUserInputError('When using certora-cli-alpha-master, a specific branch must be supplied '
...
def set_relative_paths(context: CertoraContext) -> None:

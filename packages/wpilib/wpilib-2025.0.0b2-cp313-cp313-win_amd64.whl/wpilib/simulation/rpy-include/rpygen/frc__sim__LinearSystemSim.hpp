...
struct PyTrampolineCfg_frc__sim__LinearSystemSim : CfgBase
{
...
struct PyTrampoline_frc__sim__LinearSystemSim : PyTrampolineBase {
...
struct bind_frc__sim__LinearSystemSim {
  template <int S, int I, int O> using LinearSystem = frc::LinearSystem<S, I, O>;
  template <int I> using Vectord = frc::Vectord<I>;
  struct LinearSystemSim_Trampoline : rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>;
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_LinearSystemSim
      ...
      .def_readonly("_m_plant", &rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>::m_plant, py::doc("The plant that represents the linear system."))
      .def_readonly("_m_x", &rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>::m_x, py::doc("State vector."))
      .def_readonly("_m_u", &rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>::m_u, py::doc("Input vector."))
      .def_readonly("_m_y", &rpygen::PyTrampoline_frc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs, typename rpygen::PyTrampolineCfg_frc__sim__LinearSystemSim<States, Inputs, Outputs>>::m_y, py::doc("Output vector."))

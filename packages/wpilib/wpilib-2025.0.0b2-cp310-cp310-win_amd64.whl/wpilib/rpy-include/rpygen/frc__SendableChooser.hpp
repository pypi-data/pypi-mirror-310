...
struct bind_frc__SendableChooser {
  using CopyType [[maybe_unused]] = typename frc::SendableChooser<T>::CopyType;
  struct SendableChooser_Trampoline : rpygen::PyTrampoline_frc__SendableChooser<typename frc::SendableChooser<T>, T, typename rpygen::PyTrampolineCfg_frc__SendableChooser<T>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__SendableChooser<typename frc::SendableChooser<T>, T, typename rpygen::PyTrampolineCfg_frc__SendableChooser<T>>;

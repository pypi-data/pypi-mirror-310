...
struct PyTrampoline_frc__AnalogTriggerOutput : PyTrampolineBase_frc__AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_frc__AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__AnalogTriggerOutput;
    ...
    PyTrampoline_frc__AnalogTriggerOutput(const AnalogTrigger& trigger, AnalogTriggerType outputType) :
      PyTrampolineBase_frc__AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg>(trigger, outputType)
    {}
  #endif

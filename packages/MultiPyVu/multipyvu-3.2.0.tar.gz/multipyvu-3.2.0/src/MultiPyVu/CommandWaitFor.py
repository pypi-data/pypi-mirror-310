...
from .CommandField import SimulateFieldChange
from .CommandTemperature import SimulateTemperatureChange
...
class CommandWaitForBase(ICommand):
    ...
    def convert_state_dictionary(self, can_err: int) -> str:
        """

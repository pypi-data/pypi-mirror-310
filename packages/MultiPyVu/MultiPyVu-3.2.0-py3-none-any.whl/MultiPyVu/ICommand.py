...
from .IEventManager import Publisher, IObserver
...
class ICommandObserverSim(IObserver):
    def __init__(self,
                 i_sim_change: Type[ISimulateChange],
                #  instrument_name: str):
                ):
        super().__init__()
    ...
    @property
    def change_thread(self) -> ISimulateChange:
        return self._change_thread

    @change_thread.setter
    def change_thread(self, new: ISimulateChange):
        self._change_thread = new

    def get_sim_instance(self) -> ISimulateChange:
        """

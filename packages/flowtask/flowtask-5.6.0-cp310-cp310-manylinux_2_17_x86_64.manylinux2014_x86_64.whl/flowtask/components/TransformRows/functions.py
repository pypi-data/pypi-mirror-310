...
def rename_column(df: pandas.DataFrame, field: str, rename: str):
    """
...
def rename_prefix(df: pandas.DataFrame, field: str, prefix: str, multiple: bool = False) -> pandas.DataFrame:
    """
...
def into_columns(
    ...
    try:
        ...
        df_columns = pandas.DataFrame(df[field].to_list(), columns=column_names)
        df = pandas.concat([df, df_columns], axis=axis)
    except Exception as e:
        print(

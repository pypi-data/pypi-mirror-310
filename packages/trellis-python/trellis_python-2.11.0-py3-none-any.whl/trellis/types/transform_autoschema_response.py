...
__all__ = ["TransformAutoschemaResponse", "Data", "DataOperation", "DataOperationOperation", "Metadata"]


class DataOperationOperation(BaseModel):
    column_name: str
...
class DataOperation(BaseModel):
    ...
    operations: Optional[List[DataOperationOperation]] = None
    """Required when column_type is `object` or `list`.

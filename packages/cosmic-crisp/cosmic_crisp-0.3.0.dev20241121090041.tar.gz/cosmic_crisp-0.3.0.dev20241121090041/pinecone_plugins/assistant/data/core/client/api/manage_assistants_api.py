    ...
    def __init__(self, api_client=None):
        ...
        def __delete_file(
            ...
            **kwargs
            ...
            The `delete_file` endpoint [deletes an uploaded file](https://docs.pinecone.io/guides/assistant/delete-file) from an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __describe_file(
            ...
            **kwargs
            ...
            The `describe_file` endpoint provides the [current status and metadata of a file](https://docs.pinecone.io/guides/assistant/check-file-status) uploaded to an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __list_files(
            ...
            **kwargs
            ...
            The `list_files` endpoint returns a [list of all files in an assistant](https://docs.pinecone.io//guides/assistant/list-files), with an option to filter files with metadata.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

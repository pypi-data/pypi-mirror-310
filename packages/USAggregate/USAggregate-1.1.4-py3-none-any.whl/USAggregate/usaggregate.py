    ...
    def aggregate_columns(df, group_cols, numeric_agg, char_agg):
        ...
        for col in numeric_cols:
            ...
            if agg_func in agg_functions:
                agg_dict[col] = lambda x, func=agg_functions[agg_func]: func(x.dropna())
            else:
                raise ValueError(f"Invalid aggregation function '{agg_func}' for numeric column '{col}'")
        ...
        for col in char_cols:
            ...
            if agg_func in agg_functions:
                ...
                raise ValueError(f"Invalid aggregation function '{agg_func}' for character column '{col}'")

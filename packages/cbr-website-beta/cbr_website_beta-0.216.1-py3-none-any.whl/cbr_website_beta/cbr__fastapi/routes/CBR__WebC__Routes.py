...
from osbot_utils.utils.Str import safe_id, str_safe
...
class CBR__WebC__Routes(Fast_API_Routes):
    ...
    def __init__(self, **kwargs):
        ...
        self.templates = Jinja2Templates(directory=path_combine_safe(cbr_website_beta.path, 'apps/templates'))
    ...
    def cbr_webc(self, request: Request, version=None, path=None):
        ...
        params  = dict(request=request, version=version)

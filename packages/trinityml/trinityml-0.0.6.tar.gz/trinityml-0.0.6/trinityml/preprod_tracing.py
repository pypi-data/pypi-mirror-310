...
def record(experiment_name=None,questions=None, contexts=None, generated_prompts=None, answers=None, ground_truths=None, model_temperature=None, top_k=None, model_name=None, prompt_template=None,model_provider=None,API_key=None,total_output_token_count=None,top_p=None,system_prompt=None,user_prompt=None):
    """
    Function Overview:
    ...
    if not model_name or not top_k or not prompt_template or not model_temperature or not model_provider or not API_key or not total_output_token_count or not top_p:

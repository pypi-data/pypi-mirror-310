...
from .endpoints import CosmosHubEndpoints, Endpoints
...
class CosmosHubClientReleases(BaseModel):
    """Data structure for the different versions of the API."""
    ...
    suffix: str
    available_endpoints: list[CosmosHubEndpoints]


first_release = CosmosHubClientReleases(
    version=Release.V1,
    details={
        "version": "v1",
...
AllReleases: list[CosmosHubClientReleases] = []

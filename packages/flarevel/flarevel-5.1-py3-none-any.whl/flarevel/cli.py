...
import sys
import time
from flarevel.commands.make import make_model
from flarevel.commands.make import make_controller
...
cli.add_command(make_model, 'make:model')
cli.add_command(make_controller, 'make:controller')

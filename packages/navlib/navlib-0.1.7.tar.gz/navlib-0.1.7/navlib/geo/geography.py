...
) -> Tuple[Union[float, np.ndarray], Union[float, np.ndarray], int, str]:
    """
...
def deg2m_lon(
    ...
    Returns:
        Union[float, np.ndarray]: Longitude in meters.
...
def ll2xy(
    ...
    Returns:
        Tuple[Union[float, np.ndarray], Union[float, np.ndarray]]: xy coordinates.
...
def xy2ll(
    ...
    Returns:
        Tuple[Union[float, np.ndarray], Union[float, np.ndarray]]: Latitude and longitude.

...
"""
import traceback
from .music import Song, Playlist, Artist, Album, User, Lyric, Comment, CommentSet, HotCommentSet
import functools
...
def adapt_artist(content, object_id, all_size=True, hot_songs=True):
    ...
    try:
        ...
        artist.brief_desc = content['artist']['briefDesc'] if 'briefDesc' in content['artist'] else ''
        if all_size:

...
def generate_synthetic_dataset(df, numerical_columns, categorical_columns, target_column, synthetic_ratio=1.0, noise_level=0.01):
    """
    ...
    # Sample rows from the original dataset
    ...
    for col in categorical_columns:
        synthetic_data[col] = synthetic_data[col].apply(
            lambda x: np.random.choice(df[col].unique())
        )

...
class Config:
    liquid_electrum_url: "str";bitcoin_electrum_url: "str";mempoolspace_url: "str";working_dir: "str";network: "LiquidNetwork";payment_timeout_sec: "int";zero_conf_min_fee_rate_msat: "int";breez_api_key: "typing.Optional[str]";cache_dir: "typing.Optional[str]";zero_conf_max_amount_sat: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, liquid_electrum_url: "str", bitcoin_electrum_url: "str", mempoolspace_url: "str", working_dir: "str", network: "LiquidNetwork", payment_timeout_sec: "int", zero_conf_min_fee_rate_msat: "int", breez_api_key: "typing.Optional[str]", cache_dir: "typing.Optional[str]", zero_conf_max_amount_sat: "typing.Optional[int]"):
    ...
    def __str__(self):
        return "Config(liquid_electrum_url={}, bitcoin_electrum_url={}, mempoolspace_url={}, working_dir={}, network={}, payment_timeout_sec={}, zero_conf_min_fee_rate_msat={}, breez_api_key={}, cache_dir={}, zero_conf_max_amount_sat={})".format(self.liquid_electrum_url, self.bitcoin_electrum_url, self.mempoolspace_url, self.working_dir, self.network, self.payment_timeout_sec, self.zero_conf_min_fee_rate_msat, self.breez_api_key, self.cache_dir, self.zero_conf_max_amount_sat)
...
class PaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIGHTNING:
        swap_id: "str";description: "str";preimage: "typing.Optional[str]";bolt11: "typing.Optional[str]";bolt12_offer: "typing.Optional[str]";payment_hash: "typing.Optional[str]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";

        @typing.no_type_check
        def __init__(self,swap_id: "str", description: "str", preimage: "typing.Optional[str]", bolt11: "typing.Optional[str]", bolt12_offer: "typing.Optional[str]", payment_hash: "typing.Optional[str]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
        ...
        def __str__(self):
            return "PaymentDetails.LIGHTNING(swap_id={}, description={}, preimage={}, bolt11={}, bolt12_offer={}, payment_hash={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.preimage, self.bolt11, self.bolt12_offer, self.payment_hash, self.refund_tx_id, self.refund_tx_amount_sat)

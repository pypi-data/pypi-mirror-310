...
class GitLabracadabraUser(GitLabracadabraObject):
    ...
    CREATE_PARAMS = ['email', 'password', 'force_random_password', 'reset_password', 'skip_confirmation', 'name']

    IGNORED_PARAMS = ['password', 'force_random_password', 'reset_password', 'skip_confirmation', 'skip_reconfirmation']
    ...
    Get action.
    """
    def _state_action(self, current: str, target: str) -> Optional[str]:

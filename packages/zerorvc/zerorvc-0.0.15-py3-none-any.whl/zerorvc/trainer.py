...
class RVCTrainer:
    ...
    def run(
        ...
        if upload_to_hub is not None:
            ...
            def upload():
                nonlocal upload_state_dirty
                nonlocal upload_state_last
                ...
                while True:
                    ...
                    if (
                        upload_state_dirty
                        and time.time() - upload_state_last > 60 * upload_window_minutes
                    ):
                        upload_state_dirty = False
            ...
            upload_thread = Thread(target=upload, daemon=True)
            upload_thread.start()

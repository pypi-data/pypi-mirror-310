...
class Projection:
    ...
    def from_xy(self, x: float, y: float) -> tuple[float, float]:
        """
        Returns the latitude and longitude expressed in decimal degrees from the passed X and Y coordinates
        """
        pass

    def to_xy(self, latitude: float, longitude: float) -> tuple[float, float]:
        """
        Returns the X and Y coordinates from the passed latitude and longitude expressed in degrees
        """
        pass

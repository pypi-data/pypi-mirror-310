    ...
    class Chat:                                                   
        ...
        class Completions:                                        
            ...
            def create(                                                                     
                ...
                """                                                                        
                client, messages, role = self.api._set_defaults(                                          
                    model_name,                                                                       
                    messages,                                                                         
                    temperature,                                                                      
                )                                                               
                try:                                                                                  
                    if model_name in self.api.models["mistral_models"]:                                   
                    ...
                    elif model_name in self.api.models["anthropic_models"]:                               
                        temperature = 1 if float(temperature) > 1 else temperature                           
                        if cached is True:                                                            
                            response = client.messages.create(                                        
                                model=model_name,                                                     
                                max_tokens=self.api._get_max_tokens(model_name),                          
                                temperature=float(temperature),                                              
                                system=role,                                                          
                                messages=messages,                                                    
                            ).model_dump_json()                                                       
                    ...
                    elif model_name in self.api.models["gemini_models"]:                                  
                        formatted_messages = [                                                        
                    ...
                    elif model_name in self.api.models["grok_models"]:                                    
                    ...
                    elif model_name in self.api.models["openai_models"]:                                  
                        response = client.chat.completions.create(                                    
                            model=model_name,                                                         
                            temperature=float(temperature),                                                  
                            messages=messages,                                                        

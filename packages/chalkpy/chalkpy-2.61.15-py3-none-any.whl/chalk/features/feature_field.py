...
def feature(
    ...
    if cache_nulls == "evict_nulls":
        if cache_defaults == "evict_defaults":
            ...
            raise ValueError("Cannot evict nulls and not cache defaults. Did you mean to set `cache_nulls=False` or `cache_defaults=\"evict_defaults\"`?")
        ...
        if cache_defaults == "evict_defaults":
            raise ValueError("Cannot evict defaults and not cache nulls. Did you mean to set `cache_defaults=False` or `cache_nulls=\"evict_nulls\"`?")
        elif cache_defaults == False:

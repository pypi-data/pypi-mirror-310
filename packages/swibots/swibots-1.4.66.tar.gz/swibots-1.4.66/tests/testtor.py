...
BOT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTA2MSwiaXNfYm90Ijp0cnVlLCJhY3RpdmUiOnRydWUsImlhdCI6MTY5MDgyNzYwMSwiZXhwIjoyMzIxOTc5NjAxfQ.A0Qv6mHgqbBoWdkWiKkc9e0boKwBHwY4QdTR7yOAxUA"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
...
async def src_tor(ctx: BotContext[CommandEvent]):
    ...
    result = results[0]
    # mn = xn._prepare_response()
    inline_markup=InlineMarkup([[InlineKeyboardButton("Manget Link 🔗", callback_data=f"link_{id}_{event.id}_{event.user_id}")]])
    await event.edit_text(result[0], inline_markup=inline_markup)
...
async def _bck(ctx: BotContext[CallbackQueryEvent]):
    ...
    if index > 0:
        ...
        # mn = msg._prepare_response()
        # mn.message= result[0]
        # mn.inline_markup = InlineMarkup(btn)
#        return await bot.edit_message(mn)

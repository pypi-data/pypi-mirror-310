...
# 原DP库 使用文档地址  http://drissionpage.cn/
...
class Tool:
    @staticmethod
    def pause(t:ChromiumTab):
        t.run_js(Config.eles_code)
        input('当前调试程序暂停中，按任意键继续...')  



    @staticmethod
    def get_json_by_js_fetch(tab:ChromiumTab,fetch_code:str,show_result=False):
...
class NewPage:
    def __init__(self,browser:ChromiumPage,url):
        self.url = url 

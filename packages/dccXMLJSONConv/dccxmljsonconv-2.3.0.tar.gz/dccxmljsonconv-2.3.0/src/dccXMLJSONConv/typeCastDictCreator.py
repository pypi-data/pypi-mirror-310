...
class XSDParser:
    ...
    def create_python_typecast_dict(self):
        ...
        return non_list_typecast_dict, list_typecast_dict
...
class XSDParserCacheWrapper:
    ...
    def parse_with_cache(self, url, namespace='dcc', version=None):
        ...
        if cache_key_str in self.cache:
            ...
            non_list_typecast_dict, list_typecast_dict = parser.create_python_typecast_dict()
...
# Example usage of the wrapper class
    ...
    for schmeaURL in schmaURLS:
        non_list_typecast_dict, list_typecast_dict = cache_wrapper.parse_with_cache(schmeaURL, namespace='dcc')

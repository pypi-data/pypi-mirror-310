...
class Counter(Container):
    ...
    def __init__(self, viewer: "napari.viewer.Viewer"):
        ...
        self._batch_size = LineEdit(label="Initial Batch Size", value="128")
    ...
    def _estimate_diam(self):
        ...
        if roi_layer is None or len(roi_layer.data) == 0:
            ...
            image = get_image_roi(image_layer.data, roi_layer.data[0])

        from .counter import estimate_diameter
        estimate_diam_worker = create_worker(estimate_diameter, image, self._cp_models.value, self._use_gpu.value)

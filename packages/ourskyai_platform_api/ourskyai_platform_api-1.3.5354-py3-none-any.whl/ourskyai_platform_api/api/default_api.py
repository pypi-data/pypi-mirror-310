...
class DefaultApi:
    ...
    @validate_arguments
    def v1_complete_bootstrap(self, v1_node_controller_bootstrap_request : V1NodeControllerBootstrapRequest, **kwargs) -> EmptySuccess:  # noqa: E501
        ...
        >>> thread = api.v1_complete_bootstrap(v1_node_controller_bootstrap_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.v1_complete_bootstrap_with_http_info(v1_node_controller_bootstrap_request, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_complete_bootstrap_with_http_info(self, v1_node_controller_bootstrap_request : V1NodeControllerBootstrapRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_complete_bootstrap  # noqa: E501
        ...
        >>> thread = api.v1_complete_bootstrap_with_http_info(v1_node_controller_bootstrap_request, async_req=True)
        >>> result = thread.get()

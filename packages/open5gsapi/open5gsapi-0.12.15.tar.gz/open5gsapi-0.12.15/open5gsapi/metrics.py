...
class NetworkMetricsCalculator:
    ...
    def _calculate_jitter(self, timestamps: deque) -> float:
        """Original jitter calculation that was working"""
        if len(timestamps) < 2:
            return 0.0
        jitter = 0.0
    ...
    def record_data_received(self, data: Any, timestamp: float, content_type: str) -> None:
        with self.metrics_lock:
            try:
                ...
                # Always store timestamp for jitter calculation
                self.packet_timestamps.append(timestamp)  # Add this line
            ...
            try:
                ...
                metrics = {
                    ...
                    "latency": {
                        ...
                        "jitter_ms": self._calculate_jitter(self.packet_timestamps)  # Use original jitter calculation
                    }
                }

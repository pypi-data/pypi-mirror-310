...
"Active DE" as active_de, "Active Web DE" as active_web_de, "Role Coordinator" as product_coordinator, 
...
"Actual Price" as actual_price, "Department" as department, "Sales Area" as sales_area
 from rusta_dw.public."Item" where "Company" = 22 and "Active Web DE" = 'Yes' and "Life Cycle Status" = 'Active'  and

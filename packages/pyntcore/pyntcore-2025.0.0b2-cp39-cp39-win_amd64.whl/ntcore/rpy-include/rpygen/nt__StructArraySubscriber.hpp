...
struct bind_nt__StructArraySubscriber {
  ...
  using ParamType [[maybe_unused]] = typename nt::StructArraySubscriber<T, I>::ParamType;
  using TimestampedValueType [[maybe_unused]] = typename nt::StructArraySubscriber<T, I>::TimestampedValueType;
  struct StructArraySubscriber_Trampoline : rpygen::PyTrampoline_nt__StructArraySubscriber<typename nt::StructArraySubscriber<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructArraySubscriber<T, I>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_nt__StructArraySubscriber<typename nt::StructArraySubscriber<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructArraySubscriber<T, I>>;

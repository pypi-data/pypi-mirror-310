...
struct bind_nt__StructSubscriber {
  ...
  using ParamType [[maybe_unused]] = typename nt::StructSubscriber<T, I>::ParamType;
  using TimestampedValueType [[maybe_unused]] = typename nt::StructSubscriber<T, I>::TimestampedValueType;
  struct StructSubscriber_Trampoline : rpygen::PyTrampoline_nt__StructSubscriber<typename nt::StructSubscriber<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructSubscriber<T, I>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_nt__StructSubscriber<typename nt::StructSubscriber<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructSubscriber<T, I>>;

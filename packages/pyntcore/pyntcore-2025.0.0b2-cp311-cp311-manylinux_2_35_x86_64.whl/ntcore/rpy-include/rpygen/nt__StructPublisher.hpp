...
struct bind_nt__StructPublisher {
  ...
  using ParamType [[maybe_unused]] = typename nt::StructPublisher<T, I>::ParamType;
  using TimestampedValueType [[maybe_unused]] = typename nt::StructPublisher<T, I>::TimestampedValueType;
  struct StructPublisher_Trampoline : rpygen::PyTrampoline_nt__StructPublisher<typename nt::StructPublisher<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructPublisher<T, I>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_nt__StructPublisher<typename nt::StructPublisher<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructPublisher<T, I>>;

...
struct bind_nt__StructArrayPublisher {
  ...
  using ParamType [[maybe_unused]] = typename nt::StructArrayPublisher<T, I>::ParamType;
  using TimestampedValueType [[maybe_unused]] = typename nt::StructArrayPublisher<T, I>::TimestampedValueType;
  struct StructArrayPublisher_Trampoline : rpygen::PyTrampoline_nt__StructArrayPublisher<typename nt::StructArrayPublisher<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructArrayPublisher<T, I>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_nt__StructArrayPublisher<typename nt::StructArrayPublisher<T, I>, T, I, typename rpygen::PyTrampolineCfg_nt__StructArrayPublisher<T, I>>;

...
class Motivate:
    ...
    class username:
        ...
        def __init__(self,name:str):
            ...
            self.pronoun = "Mr"
            self.name = name
            print( Style.BRIGHT + f"""Welcome {Fore.CYAN}{self.name}{Style.RESET_ALL} !, {Fore.BLACK} this is my first package {Style.RESET_ALL}""")
            print( Fore.LIGHTWHITE_EX + f"Nice to meet you, {self.pronoun}.{self.name} ")

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/gui/../icons/3d bar chart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.main_window_buttons_hLayout.setObjectName("main_window_buttons_hLayout")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "DRAN v1.0"))
        self.btn_edit_driftscan.setText(_translate("MainWindow", "Edit Driftscan"))
        self.btn_edit_timeseries.setText(_translate("MainWindow", "Edit Time series"))

...
Refer to the Terraform Registry for docs: [`digitalocean_database_user`](https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user).
'''
...
class DatabaseUser(
    ...
    def __init__(
        ...
        *,
        ...
        :param cluster_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#cluster_id DatabaseUser#cluster_id}.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#name DatabaseUser#name}.
        ...
        :param mysql_auth_plugin: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#mysql_auth_plugin DatabaseUser#mysql_auth_plugin}.
        :param settings: settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#settings DatabaseUser#settings}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DatabaseUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#import import section} in the documentation of this resource for the id to use
...
class DatabaseUserSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param acl: acl block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#acl DatabaseUser#acl}
        :param opensearch_acl: opensearch_acl block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#opensearch_acl DatabaseUser#opensearch_acl}
        '''
        if __debug__:
...
class DatabaseUserSettingsAcl:
    def __init__(self, *, permission: builtins.str, topic: builtins.str) -> None:
        '''
        :param permission: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#permission DatabaseUser#permission}.
        :param topic: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#topic DatabaseUser#topic}.
        '''
        if __debug__:
...
class DatabaseUserSettingsOpensearchAcl:
    def __init__(self, *, index: builtins.str, permission: builtins.str) -> None:
        '''
        :param index: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#index DatabaseUser#index}.
        :param permission: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/database_user#permission DatabaseUser#permission}.
        '''
        if __debug__:

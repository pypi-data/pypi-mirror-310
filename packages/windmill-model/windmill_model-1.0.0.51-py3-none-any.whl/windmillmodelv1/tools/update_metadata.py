...
def update_metadata(args):
    ...
    # 3. update metadata
    metadata = model_update_metadata(graph=graph, model_metadata=response.metadata, input_uri=model_uri)

    # 4. update artifact
    windmill_client.update_artifact(name=args.model_name, metadata=metadata)

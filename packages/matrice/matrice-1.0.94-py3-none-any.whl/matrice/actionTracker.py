...
class ActionTracker:
    ...
    def _log_action_benchmark_results(self):
        ...
        try:
            if self.action_type == "model_train":
                ...
                self.save_benchmark_results(
                    latency_ms=(self.model_upload_time - self.model_download_time)
                    * 1000
                )
        except Exception as e:
    ...
    def store_inference_results(self, images, predictions):
        # TODO: store the images and predictions in the database
        pass

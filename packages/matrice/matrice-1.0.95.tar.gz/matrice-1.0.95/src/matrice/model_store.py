...
class BYOM:
    ...
    def get_user_code_upload_path(self):
        path = "/v1/model_store/get_user_code_upload_path"
        resp = self.rpc.get(path=path)
        return handle_response(resp, "Upload path retrieved", "Error getting upload path")

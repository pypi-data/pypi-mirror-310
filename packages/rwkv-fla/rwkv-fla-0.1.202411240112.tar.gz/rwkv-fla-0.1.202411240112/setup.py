...
class PostInstallCommand(install):
    def run(self):
        ...
        fla_path = install_path / 'fla'
        rwkvfla_path = install_path / 'rwkvfla'
        
        print(f"Creating symlink in {install_path}")
        if fla_path.exists() and not rwkvfla_path.exists():
            os.symlink(str(fla_path), str(rwkvfla_path))
            print(f"Created symlink from {rwkvfla_path} to {fla_path}")

...
class LlamaLitAPI(ls.LitAPI):
    def setup(self, device):
        ...
        # Download model
        subprocess.run(["wget", "-O", model_path, "https://huggingface.co/Mozilla/Llama-3.2-1B-Instruct-llamafile/resolve/main/Llama-3.2-1B-Instruct.Q6_K.llamafile"], check=True)

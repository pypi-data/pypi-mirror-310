...
class Singularity(AzureML):
    ...
    def submit_node_run(self, job_id, node_run, xt_ws_name, aml_ws_name, xt_exper_name, aml_exper_name, 
        ...
        if vc_name in ["dell1", "kings01", "kings02", "kings03", "kings04", "kings05", "kings06", "kings07", "kings08", "kings09", "kings10", "kings11", "kings12", "mckinley01", "mckinley02", "mckinley03", "mckinley04", "mckinley05", "mckinley06", "mckinley07", "mckinley08", "barlow01", "barlow02", "barlow03", "barlow04", "barlow05", "barlow06", "barlow07", "barlow08", "barlow09", "msrresrchlab"]:
        ...
        elif vc_name in ["msrresrchvc", "msrreschlab", "msrreschbasic"]:

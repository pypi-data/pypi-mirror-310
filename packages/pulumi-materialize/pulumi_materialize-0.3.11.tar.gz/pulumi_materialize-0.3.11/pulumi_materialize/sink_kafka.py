...
class SinkKafkaArgs:
    def __init__(__self__, *,
                 ...
                 partition_by: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] partition_by: A SQL expression used to partition the data in the Kafka sink. Can only be used with `ENVELOPE UPSERT`.
    ...
    def partition_by(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @partition_by.setter
    def partition_by(self, value: Optional[pulumi.Input[str]]):
...
class SinkKafka(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="partitionBy")
    def partition_by(self) -> pulumi.Output[Optional[str]]:
        """
        A SQL expression used to partition the data in the Kafka sink. Can only be used with `ENVELOPE UPSERT`.
        """
        return pulumi.get(self, "partition_by")

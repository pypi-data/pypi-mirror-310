...
class SecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The identifier for the secret database in Materialize. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        ...
        :param pulumi.Input[str] schema_name: The identifier for the secret schema in Materialize. Defaults to `public`.
        """

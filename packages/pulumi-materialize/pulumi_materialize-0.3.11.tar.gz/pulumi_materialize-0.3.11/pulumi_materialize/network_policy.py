...
class NetworkPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the network policy.
...
class NetworkPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkPolicyRuleArgs']]]]] = None,
                 __props__=None):
        """
        ...
        ```
         ...
         The network_policy_id is the ID of the network policy. You can find it from the `mz_internal.mz_network_policy_rules` table in the materialize The region is the region where the database is located (e.g. aws/us-east-1)
        ...
        :param pulumi.Input[str] name: The name of the network policy.
        :param pulumi.Input[str] region: The region to use for the resource connection. If not set, the default region is used.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkPolicyRuleArgs']]]] rules: Rules for the network policy.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NetworkPolicyRuleArgs']]]]] = None) -> 'NetworkPolicy':
        """

...
class ConnectionKafka(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 aws_connection: Optional[pulumi.Input[pulumi.InputType['ConnectionKafkaAwsConnectionArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectionKafkaAwsConnectionArgs']] aws_connection: The AWS connection to use for IAM authentication.

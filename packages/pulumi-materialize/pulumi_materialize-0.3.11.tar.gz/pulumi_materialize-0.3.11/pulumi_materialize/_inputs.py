...
class NetworkPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[str]):
        """
        :param pulumi.Input[str] action: The action to take for this rule. Currently only 'allow' is supported.
        :param pulumi.Input[str] address: The CIDR block the rule will be applied to.
        :param pulumi.Input[str] direction: The direction of traffic the rule applies to. Currently only 'ingress' is supported.

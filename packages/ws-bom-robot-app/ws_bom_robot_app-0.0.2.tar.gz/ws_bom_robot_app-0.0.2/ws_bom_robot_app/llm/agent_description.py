...
class AgentDescriptor:
    ...
    def add_strategy(cls,name: str, strategy: AgentDescriptorStrategy):
        """_summary_
        ...
        """
        cls._list[name.lower()] = strategy

    def get_strategy(cls,name: str) -> AgentDescriptorStrategy:
        return cls._list.get(name.lower(), DefaultAgentDescriptor())

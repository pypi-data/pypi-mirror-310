...
async def formats_from_request(request: Request,
                               ...
                               link_callback: Callable[[int, representor.Link], None] | None = None) -> tuple[bytes, str]:
    """
    ...
    return await representor.formats(request, run_time_docs, link_callback=link_callback), representor.MIME_TYPE

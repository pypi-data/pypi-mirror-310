...
if __name__ == '__main__':
    ...
    Transits = Windows(
        table = ATREIDES.table,
        directory= './PTO_partial_transits_K2-39b/',
    )
    for P in [115, 116, 117]:
        Transits.get_dates_for_ESO_semester(P)
        Transits.directory = f'/media/chamaeleontis/Observatory_main/ESO_scheduling/ESO_{P}_PTO_partial_transits_K2-39b/'

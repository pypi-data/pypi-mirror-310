...
setup(
    ...
    download_url = 'https://github.com/kaunghtetsan275/pyidaungsu/archive/0.1.4.tar.gz',
    install_requires=['numpy','python-crfsuite','emoji','pybind11','fasttext-numpy2-wheel'],

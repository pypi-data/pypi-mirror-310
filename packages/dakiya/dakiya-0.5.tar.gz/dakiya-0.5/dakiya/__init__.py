...
class Transmitter:
    def send_x(self, what, template, app_name, *k, **kw):
        print("HERE", what, template, app_name, k, kw)
    ...
    def __getattr__(self, name):
        ...
        def fn(template, app_name, *k, **kw):
            return self.send_x(name, template, app_name, *k, **kw)

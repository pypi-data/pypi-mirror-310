...
<div style="text-align: center;">
  ...
  <div style="display: inline-block;">
    <a href="https://www.linkedin.com/in/vishnu-k-8a058425b/" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/Linkedin_icon.svg" alt="LinkedIn" style="max-width:30px; max-height:30px; margin-right: 15px;">
    </a>
    <a href="mailto:vishnuknandanam@gmail.com" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Gmail_Icon.png" alt="Email" style="max-width:30px; max-height:30px; margin-right: 15px;">
    </a>
    <a href="https://github.com/Vishnuk4906" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg" alt="GitHub" style="max-width:30px; max-height:30px;">
    </a>
  </div>
</div>

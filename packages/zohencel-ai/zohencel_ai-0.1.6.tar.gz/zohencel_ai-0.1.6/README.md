<div style="text-align: center;">
  <img src="https://raw.githubusercontent.com/Vishnuk4906/zohencel-ai-utils/main/zailogo.PNG" alt="Zohencel-AI Logo" style="width: 20%; height: auto;">
</div>
...
5. **Limitations**: Memory context is not available in the current version, it will be in the upcoming version.
## 📸 Sample Images
...
We are excited to introduce **ML Bot**, an intelligent assistant that will help you train and test machine learning models end-to-end, all through simple queries. 
...
<div style="text-align: center;">
  ...
  <div style="display: inline-block;">
    <a href="https://www.linkedin.com/in/vishnu-k-8a058425b/" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/Linkedin_icon.svg" alt="LinkedIn" style="width:30px; height:auto; margin-right: 15px;">
    </a>
    <a href="mailto:vishnuknandanam@gmail.com" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Gmail_Icon.png" alt="Email" style="width:30px; height:auto; margin-right: 15px;">
    </a>
    <a href="https://github.com/Vishnuk4906" target="_blank">
      <img src="https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg" alt="GitHub" style="width:30px; height:auto;">
    </a>
  </div>
</div>

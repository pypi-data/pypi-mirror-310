...
class Trademarks(ExtractBase):
    ...
    def unpack_archive(self, archive, dest):
        ...
        for result in results:
            try:
                appnum = result["trademarkApplication"]["trademarkBag"]["trademark"][0]["trademarkTypeChoice1"]["applicationNumber"][0]["applicationNumberText"]
                # sanitize
                ...
                if len(appnum)<9:
                    # mising year prefix
                    try:
                        appdate = result["trademarkApplication"]["trademarkBag"]["trademark"][0]["trademarkTypeChoice2"]["applicationDate"]
                        # get the year
            ...
            # get the image url
            try:
                img_uri = result["trademarkApplication"]["trademarkBag"]["trademark"][0]["markRepresentation"]["markReproduction"]["markImageBag"]["markImage"][0]["fileName"]            

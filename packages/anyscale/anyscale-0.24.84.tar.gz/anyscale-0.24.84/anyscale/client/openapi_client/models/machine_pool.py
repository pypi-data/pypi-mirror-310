...
class MachinePool(object):
    ...
    def __init__(self, machine_pool_name=None, machine_pool_id=None, organization_id=None, cloud_ids=None, enable_rootless_dataplane_config=False, local_vars_configuration=None):  # noqa: E501

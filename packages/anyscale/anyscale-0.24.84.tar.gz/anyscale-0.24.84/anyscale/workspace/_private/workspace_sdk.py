        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            if is_pull:
                ...
                if (
                    ...
                    and os.listdir(destination)
                ):
                    click.echo(
                        f"WARNING: {destination} is not empty. Workspace pull will delete all files in this directory and replace them with the contents of the workspace."
                    )
                    if not click.confirm("Do you want to continue?"):
                        click.echo("Workspace pull canceled.")
                        return
            else:
                source = local_dir

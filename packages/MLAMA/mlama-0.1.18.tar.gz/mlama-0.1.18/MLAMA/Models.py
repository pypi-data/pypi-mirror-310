...
def gen_ml(wave,test_length,parameter_length,lag_reserve,max_prediction_length, resid):#generate train, test from whole data
    ...
    print('test_length:',test_length, finaldf.tail(1))
    if resid == False :

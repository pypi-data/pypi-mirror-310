...
class Wave:
  ...
  def __init__(self, waveID, startDate, endDate,
               trainStartDate, trainEndDate, testStartDate, testEndDate, max_delay, df):
    """
  ...
  def get_wave_dates_with_delay_JMM(self, delay, delayed_start_matrix):#JMM definition.
    """
  ...
  def get_wave_dates_with_delay_yushu(self, delay, delayed_start_matrix):#yushu definition.
    """
    Gets the wave data, train data, and test data after calculating delay.
  ...
  def get_wave_dates_with_delay(self, delay, delayed_start_matrix,Yushu):
    """
    Gets the wave data, train data, and test data after calculating delay.
    ...
    """
    if Yushu == False:
      return self.get_wave_dates_with_delay_JMM(delay, delayed_start_matrix)

    return self.get_wave_dates_with_delay_yushu(delay, delayed_start_matrix)

#####################################

def generate_test_start_date(test_end_date, test_length):
  """
...
def generate_train_end_date(wave_end_date, test_length):
  """

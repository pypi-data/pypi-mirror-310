...
class EclypseMetric(EclypseCallback):
    """Class for a metric that will be used during the simulation for reporting purposes."""
...
class EclypseMetricWrapper(EclypseMetric):
    """A class that wraps a function into a metric object, that can be         managed by the Simulator."""

                    ...
                    if liminaire is not None:
                        ...
                        if grtitre is not None:
                            ...
                            if titre is not None:
                                title, text, sentences = add_paragraph(tree, text, sentences, None, titre, css=MY_CSS_PROFILE)
                        ...
                        if params.resume:
                            ...
                            if resume is not None and resume.get('lang', 'fr') == 'fr':
                                _, text, sentences = add_paragraph(tree, text, sentences, None, resume, css=MY_CSS_PROFILE)

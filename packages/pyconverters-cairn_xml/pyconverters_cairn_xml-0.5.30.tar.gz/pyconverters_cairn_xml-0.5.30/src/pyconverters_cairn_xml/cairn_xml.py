                ...
                for article in tree.iter("article"):
                    ...
                    if liminaire is not None:
                        ...
                        if chapo is not None:
                            _, text, sentences = add_paragraph(tree, text, sentences, None, chapo)
                        if params.resume:

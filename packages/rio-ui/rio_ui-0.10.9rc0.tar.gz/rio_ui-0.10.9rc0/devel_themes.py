...
class ThemeViewer(rio.Component):
    def build(self) -> rio.Component:
        ...
        for col in theme_colors:
            light_theme = rio.theme._create_new_theme(
                primary_color=col,
                mode="light",
            )

            dark_theme = rio.theme._create_new_theme(
                primary_color=col,
                mode="dark",
            )
...
app = rio.App(
    build=ThemeViewer,
    theme=(
        rio.theme._create_new_theme(mode="light"),
        rio.theme._create_new_theme(mode="dark"),
    ),
    default_attachments=[],
)

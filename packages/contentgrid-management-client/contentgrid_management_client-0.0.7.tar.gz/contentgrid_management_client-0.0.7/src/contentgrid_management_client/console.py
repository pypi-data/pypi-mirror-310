...
class AttributeConstraint(InteractiveHALResponse):
    ...
    def valid(data: dict) -> bool:
        return 'type' in data and data['type'] in ConstraintType and ConstraintType(data['type']) in constraint_map
...
class AttributeSearchOption(InteractiveHALResponse):
    ...
    @staticmethod
    def valid(data: dict) -> bool:
        return 'type' in data and data['type'] in SearchType and SearchType(data['type']) in search_option_map

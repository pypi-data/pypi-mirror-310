...
def select_top_files(filtered_files, llm, max_files=5):
    """Select the most important files for README generation."""
    select_top_files_template = """
...
def main(mode, llm, short, max_tokens):
    try:
        ...
        if mode == 'readme':
            ...
            try:
                top_selected_files = select_top_files(filtered_files, llm_instance)

...
class DatasetHandler:
    ...
    async def validate_dataset(self, dataset_id: str) -> bool:
        ...
        path = DatasetStoragePaths.dataset_path(self.user_id, dataset_id)
    ...
    async def upload_dataset(self, file_content: bytes, filename: str) -> DatasetMetadata:
        ...
        try:
            ...
            raw_path = f"{DatasetStoragePaths.raw_path(self.user_id, dataset_id)}/{filename}"
    ...
    async def delete_dataset(self, dataset_id: str) -> Dict:
        ...
        dataset_path = DatasetStoragePaths.dataset_path(self.user_id, dataset_id)

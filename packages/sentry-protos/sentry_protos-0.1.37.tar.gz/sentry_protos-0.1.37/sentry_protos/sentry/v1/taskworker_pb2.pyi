...
class SetTaskStatusRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_fetch_next", b"_fetch_next", "fetch_next", b"fetch_next"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_fetch_next", b"_fetch_next", "fetch_next", b"fetch_next", "id", b"id", "status", b"status"]) -> None: ...

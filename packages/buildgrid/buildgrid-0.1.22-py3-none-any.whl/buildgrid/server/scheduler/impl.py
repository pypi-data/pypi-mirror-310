...
class Scheduler:
    ...
    def synchronize_bot_lease(
        ...
        bot_id: str,
        bot_status: int,
        session_lease: Optional[Lease],
        partial_execution_metadata: Optional[Dict[str, ExecutedActionMetadata]] = None,
    ) -> Optional[Lease]:
        log_tags = {
            "instance_name": try_current_instance(),
    ...
    def get_execute_action_metadata(self, job: JobEntry) -> ExecutedActionMetadata:
        ...
        def assign_timestamp(field: Timestamp, timestamp: Optional[datetime]) -> None:

...
class ZbDjangoAuth(AppConfig):
    ...
    def ready(self):
        ...
        settings.ZB_AUTH_DEFAULT_PASSWORD_LENGTH = getattr(settings, "ZB_AUTH_DEFAULT_PASSWORD_LENGTH", 8)
        ...
        settings.ZB_AUTH_SECURE_PASSWORD_LENGTH = getattr(settings, "ZB_AUTH_SECURE_PASSWORD_LENGTH", 12)

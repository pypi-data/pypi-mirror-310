    ...
    namespace phoenix6
    {
        namespace spns
        {
            ...
            public:
                ...
                static constexpr int CustomParam0 = 818;
                static constexpr int CustomParam1 = 819;
                static constexpr int CANcoder_SensorDirection = 823;
                static constexpr int FrcLock = 825;
                static constexpr int RobotEnabled = 826;
                static constexpr int LED1_OnColor = 828;
                static constexpr int LED1_OffColor = 829;
                static constexpr int LED2_OnColor = 830;
                static constexpr int LED2_OffColor = 831;
                static constexpr int AllFaults = 837;
                static constexpr int AllStickyFaults = 838;
                static constexpr int Pigeon2UseCompass = 912;
                static constexpr int Pigeon2DisableTemperatureCompensation = 947;
                static constexpr int Pigeon2DisableNoMotionCalibration = 949;
                static constexpr int Pigeon2MountPoseYaw = 954;
                static constexpr int Pigeon2MountPosePitch = 955;
                static constexpr int Pigeon2MountPoseRoll = 956;
                static constexpr int Pigeon2GyroScalarX = 960;
                static constexpr int Pigeon2GyroScalarY = 961;
                static constexpr int Pigeon2GyroScalarZ = 962;
                static constexpr int Pigeon2Yaw = 969;
                static constexpr int Pigeon2Pitch = 970;
                static constexpr int Pigeon2Roll = 971;
                static constexpr int Pigeon2QuatW = 972;
                static constexpr int Pigeon2QuatX = 973;
                static constexpr int Pigeon2QuatY = 974;
                static constexpr int Pigeon2QuatZ = 975;
                static constexpr int Pigeon2GravityVectorX = 976;
                static constexpr int Pigeon2GravityVectorY = 977;
                static constexpr int Pigeon2GravityVectorZ = 978;
                static constexpr int Pigeon2Temperature = 979;
                static constexpr int Pigeon2NoMotionCalEnabled = 980;
                static constexpr int Pigeon2NoMotionCount = 981;
                static constexpr int Pigeon2TempCompDisabled = 982;
                static constexpr int Pigeon2UpTime = 983;
                static constexpr int Pigeon2AccumGyroX = 984;
                static constexpr int Pigeon2AccumGyroY = 985;
                static constexpr int Pigeon2AccumGyroZ = 986;
                static constexpr int Pigeon2AngularVelocityXWorld = 987;
                static constexpr int Pigeon2AngularVelocityYWorld = 988;
                static constexpr int Pigeon2AngularVelocityZWorld = 989;
                static constexpr int Pigeon2AccelerationX = 990;
                static constexpr int Pigeon2AccelerationY = 991;
                static constexpr int Pigeon2AccelerationZ = 992;
                static constexpr int Pigeon2_SupplyVoltage = 993;
                static constexpr int Pigeon2AngularVelocityX = 996;
                static constexpr int Pigeon2AngularVelocityY = 997;
                static constexpr int Pigeon2AngularVelocityZ = 998;
                ...
                static constexpr int Pigeon2RawMagneticFieldX = 1004;
                static constexpr int Pigeon2RawMagneticFieldY = 1005;
                static constexpr int Pigeon2RawMagneticFieldZ = 1006;
                static constexpr int CANCoder_MagnetOffset = 1007;
                static constexpr int CANcoder_AbsoluteSensorRange = 1008;
                static constexpr int TalonFX_SetSensorPosition = 1012;
                static constexpr int CANcoder_SetSensorPosition = 1014;
                static constexpr int Pigeon2_SetYaw = 1016;
                static constexpr int DeviceEnabled = 1045;
                static constexpr int PRO_MotorOutput_MotorVoltage = 2024;
                static constexpr int ForwardLimit = 2025;
                static constexpr int ReverseLimit = 2026;
                static constexpr int PRO_MotorOutput_RotorPolarity = 2027;
                static constexpr int PRO_MotorOutput_DutyCycle = 2028;
                static constexpr int PRO_MotorOutput_TorqueCurrent = 2030;
                static constexpr int PRO_SupplyAndTemp_StatorCurrent = 2031;
                static constexpr int PRO_SupplyAndTemp_SupplyCurrent = 2032;
                static constexpr int PRO_SupplyAndTemp_SupplyVoltage = 2033;
                static constexpr int PRO_SupplyAndTemp_DeviceTemp = 2034;
                static constexpr int PRO_SupplyAndTemp_ProcessorTemp = 2035;
                static constexpr int PRO_RotorPosAndVel_Velocity = 2037;
                static constexpr int PRO_RotorPosAndVel_Position = 2038;
                static constexpr int PRO_PosAndVel_Velocity = 2041;
                static constexpr int PRO_PosAndVel_Position = 2042;
                static constexpr int PRO_PosAndVel_Acceleration = 2043;
                static constexpr int PRO_PIDStateEnables_IntegratedAccum_DC = 2045;
                static constexpr int PRO_PIDStateEnables_IntegratedAccum_V = 2046;
                static constexpr int PRO_PIDStateEnables_IntegratedAccum_A = 2047;
                static constexpr int PRO_PIDStateEnables_FeedForward_DC = 2048;
                static constexpr int PRO_PIDStateEnables_FeedForward_V = 2049;
                static constexpr int PRO_PIDStateEnables_FeedForward_A = 2050;
                static constexpr int TalonFX_ControlMode = 2051;
                static constexpr int PRO_PIDStateEnables_IsMotionMagicRunning = 2055;
                static constexpr int PRO_PIDStateEnables_DeviceEnable = 2057;
                static constexpr int PRO_PIDRefPIDErr_PIDRef_Position = 2059;
                static constexpr int PRO_PIDRefPIDErr_PIDRef_Velocity = 2060;
                static constexpr int PRO_PIDRefPIDErr_PIDErr_Position = 2061;
                static constexpr int PRO_PIDRefPIDErr_PIDErr_Velocity = 2062;
                static constexpr int PRO_PIDRefPIDErr_ClosedLoopMode = 2063;
                static constexpr int PRO_PIDOutput_PIDOutputMode = 2065;
                static constexpr int PRO_PIDOutput_ProportionalOutput_DC = 2066;
                static constexpr int PRO_PIDOutput_ProportionalOutput_V = 2067;
                static constexpr int PRO_PIDOutput_ProportionalOutput_A = 2068;
                static constexpr int PRO_PIDOutput_DerivativeOutput_DC = 2069;
                static constexpr int PRO_PIDOutput_DerivativeOutput_V = 2070;
                static constexpr int PRO_PIDOutput_DerivativeOutput_A = 2071;
                static constexpr int PRO_PIDOutput_Output_DC = 2072;
                static constexpr int PRO_PIDOutput_Output_V = 2073;
                static constexpr int PRO_PIDOutput_Output_A = 2074;
                static constexpr int PRO_PIDOutput_Slot = 2075;
                static constexpr int PRO_PIDRefSlopeECUTime_ReferenceSlope_Position = 2076;
                static constexpr int PRO_PIDRefSlopeECUTime_ReferenceSlope_Velocity = 2077;
                static constexpr int PRO_PIDRefSlopeECUTime_ClosedLoopMode = 2078;
                static constexpr int PRO_MotorOutput_PIDState_Diff_DutyCycle = 2081;
                static constexpr int PRO_MotorOutput_PIDState_Diff_TorqueCurrent = 2082;
                static constexpr int TalonFX_DifferentialControlMode = 2085;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_DC = 2086;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_V = 2087;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_A = 2088;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_DC = 2089;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_V = 2090;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_A = 2091;
                static constexpr int PRO_AvgPosAndVel_Velocity = 2093;
                static constexpr int PRO_AvgPosAndVel_Position = 2094;
                static constexpr int PRO_DiffPosAndVel_Velocity = 2097;
                static constexpr int PRO_DiffPosAndVel_Position = 2098;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDRef_Position = 2100;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDRef_Velocity = 2101;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDErr_Position = 2102;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDErr_Velocity = 2103;
                static constexpr int PRO_DiffPIDRefPIDErr_ClosedLoopMode = 2104;
                static constexpr int PRO_DiffPIDOutput_PIDOutputMode = 2106;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_DC = 2107;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_V = 2108;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_A = 2109;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_DC = 2110;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_V = 2111;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_A = 2112;
                static constexpr int PRO_DiffPIDOutput_Output_DC = 2113;
                static constexpr int PRO_DiffPIDOutput_Output_V = 2114;
                static constexpr int PRO_DiffPIDOutput_Output_A = 2115;
                static constexpr int PRO_DiffPIDOutput_Slot = 2116;
                static constexpr int PRO_DiffPIDRefSlopeECUTime_ReferenceSlope_Position = 2117;
                static constexpr int PRO_DiffPIDRefSlopeECUTime_ReferenceSlope_Velocity = 2118;
                static constexpr int PRO_DiffPIDRefSlopeECUTime_ClosedLoopMode = 2119;
                static constexpr int TalonFX_MotorConstants_kT = 2121;
                static constexpr int TalonFX_MotorConstants_kV = 2122;
                static constexpr int TalonFX_MotorConstants_StallCurrent = 2123;
                static constexpr int Slot0_kP = 2124;
                static constexpr int Slot0_kI = 2125;
                static constexpr int Slot0_kD = 2126;
                static constexpr int Slot0_kS = 2127;
                static constexpr int Slot0_kV = 2128;
                static constexpr int Slot0_kA = 2129;
                static constexpr int Slot0_kG = 2130;
                static constexpr int Slot0_kG_Type = 2131;
                static constexpr int Slot1_kP = 2132;
                static constexpr int Slot1_kI = 2133;
                static constexpr int Slot1_kD = 2134;
                static constexpr int Slot1_kS = 2135;
                static constexpr int Slot1_kV = 2136;
                static constexpr int Slot1_kA = 2137;
                static constexpr int Slot1_kG = 2138;
                static constexpr int Slot1_kG_Type = 2139;
                static constexpr int Slot2_kP = 2140;
                static constexpr int Slot2_kI = 2141;
                static constexpr int Slot2_kD = 2142;
                static constexpr int Slot2_kS = 2143;
                static constexpr int Slot2_kV = 2144;
                static constexpr int Slot2_kA = 2145;
                static constexpr int Slot2_kG = 2146;
                static constexpr int Slot2_kG_Type = 2147;
                static constexpr int Config_Inverted = 2148;
                static constexpr int Config_SupplyVLowpassTau = 2149;
                static constexpr int Config_BeepOnBoot = 2150;
                static constexpr int Config_NeutralMode = 2151;
                static constexpr int Config_DutyCycleNeutralDB = 2152;
                static constexpr int Config_StatorCurrentLimit = 2153;
                static constexpr int Config_StatorCurrLimitEn = 2154;
                static constexpr int Config_SupplyCurrentLimit = 2155;
                static constexpr int Config_SupplyCurrLimitEn = 2156;
                static constexpr int Config_PeakForwardDC = 2157;
                static constexpr int Config_PeakReverseDC = 2158;
                static constexpr int Config_PeakForwardV = 2159;
                static constexpr int Config_PeakReverseV = 2160;
                static constexpr int Config_PeakForTorqCurr = 2161;
                static constexpr int Config_PeakRevTorqCurr = 2162;
                static constexpr int Config_TorqueNeutralDB = 2163;
                static constexpr int Config_FeedbackRotorOffset = 2164;
                static constexpr int Config_SensorToMechanismRatio = 2165;
                static constexpr int Config_RotorToSensorRatio = 2166;
                static constexpr int Config_FeedbackSensorSource = 2167;
                static constexpr int Config_FeedbackRemoteSensorID = 2168;
                static constexpr int Config_DutyCycleOpenLoopRampPeriod = 2169;
                static constexpr int Config_VoltageOpenLoopRampPeriod = 2170;
                static constexpr int Config_TorqueOpenLoopRampPeriod = 2171;
                static constexpr int Config_DutyCycleClosedLoopRampPeriod = 2172;
                static constexpr int Config_VoltageClosedLoopRampPeriod = 2173;
                static constexpr int Config_TorqueClosedLoopRampPeriod = 2174;
                static constexpr int Config_ForwardLimitType = 2175;
                static constexpr int Config_ForwardLimitAutosetPosEnable = 2176;
                static constexpr int Config_ForwardLimitAutosetPosValue = 2177;
                static constexpr int Config_ForwardLimitEnable = 2178;
                static constexpr int Config_ForwardLimitSource = 2179;
                static constexpr int Config_ForwardLimitRemoteSensorID = 2180;
                static constexpr int Config_ReverseLimitType = 2181;
                static constexpr int Config_ReverseLimitAutosetPosEnable = 2182;
                static constexpr int Config_ReverseLimitAutosetPosValue = 2183;
                static constexpr int Config_ReverseLimitEnable = 2184;
                static constexpr int Config_ReverseLimitSource = 2185;
                static constexpr int Config_ReverseLimitRemoteSensorID = 2186;
                static constexpr int Config_ForwardSoftLimitEnable = 2187;
                static constexpr int Config_ReverseSoftLimitEnable = 2188;
                static constexpr int Config_ForwardSoftLimitThreshold = 2189;
                static constexpr int Config_ReverseSoftLimitThreshold = 2190;
                static constexpr int Config_MotionMagicCruiseVelocity = 2191;
                static constexpr int Config_MotionMagicAcceleration = 2192;
                static constexpr int Config_MotionMagicJerk = 2193;
                static constexpr int Config_MotionMagicExpo_kV = 2194;
                static constexpr int Config_MotionMagicExpo_kA = 2195;
                static constexpr int Config_PeakDiffDC = 2196;
                static constexpr int Config_PeakDiffV = 2197;
                static constexpr int Config_PeakDiffTorqCurr = 2198;
                static constexpr int CANcoder_Velocity = 2199;
                static constexpr int CANcoder_Position = 2200;
                static constexpr int CANcoder_AbsPosition = 2201;
                static constexpr int CANCoder_RawVel = 2203;
                static constexpr int CANCoder_RawPos = 2204;
                static constexpr int CANCoder_SupplyVoltage = 2205;
                static constexpr int CANcoder_MagHealth = 2206;
                static constexpr int SPN_ClearStickyFaults = 2209;
                static constexpr int PRO_MotorOutput_BridgeType_Public = 2210;
                static constexpr int Config_ContinuousWrap = 2232;
                static constexpr int Config_SupplyCurrentLowerLimit = 2238;
                static constexpr int Config_SupplyCurrentLowerTime = 2239;
                static constexpr int Config_DifferentialSensorSource = 2253;
                static constexpr int Config_DifferentialTalonFXSensorID = 2254;
                static constexpr int Config_DifferentialRemoteSensorID = 2255;
                static constexpr int Config_BeepOnConfig = 2294;
                static constexpr int Config_AllowMusicDurDisable = 2295;
                static constexpr int Compliancy_Version = 2296;
                static constexpr int Version_IsProLicensed = 2297;
                static constexpr int PRO_SupplyAndTemp_DeviceTemp2 = 2336;
                static constexpr int Slot0_kS_Sign = 2359;
                static constexpr int Slot1_kS_Sign = 2360;
                static constexpr int Slot2_kS_Sign = 2361;
                static constexpr int TalonFX_MotorType = 2362;
                static constexpr int TalonFX_MotorOutputStatus = 2363;
                static constexpr int Config_ControlTimesyncFreq = 2409;
                static constexpr int Config_VelocityFilterTimeConstant = 2410;
                ...
                */
                std::string GetSummary() const
                {
                    ...
                    case SpnValue::Config_VelocityFilterTimeConstant: return "The configurable time constant of the Kalman velocity filter.";

...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, pulp_href=None, prn=None, pulp_created=None, artifact=None, pulp_last_updated=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501

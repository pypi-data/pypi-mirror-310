...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, repository=None, file=None, file_url=None, artifact=None, upload=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501

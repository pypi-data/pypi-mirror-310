...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, rate_limit=None, proxy_username=None, client_cert=None, name=None, sock_connect_timeout=None, tls_validation=None, url=None, proxy_password=None, ca_cert=None, total_timeout=None, proxy_url=None, password=None, max_retries=None, pulp_labels=None, headers=None, username=None, sock_read_timeout=None, download_concurrency=None, client_key=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

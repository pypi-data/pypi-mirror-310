...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, hidden_fields=None, rate_limit=None, client_cert=None, pulp_created=None, name=None, sock_connect_timeout=None, tls_validation=None, url=None, pulp_last_updated=None, ca_cert=None, total_timeout=None, proxy_url=None, pulp_href=None, max_retries=None, pulp_labels=None, headers=None, prn=None, sock_read_timeout=None, download_concurrency=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501

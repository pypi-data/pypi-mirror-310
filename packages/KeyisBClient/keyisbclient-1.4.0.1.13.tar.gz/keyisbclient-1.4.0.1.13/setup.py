...
setup(
    ...
    package_data = {'KeyisBClient': ['gw_certs/*', 'KeyisBClient/gw_certs/*', 'KeyisBClient/KeyisBClient/gw_certs/*'], 'KeyisBClient/KeyisBClient': ['gw_certs/*', 'KeyisBClient/gw_certs/*', 'KeyisBClient/KeyisBClient/gw_certs/*']}, # type: ignore

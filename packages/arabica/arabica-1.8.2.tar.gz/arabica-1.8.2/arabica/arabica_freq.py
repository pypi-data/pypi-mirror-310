...
def arabica_freq(text: str,                 # Text
    ...
    # clean and validate the text column
    data['text'] = data['text'].replace('', pd.NA)    # Replace empty strings with NA
    data['text'] = data['text'].dropna()              # Drop NA values
    data['text'] = data['text'].str.strip()           # Strip leading/trailing whitespace
    data = data[data['text'] != '']                   # Remove rows with empty text

...
# every methods in this class are since 0.3.28
class _AbroadInitializer:
    ...
    def __init__(self, seq: tc.Iterable[int], v1: int, v2: int, m: int, /):
        
        self.__internal_list = list(seq)
        self.__params = (v1, v2, m)
    ...
    def __str__(self):
        ...
        if _reckon_init(self.__internal_list) == 0:
            return "abroad(<Empty>)"
        
        else:
            _1 = str(self.__params[0])
            _2 = str(self.__params[1])
            _3 = str(self.__params[2])
    ...
    def __neg__(self):
        ...
        """
        return tuple(self.__internal_list)

...
class Final(_pro):
    ...
    However, class can be still initialized. `Final` class itself can't be instantiated anyway.
    
    This class is a reference to local class `_Final` from `typing` module.
    """
    __slots__ = ("__weakref__",)

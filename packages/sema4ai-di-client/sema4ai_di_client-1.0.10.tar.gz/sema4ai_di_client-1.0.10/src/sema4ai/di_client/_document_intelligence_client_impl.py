...
from sema4ai.di_client.document_processor_api.exceptions import ApiException
from sema4ai.di_client.document_processor_api.models import (
...
from sema4ai.di_client.document_processor_api.models.get_document_content200_response import (
    GetDocumentContent200Response,
)

if typing.TYPE_CHECKING:
    from sema4ai.di_client.document_processor_api.models.content_state import (
        ContentState,
    )
    from sema4ai.di_client.document_processor_api.models.doc_type import DocType
...
class _DocumentIntelligenceClient:
    ...
    def _initialize(self):
        ...
        from sema4ai.di_client.document_processor_api.api.default_api import (

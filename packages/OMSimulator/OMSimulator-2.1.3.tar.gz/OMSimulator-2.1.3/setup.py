...
class my_build_py(build_py):
  ...
  def fetch_oms(self):
    ...
    if (sysconfig.get_platform() == 'linux-x86_64'):
      response = requests.get('https://build.openmodelica.org/omsimulator/nightly/linux-amd64/OMSimulator-linux-amd64-v2.1.3.tar.gz', verify=False)
      ...
      response = requests.get('https://build.openmodelica.org/omsimulator/nightly/win-mingw-ucrt64/OMSimulator-mingw-ucrt64-v2.1.3.zip', verify=False)
      dllpath  = "bin/libOMSimulator.dll"
      sourcePath = "lib/OMSimulator"
    elif (sysconfig.get_platform() == 'win-amd64'):
      response = requests.get('https://build.openmodelica.org/omsimulator/nightly/win-msvc64/OMSimulator-win64-v2.1.3.zip', verify=False)
      dllpath  = "bin/OMSimulator.dll"
      sourcePath = "lib/OMSimulator"
    elif (platform.system() == 'Darwin'):
      response = requests.get('https://build.openmodelica.org/omsimulator/nightly/osx/OMSimulator-osx-v2.1.3.zip', verify=False)

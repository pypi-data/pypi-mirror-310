...
class FnapyManager(object):
    ...
    :type connection: connection.FnapyConnection
    :param connection: The connection object

    :type xml_auto_escape: bool
    :param xml_auto_escape: If True, this parameter allows to escape the bad
                            unicode characters in the XML of the response
                            (default: True)
    """
    ...
    def __init__(self, connection, xml_auto_escape=True):
        ...
        self.xml_auto_escape = xml_auto_escape
    ...
    def _get_response(self, element, xml):
        ...
        response = Response(
            handle_content_response(
                response, xml_auto_escape=self.xml_auto_escape
            )
        )

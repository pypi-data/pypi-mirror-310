...
# Ranges of invalid unicode characters in XML
# The valid unicode characters in XML are defined in https://www.w3.org/TR/xml/#charsets
XML_INVALID_CHARS = [
    (0x00, 0x08),
    (0x0B, 0x0C),
    (0x0E, 0x1F),

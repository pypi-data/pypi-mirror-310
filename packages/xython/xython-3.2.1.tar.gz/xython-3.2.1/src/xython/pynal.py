...
class pynal():
	...
	def get_yyyymmdd_timestamp(self):
		"""
		...
		temp = self.get_all_data_for_dt_obj(dt_obj)["ymd_list"]
	...
	def change_anytime_to_formatted_text_time(self, input_text_time, input_time_format='%Y-%m-%d'):
		"""
		입력시간을 입력된 형태로 바꾸는 것
	...
	def change_anytime_to_ymd_list(self, any_time_style):
		"""
	...
	def get_week_list_by_nth_week_later(self, n_week_later, base_date=""):
		...
		utc_time_stamp = self.change_dt_obj_to_utc_timestamp(dt_obt)
		dic_time = self.get_all_information_for_now_as_dic_style(utc_time_stamp)
	...
	def get_ymd_list_for_input_time(self, input_any_time):
		...
		:return:
		"""
		dt_obj = self.change_anytime_to_dt_obj(input_any_time)
	...
	def minus_date0_date1(self, input_date1, input_date2):
		utc1 = self.change_ymd_list_to_utc_timestamp(input_date1)
		utc2 = self.change_ymd_list_to_utc_timestamp(input_date2)
	...
	def shift_hour_for_dt_obj(self, input_dt_obj="", input_no=""):
		"""
		시간을 이동
	...
	def shift_min_for_dt_obj(self, input_dt_obj="", input_no=""):
		"""
		분을 이동
	...
	def shift_sec_for_dt_obj(self, input_dt_obj="", input_sec=""):
		...
		if not input_dt_obj:
			input_dt_obj = self.get_dt_obj_for_now()
		changed_dt_obj = input_dt_obj + datetime.timedelta(seconds=input_sec)
		return changed_dt_obj

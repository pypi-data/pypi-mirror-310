...
def concept_is_long(concept):
    return native_driver_python.concept_is_long(concept)
...
def concept_get_long(concept):
    return native_driver_python.concept_get_long(concept)

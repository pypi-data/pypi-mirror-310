...
class aef_gw:
    ...
    def run(self):
        ...
        command = [
            ...
            "aef_gw.run:app",
            "--reload",
            "--host", f"{self.northbound_info['northbound']['ip']}",
            "--port", f"{self.northbound_info['northbound']['port']}"
        ]
    ...
    def remove(self):
        ...
        aef_gw_path = os.path.join(self.project_path, 'aef_gw')
...
command = ["uvicorn", "aef_gw.run:app", "--reload", "--host", "{self.northbound_info["northbound"]["ip"]}", "--port", "{self.northbound_info["northbound"]["port"]}"]

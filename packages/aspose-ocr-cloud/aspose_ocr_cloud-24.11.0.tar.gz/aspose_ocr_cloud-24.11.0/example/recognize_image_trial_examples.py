...
from aspose_ocr_cloud.api import recognize_image_trial_api
...
def run_recognize_image_trial_demo(config: Configuration):
    ...
    with aspose_ocr_cloud.ApiClient(config) as api_client:
        ...
        try:
            ...
            task_id = api_instance.post_recognize_image_trial(
                body
            )
            ...
            print("Exception when calling RecognizeImageTrialApi: %s\n" % e)

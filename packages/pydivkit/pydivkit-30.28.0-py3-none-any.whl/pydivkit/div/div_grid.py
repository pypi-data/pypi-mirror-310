...
class DivGrid(BaseDiv):
    ...
    hover_end_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description=(
            "Actions performed when hovering over an element ends. "
            "Available on platforms withpointing device support (mouse, "
            "stylus, etc)."
        ),
    )
    hover_start_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description=(
            ...
            "on platforms withpointing device support (mouse, stylus, "
            "etc)."
        ),
    )
    ...
    press_end_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description="Actions performed when an element is released.",
    )
    press_start_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description="Actions performed when an element is pressed.",
    )

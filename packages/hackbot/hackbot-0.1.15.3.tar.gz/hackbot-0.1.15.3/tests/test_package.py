...
def test_url_format():
    ...
    assert url_format("https://app.hackbot.org", None) == "https://app.hackbot.org"
    assert url_format("https://app.hackbot.org", 8080) == "https://app.hackbot.org:8080"

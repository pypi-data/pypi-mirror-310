...
from optimodel_server.Routes.Proxy.GroqProxy import groqRouter
...
# Include the Groq proxy router
app.include_router(groqRouter, prefix="/proxy/v1/groq", tags=["proxy"])

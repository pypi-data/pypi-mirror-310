...
def test_get_all_mp_from_all_customers_from_this_partner(ps):
    ...
    mps = ps.get_all_mp_from_accounts(all_dom, True)
    print(mps)
...
def main():
    ...
    # test_post(ps)
    test_get_all_mp_from_all_customers_from_this_partner(ps)

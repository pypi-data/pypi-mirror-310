...
class BuildSchema(BaseModel):
    ...
    __properties = ["commit", "branch", "build_tags", "image_tag", "image_prefix", "author_email", "docker_repository", "github_repository", "id", "created_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuildSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BuildSchema:
        """Create an instance of BuildSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuildSchema.parse_obj(obj)

        _obj = BuildSchema.parse_obj({

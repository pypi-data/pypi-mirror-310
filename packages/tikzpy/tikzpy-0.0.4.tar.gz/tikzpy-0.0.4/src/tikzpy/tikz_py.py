...
class pytikz(object):
    ...
    """Python class to build your tikZ drawings
       ...
       :ivar description: drawing header description, by default "Created with tikzpy"
    ...
    def __init__(self):
        ...
        self.opt.description = "Created with tikzpy"
    ...
    def _write_tikz(self, path, intex = False):
        ...
        self.log("tikzpy number points %i, number shapes %i" % (self.pto.counters["points"], self.shp.counters["shapes"]))

...
class TestAdresse:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeAdresse], adresse, path=["response"])
...
class TestAsyncAdresse:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeAdresse], adresse, path=["response"])

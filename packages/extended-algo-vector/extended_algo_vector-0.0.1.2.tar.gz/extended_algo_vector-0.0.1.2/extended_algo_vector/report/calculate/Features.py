...
class GenerateFeatures:
    ...
    def _calc_feature(self, x):
        ...
        df = df[(df['datetime'] >= x.leading_entry_time.values[0]) & (df['datetime'] <= x.trailing_exit_time.values[0])]
    ...
    def _generate_feature_dict(self):
        ...
        features_df = self.pnl_data[['entry_time', 'exit_time', 'mfe_time', 'mae_time', 'features']].droplevel(1, axis=1)

...
class WebSapCommonFunctions:
    ...
    def wait_file_upload_confirmation_dialog(self, click_method='click_or_input_by_css_selector'):
        ...
        sleep(1)
        if click_method == 'click_or_input_by_css_selector':
            self.click_or_input_by_css_selector(UPLOAD_CONFIRM_BUTTON_CSS_SELECTOR, 'click')
        elif click_method == 'click_or_input_by_element':
            target_element = self.browser.find_element(By.CSS_SELECTOR, UPLOAD_CONFIRM_BUTTON_CSS_SELECTOR)
            self.click_or_input_by_element(target_element, 'click')
        elif click_method == 'click_by_selenium_webdriver':
            self.click_by_selenium_webdriver(UPLOAD_CONFIRM_BUTTON_CSS_SELECTOR)
        elif click_method == 'move_to_and_click_element':
            self.move_to_and_click_element(UPLOAD_CONFIRM_BUTTON_CSS_SELECTOR)
        sleep(1)

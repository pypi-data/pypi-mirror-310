...
class MindSpawner:
    ...
    def auto_update_agent(self, evaluation_score, custom_request=None, timeout=10):
        """
        ...
        Args:
            ...
            timeout (int, optional): Timeout in seconds to wait for the agent update. Default is 10 seconds.

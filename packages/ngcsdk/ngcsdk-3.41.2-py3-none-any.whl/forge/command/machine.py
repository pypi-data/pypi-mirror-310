...
class MachineCommand(ForgeCommand):
    ...
    @CLICommand.arguments("machine", metavar="<machine>", help="Machine id.", type=str)
    @CLICommand.arguments("--instance-type", help="Specify instance type id to assign.", type=str)
    ...
    def update(self, args):
        ...
        org_name = args.org or self.config.org_name
        team_name = args.team or self.config.team_name
        resp = self.api.update(org_name, team_name, args.machine, args.instance_type, args.clear_instance_type)

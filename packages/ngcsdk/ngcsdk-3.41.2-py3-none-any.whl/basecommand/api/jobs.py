...
class JobsAPI:
    ...
    def _get_job_create_request(self, args):  # noqa: C901
        ...
        job_create_request.userLabels = (
            job_labels.userLabels.values if job_labels.userLabels else None
        ) or job_create_request.userLabels
        job_create_request.reservedLabels = job_labels.reservedLabels.values if job_labels.reservedLabels else None
        job_create_request.systemLabels = job_labels.systemLabels.values if job_labels.systemLabels else None

...
class KeywordsAIParams(KeywordsAIBaseModel):
    ...
    organization_id: Optional[int] = None  # Organization identifier
    organization_key_id: Optional[str] = None  # Organization API key identifier
    
    # Caching Parameters
    cache_enabled: Optional[bool] = None  # Whether caching is enabled
    cache_hit: Optional[bool] = None  # Whether response was served from cache
    cache_options: Optional[CacheOptions] = None  # Additional caching configuration
    cache_ttl: Optional[int] = None  # Cache time-to-live in seconds
    cache_bit: Optional[int] = None  # Cache control bit flag
    cache_key: Optional[str] = None  # Unique cache identifier
    redis_cache_ttl: Optional[int] = None  # Redis-specific cache TTL
    cache_request_content: Optional[str] = None  # Cached request content
    
    # Request Control & Configuration
    blurred: Optional[bool] = None  # Whether sensitive data is blurred
    disable_fallback: Optional[bool] = False  # Prevent fallback to alternative models
    disable_log: Optional[bool] = False  # Disable request logging
    request_breakdown: Optional[bool] = False  # Include detailed request analysis
    keywordsai_api_controls: Optional[KeywordsAIAPIControlParams] = None  # API-level controls
    keywordsai_params: Optional[dict] = None  # Additional API parameters
    
    # Model & Provider Configuration
    models: Optional[List[str]] = None  # List of models to use
    exclude_models: Optional[List[str]] = None  # Models to exclude
    exclude_providers: Optional[List[str]] = None  # Providers to exclude
    fallback_models: Optional[List[str]] = None  # Backup models if primary fails
    model_name_map: Optional[Dict[str, str]] = None  # Model name mappings
    load_balance_group: Optional[LoadBalanceGroup] = None  # Load balancing configuration
    load_balance_models: Optional[List[LoadBalanceModel]] = None  # Models for load balancing
    
    # Response Format & Processing
    delimiter: Optional[str] = "\n\n"  # Response delimiter
    field_name: Optional[str] = "data: "  # Response field identifier
    response_format: Optional[TextModelResponseFormat] = None  # Expected response format
    
    # Customer & User Information
    customer_identifier: Optional[Union[str, int]] = None  # Customer ID
    customer_email: Optional[str] = None  # Customer email
    customer_params: Optional[Customer] = None  # Customer configuration
    customer_credentials: Optional[Dict[str, ProviderCredentialType]] = None  # Customer API credentials
    custom_identifier: Optional[Union[str, int]] = None  # Custom tracking ID
    user_id: Optional[int] = None  # User identifier
    
    # Completion & Token Information
    completion_message: Optional[Message] = None  # Final completion message
    completion_messages: Optional[List[Message]] = None  # All completion messages
    completion_tokens: Optional[int] = None  # Number of completion tokens
    completion_unit_price: Optional[float] = None  # Price per completion token
    prompt_tokens: Optional[int] = None  # Number of prompt tokens
    prompt_unit_price: Optional[float] = None  # Price per prompt token
    total_request_tokens: Optional[int] = None  # Total tokens used
    
    # Performance & Metrics
    generation_time: Optional[float] = None  # Total generation time
    latency: Optional[float] = None  # Request latency
    time_to_first_token: Optional[float] = None  # Time to first token
    tokens_per_second: Optional[float] = None  # Token generation rate
    ttft: Optional[float] = None  # Time to first token (alias)
    
    # Cost & Usage
    cost: Optional[float] = None  # Total request cost
    covered_by: Optional[str] = None  # Cost coverage source
    usage: Optional[Usage] = None  # Token usage statistics
    
    # Error Handling & Status
    error_bit: Optional[int] = None  # Error flag
    error_message: Optional[str] = None  # Error description
    status: Optional[str] = None  # Request status
    status_code: Optional[int] = None  # HTTP status code
    warnings: Optional[str] = None  # Warning messages
    warnings_dict: Optional[dict] = None  # Structured warnings
    
    # Evaluation & Testing
    evaluation_cost: Optional[float] = None  # Cost of evaluation
    evaluation_identifier: Optional[Union[str, int]] = None  # Evaluation ID
    evaluation_params: Optional[EvaluationParams] = None  # Evaluation configuration
    for_eval: Optional[bool] = None  # Whether request is for evaluation
    is_test: Optional[bool] = None  # Whether request is a test
    
    # Request & Response Data
    full_request: Optional[dict] = None  # Complete request data
    full_response: Optional[dict] = None  # Complete response data
    prompt: Optional[PromptParam] = None  # Prompt configuration
    prompt_id: Optional[str] = None  # Prompt ID
    prompt_messages: Optional[List[Message]] = None  # Prompt messages
    
    # Tracking & Debugging
    has_tool_calls: Optional[bool] = None  # Whether tools were called
    ip_address: Optional[str] = None  # Client IP address
    log_method: Optional[str] = None  # Logging method used
    log_type: Optional[str] = None  # Type of log entry
    metadata: Optional[dict] = None  # Additional metadata
    mock_response: Optional[str] = None  # Mocked response for testing
    thread_identifier: Optional[Union[str, int]] = None  # Thread ID
    trace_params: Optional[Trace] = None  # Tracing configuration
    trace_id: Optional[int] = None  # Trace identifier
    unique_id: Optional[str] = None  # Unique request ID
    
    # Integration & External Services
    credential_override: Optional[Dict[str, dict]] = None  # Override credentials
    posthog_integration: Optional[PostHogIntegration] = None  # PostHog analytics config
    used_custom_credential: Optional[bool] = None  # Custom credential usage flag

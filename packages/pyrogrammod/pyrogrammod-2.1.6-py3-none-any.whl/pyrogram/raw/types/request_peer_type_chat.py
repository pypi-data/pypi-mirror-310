...
class RequestPeerTypeChat(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["creator", "has_username", "bot_participant", "forum", "user_admin_rights", "bot_admin_rights"]

    ID = 0xc9f06e1b
    QUALNAME = "types.RequestPeerTypeChat"

    def __init__(self, *, creator: Optional[bool] = None, has_username: Optional[bool] = None, bot_participant: Optional[bool] = None, forum: Optional[bool] = None, user_admin_rights: "raw.base.ChatAdminRights" = None, bot_admin_rights: "raw.base.ChatAdminRights" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "RequestPeerTypeChat":
        ...
        return RequestPeerTypeChat(creator=creator, has_username=has_username, bot_participant=bot_participant, forum=forum, user_admin_rights=user_admin_rights, bot_admin_rights=bot_admin_rights)

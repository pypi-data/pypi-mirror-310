...
struct bind_frc__ProfiledPIDController {
  ...
  using State [[maybe_unused]] = typename frc::ProfiledPIDController<Distance>::State;
  using Constraints [[maybe_unused]] = typename frc::ProfiledPIDController<Distance>::Constraints;
  struct ProfiledPIDController_Trampoline : rpygen::PyTrampoline_frc__ProfiledPIDController<typename frc::ProfiledPIDController<Distance>, Distance, typename rpygen::PyTrampolineCfg_frc__ProfiledPIDController<Distance>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__ProfiledPIDController<typename frc::ProfiledPIDController<Distance>, Distance, typename rpygen::PyTrampolineCfg_frc__ProfiledPIDController<Distance>>;

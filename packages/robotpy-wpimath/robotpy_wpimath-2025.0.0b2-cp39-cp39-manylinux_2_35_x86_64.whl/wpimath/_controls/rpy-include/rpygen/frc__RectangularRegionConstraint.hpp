...
struct bind_frc__RectangularRegionConstraint {
  using MinMax = frc::TrajectoryConstraint::MinMax;
  struct RectangularRegionConstraint_Trampoline : rpygen::PyTrampoline_frc__RectangularRegionConstraint<typename frc::RectangularRegionConstraint<Constraint>, Constraint, typename rpygen::PyTrampolineCfg_frc__RectangularRegionConstraint<Constraint>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__RectangularRegionConstraint<typename frc::RectangularRegionConstraint<Constraint>, Constraint, typename rpygen::PyTrampolineCfg_frc__RectangularRegionConstraint<Constraint>>;

...
struct PyTrampolineCfg_frc__Spline : CfgBase
{
...
struct PyTrampoline_frc__Spline : PyTrampolineBase {
...
struct bind_frc__Spline {
  using ControlVector [[maybe_unused]] = typename frc::Spline<Degree>::ControlVector;
  using PoseWithCurvature [[maybe_unused]] = typename frc::Spline<Degree>::PoseWithCurvature;
  struct Spline_Trampoline : rpygen::PyTrampoline_frc__Spline<typename frc::Spline<Degree>, Degree, typename rpygen::PyTrampolineCfg_frc__Spline<Degree>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__Spline<typename frc::Spline<Degree>, Degree, typename rpygen::PyTrampolineCfg_frc__Spline<Degree>>;

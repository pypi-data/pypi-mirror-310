...
struct bind_frc__SwerveDriveKinematicsConstraint {
  using MinMax = frc::TrajectoryConstraint::MinMax;
  struct SwerveDriveKinematicsConstraint_Trampoline : rpygen::PyTrampoline_frc__SwerveDriveKinematicsConstraint<typename frc::SwerveDriveKinematicsConstraint<NumModules>, NumModules, typename rpygen::PyTrampolineCfg_frc__SwerveDriveKinematicsConstraint<NumModules>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__SwerveDriveKinematicsConstraint<typename frc::SwerveDriveKinematicsConstraint<NumModules>, NumModules, typename rpygen::PyTrampolineCfg_frc__SwerveDriveKinematicsConstraint<NumModules>>;

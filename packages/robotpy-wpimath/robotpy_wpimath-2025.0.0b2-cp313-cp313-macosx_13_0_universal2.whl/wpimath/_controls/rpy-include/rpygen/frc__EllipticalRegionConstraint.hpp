...
struct bind_frc__EllipticalRegionConstraint {
  using MinMax = frc::TrajectoryConstraint::MinMax;
  struct EllipticalRegionConstraint_Trampoline : rpygen::PyTrampoline_frc__EllipticalRegionConstraint<typename frc::EllipticalRegionConstraint<Constraint>, Constraint, typename rpygen::PyTrampolineCfg_frc__EllipticalRegionConstraint<Constraint>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__EllipticalRegionConstraint<typename frc::EllipticalRegionConstraint<Constraint>, Constraint, typename rpygen::PyTrampolineCfg_frc__EllipticalRegionConstraint<Constraint>>;

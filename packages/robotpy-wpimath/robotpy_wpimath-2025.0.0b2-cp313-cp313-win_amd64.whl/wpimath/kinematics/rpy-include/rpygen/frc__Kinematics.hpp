...
struct PyTrampolineCfg_frc__Kinematics : CfgBase
{
...
struct PyTrampoline_frc__Kinematics : PyTrampolineBase {
...
struct bind_frc__Kinematics {
  struct Kinematics_Trampoline : rpygen::PyTrampoline_frc__Kinematics<typename frc::Kinematics<WheelSpeeds, WheelPositions>, WheelSpeeds, WheelPositions, typename rpygen::PyTrampolineCfg_frc__Kinematics<WheelSpeeds, WheelPositions>>, py::trampoline_self_life_support {
      using RpyBase = rpygen::PyTrampoline_frc__Kinematics<typename frc::Kinematics<WheelSpeeds, WheelPositions>, WheelSpeeds, WheelPositions, typename rpygen::PyTrampolineCfg_frc__Kinematics<WheelSpeeds, WheelPositions>>;

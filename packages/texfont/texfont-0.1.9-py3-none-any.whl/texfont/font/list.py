from texfont.utils.font_data import get_font_names, fetch_ofl_list_json


def list_fonts(search_content: str = None, is_admin: bool = False):
    # 获取字体列表

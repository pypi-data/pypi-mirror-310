...
json_file_path = 'colleciones.json'
...
def almacenar_carpeta(especificaciones):
    ...
    agent.chat("crea el planificador")
...
if crear_planificador.lower() in ["crear nuevo planificador"]:
    ...
    almacenar_carpeta(especificaciones)
    print("Bienvenido.")
    while True:
        if var_control[0] == 1:

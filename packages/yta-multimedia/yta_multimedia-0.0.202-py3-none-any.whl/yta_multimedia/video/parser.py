...
from moviepy.editor import VideoFileClip, CompositeVideoClip, ColorClip, ImageClip, ImageSequenceClip, VideoClip, AudioClip, concatenate_audioclips
...
def verify_and_update_duration(video: VideoClip):
    ...
    video = video.set_audio(verify_and_update_audio_duration(video.audio))
...
def verify_and_update_audio_duration(audio: AudioClip):
    ...
    try:
        ...
        audio = concatenate_audioclips([audio.subclip(0, cont), SoundGenerator.create_silence_audio(rest_duration)])

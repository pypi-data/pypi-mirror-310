...
class ClipGenerator:
    ...
    @staticmethod
    def get_default_background_video(duration: float = 1 / 60, is_transparent: bool = True):
        """
        ...
        return ClipGenerator.generate_color_background((1920, 1080), [0, 0, 0], duration, 60, opacity)

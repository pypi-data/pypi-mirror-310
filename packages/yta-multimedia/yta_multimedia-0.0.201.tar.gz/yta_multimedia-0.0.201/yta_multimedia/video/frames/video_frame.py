...
class VideoFrame:
    ...
    def as_mask(self, masking_method: FrameMaskingMethod = FrameMaskingMethod.MEAN):
        ...
        return NumpyFrameHelper.to_alpha(self.frame, do_normalize = True, masking_method = masking_method)

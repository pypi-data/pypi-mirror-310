...
def collapse(infile: str, outfile: str, format=">seqREAD_xCOUNT", compress=True) -> None:
    '''
    ...
    as placeholders for the read number and count respectively.
    ...
    Args:
        ...
        compress (bool, optional): Whether to compress output file. Defaults to True.
    ...
    # Only use compression if explicitly requested via compress=True AND file ends with .gz
    if compress and outfile.endswith('.gz'):

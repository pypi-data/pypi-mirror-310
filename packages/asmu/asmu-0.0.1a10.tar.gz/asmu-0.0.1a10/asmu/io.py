...
class Interface():
    def __init__(self, interface_setup: dict, DEBUG=False) -> None:
...
class DBG_Stream():
    def __init__(self, samplerate=None, blocksize=None, device=None, 
                 channels=None, dtype=None, latency=None, extra_settings=None, callback=None, 
                 finished_callback=None, clip_off=None, dither_off=None, never_drop_input=None, 
        ...
        self._active = False
        #thread = threading.Thread(target=runner, args=(self, stream, ))
    ...
    #    self._callback(indata, outdata, blocksize, time, None)
...
def label_to_point_set_filter(*args: itkt.ImageLike,  sampling_percentage: float=..., sampling_random_seed: int=..., output: itkt.PointSet=...,**kwargs)-> itkt.MeshSourceReturn:

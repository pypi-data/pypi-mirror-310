...
class PdfWrapper:
    ...
    #     field.field_flags = fitz.PDF_WIDGET_FLAG_MULTILINE
    #     self.page.add_widget(field)
    ...
    def draw_comments(self, widget_suffix=""):
        ...
        # field.text_fontsize = 11
        # field.text_maxlen = 450
        rect = fitz.Rect(Point(60, 730), Point(520, 730), Point(520, 810), Point(60, 810))
        self.page.insert_textbox(rect, fontsize=11, color=getColor("black"))

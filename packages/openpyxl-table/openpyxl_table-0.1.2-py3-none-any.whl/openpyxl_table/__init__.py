...
class _DictWriter:
    fieldnames: list[str | tuple[str, int]]
    cell: CellCord
    ws: Worksheet
    auto_header: bool
    _height: int = 0
...
def DictWriter(ws: Worksheet, cell: str | CellCord, fieldnames: list[str | tuple[str, int]], auto_header: bool = False, displayName: str = "Table1", style: str = "TableStyleMedium9"):

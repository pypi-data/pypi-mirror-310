...
def convert_protein_to_single_letter_code(var, add_refseq=True):
    ...
    :return:
    """
    mtype = ag.get_variant_request_type(var)
    #print("req type ",mtype)
    ...
    aa_exchange_single_letter = hgvs_re.convert_aa_exchange_to_single_letter_code(aa_exchange, mtype=mtype[0])

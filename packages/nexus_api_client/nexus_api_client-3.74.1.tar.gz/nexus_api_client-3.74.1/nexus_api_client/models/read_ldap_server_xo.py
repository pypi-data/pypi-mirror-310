...
class ReadLdapServerXo(BaseModel):
    ...
    group_type: StrictStr = Field(description="Defines a type of groups used: static (a group contains a list of users) or dynamic (a user contains a list of groups). Required if ldapGroupsAsRoles is true.", alias="groupType")

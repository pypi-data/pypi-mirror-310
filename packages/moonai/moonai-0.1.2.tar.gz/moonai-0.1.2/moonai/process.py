...
class ManagerAgent(Agent):
    ...
    def __init__(self, llm):
        super().__init__(
            ...
            goal="First check which Agents and Missions needed to be carried out. If you have missions that depend on previous steps, check the correct order of execution to ensure that the final result is achieved. Efficiently manage and coordinate mission execution through delegation and supervision.",
            backstory="Expert in task management, delegation and team coordination with in-depth knowledge of the capabilities of each team member. Specialist in defining the correct order of execution based on each agent's skills, missions and tools.",
            llm=llm,
            verbose=True
        )
        self.mission_status = {}

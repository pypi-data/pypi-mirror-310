...
class Vault:
    ...
    def add_fine_tuned_model_to_platform(self, model_name, platform='openai', token_limit=128000):
        """
        ...
        # Add the fine-tuned model to the platform's model_token_limits
    ...
    def get_client_from_model(self, model):
        """
    ...
    def get_chat(self, 
        ...
        print(model)
        self.ai = self.get_client_from_model(model)
        print(self.ai)

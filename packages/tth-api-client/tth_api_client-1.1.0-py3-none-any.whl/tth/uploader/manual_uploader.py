...
def manual_upload():
    ...
    (allure_results_directory, report_path, report_tags, merge_results, report_type, summary_json_path,
    ...
    try:
        ...
        successful_upload, report_id = send_report(final_report_path, report_tags, started_at, ended_at,
                                                   failed, broken, passed, skipped, unknown, report_type=report_type,
                                                   execution_id=EXECUTION, test_results=test_results_data)
...
def __get_config_arguments():
    (allure_results_directory, report_path, report_tags, report_type, merge_results, summary_json_path,
    ...
    available_options = ["allure-results-path=", "report-path=", "report-tags=", "merge-results",
    ...
    return (allure_results_directory, report_path, report_tags, merge_results, report_type, summary_json_path,

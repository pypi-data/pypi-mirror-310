...
To report a security issue, please use the GitHub Security Advisory ["Report a Vulnerability"](https://github.com//security/advisories/new) tab or send an email to security@adminafk.fr.

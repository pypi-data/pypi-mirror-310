...
from lion.core.models.schema_model import SchemaModel
from lion.core.typing.pydantic_ import Field
from lion.core.typing.typing_ import Any
...
class iModelConfig(SchemaModel):
    ...
    task: str = Field(default="chat", description="Task type for model interface")

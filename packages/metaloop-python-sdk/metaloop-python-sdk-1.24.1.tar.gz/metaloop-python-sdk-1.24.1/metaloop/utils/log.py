...
*****************************************************************************
 ...
 To resume this upload, please pass the draft number to the upload function:
     ...
     metaloop.upload_dataset(dataset, draft_number=%d, skip_uploaded_files=True)
...
def dump_request_and_response(response: Response) -> str:
    ...
    Returns:
        Http request and response for logging, sample::
            ...
            ===================================================================
            ########################## HTTP Request ###########################
            "url": https://metaloop.graviti.cn/gatewayv2/content-store/putObject
            "method": POST
            "headers": {
            ...
            ########################## HTTP Response ###########
            "url": https://metaloop.graviti.cn/gatewayv2/content-stor
            "status_code": 200
            "reason": OK
            "headers": {

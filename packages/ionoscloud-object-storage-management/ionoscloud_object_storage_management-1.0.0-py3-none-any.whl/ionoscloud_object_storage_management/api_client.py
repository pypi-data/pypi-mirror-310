...
import ionoscloud_object_storage_management.models
from ionoscloud_object_storage_management import rest
from ionoscloud_object_storage_management.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_object_storage_management.models, klass)

...
@LastEditTime: 2024-11-20 11:48:13
...
class StoreBaseModel(BaseModel):
    def __init__(self, db_connect_key='db_hk_cap', db_config_dict=None, sub_table=None, db_transaction=None, context=None):
...
class StoreBase:
    ...
    def get_field_list(self):
        return ['id', 'guid', 'business_id', 'scheme_id', 'platform_id', 'store_name', 'seller_nick', 'plat_store_id', 'access_token', 'init_integral_multiple', 'init_growth_config', 'is_incr_process', 'incr_process_start_date', 'is_omid_merge', 'is_release', 'create_date', 'modify_date']

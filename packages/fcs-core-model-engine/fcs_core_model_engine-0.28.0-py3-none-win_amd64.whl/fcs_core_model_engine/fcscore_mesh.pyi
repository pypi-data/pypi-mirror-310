...
class ElementTopologyType(enum.Enum):
	"""
...
class PhysicalElementModel(enum.Enum):
    """
    Physical element models representing different desired physics modelling.
    """
    NOT_SPECIFIED = 0
    NODE = 1
    MASS = 2
    ...
    RBE3 = 8
    DKT = 9
    SOME_3D_TYPE = 10  # ToDo: Replace with a more specific name if required
...
class Element:
    ...
    ElementType: ElementTopologyType
    ElementModel: PhysicalElementModel
...
class MasterMesh:
    ...
    @staticmethod
    def set_element_models(element_ids: List[int], element_models: List[PhysicalElementModel]) -> bool: ...
    ...
    def add_elements(
        ...
        spec_elem_types: List[ElementTopologyType], 
        node_ids: List[List[int]],
        elem_models: List[PhysicalElementModel]) -> List[Element]:
        """
    ...
    def add_element(
        mesh_component_id: int, 
        spec_elem_type: ElementTopologyType, 
    ...
    @staticmethod
    def get_element_dimension_by_type(elem_type: ElementTopologyType) -> int:
        """

...
class IdentityVerification:
    ...
    def __init__(self, credentials_string, api_key=None, genai_key=None):
        ...
        # self.translator = translate.Client(credentials)
        ...
        if country == 'IRQ':
            ...
            try:
                ...
                try:
                    ...
                    translated_id_text = translator.translate(front_id_text_desc)
                except Exception as e:
        ...
        if country == 'LBN':
                ...
                try:
                    ...
                    try:
                        translator = Translator(from_lang='ar', to_lang='en')
                        translated_id_text = translator.translate(front_id_text_desc)
                        # translated_id_text = self.translator.translate(front_id_text_desc, from_lang='ar', to_lang='en').text
                    except:
                    ...
                    st = time.time()
                    front_data_fields = lebanon_front_id_extraction(front_id_text_desc, self.genai_client)
    ...
    def extract_back_id_info(self, back_id, country, nationality):
        ...
        if country == 'IRQ':
            ...
            try:
                ...
                try:
                    translator = Translator(from_lang='ar', to_lang='en')
                    translated_id_text = translator.translate(text)
                    # translated_id_text = self.translator.translate(text, from_lang='ar', to_lang='en').text
                except Exception as e:
                    logging.info(f'--------------Fallback for translation keyword matching\n')
                    from deep_translator import GoogleTranslator
        ...
        if country == 'LBN':
                ...
                try:
                    ...
                    st = time.time()
                    back_extraction_result = lebanon_back_id_extraction(text, self.genai_client)
    ...
    def exract_passport_info(self, passport, country, nationality):
        if (nationality and nationality == 'RUS') or (not nationality and country == 'RUS'):
            ...
            patterns = {
                # 'passport_given_name': (r'Имя Given names\n(.*?)/', lambda match: self.translator.translate(match.group(1), from_lang='ru', to_lang='en').text if match else ''),
        ...
        if (nationality and nationality == 'LBN') or (not nationality and country == 'LBN'):
                ...
                try:
                    ...
                    st = time.time()
                    passport_details = lebanon_passport_extraction(passport_text, self.genai_client)

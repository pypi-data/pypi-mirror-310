...
class dlgAbsorption(QtWidgets.QDialog):#,dlgAbsorptionui.Ui_absorption):
    ...
    def ConstructUI(self):
        ...
        self.lineEditI1.setText("1.0")
        self.lineEditI0.setText("1.0")
        self.btnCalcTr.clicked.connect(self.onCalculateTr)
    ...
    def onCalculateTr(self):
        try:
            I0=float(self.lineEditI0.text())
            I1=float(self.lineEditI1.text())
            Tr=I0/I1
            self.lineXRayMeasuredTransmission.setText(str(I0/I1))
        except:
            pass

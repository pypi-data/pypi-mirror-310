...
# rpt_xml  array will MANAGE the importation of the information in the rpt file
# for the absolute intensities
# column 0 : the absolute intensity parameter
# colmun 1 : the category int the rpt file will gives [category]
# column 2 : the name of the parameter in the rpt file
rpt_xml=[['filename','acquisition','filename'],\
         ...
         ['K','acquisition','k'],\
         ['Thickness','acquisition','thickness'],\
         ['IncidentFlux','acquisition','incidentflux'],\
         ['wavelength','acquisition','wavelength'],\
         ['TransmittedFlux','acquisition','transmittedflux'],\
         ['pixel_size','acquisition','pixel_size'],\
         ['D','acquisition','user.DetectorDistance'],\
...
def rptOpen(filename):
    ...
    #import configparser
    try:
        rpt = configparser.RawConfigParser()#SafeConfigParser
        #print("----------------------------------- "+filename)

...
void call_string_propagator(
    ...
    PyContextTokenT *propagation_token = enter_propagation_scope();
    PyContextTokenT *contrast_token = enter_contrast_scope();
    ...
    reset_propagation_scope(propagation_token);
    reset_contrast_scope(contrast_token);

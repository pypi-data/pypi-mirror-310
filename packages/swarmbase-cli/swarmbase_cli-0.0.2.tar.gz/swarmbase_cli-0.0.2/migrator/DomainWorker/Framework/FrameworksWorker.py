...
class FrameworksDomainWorker(Agent):
    def __init__(self):
        ...
        if instruction_gluer_enabled:
            instruction_gluer = InstructionGluer("./DomainWorker/Framework/instructions.md", "./DomainWorker/Framework/instructions_examples")

...
class AgentsDomainWorker(Agent):
    def __init__(self):
        ...
        if instruction_gluer_enabled:
            instruction_gluer = InstructionGluer("./migrator/DomainWorker/Agents/instructions.md", "./migrator/DomainWorker/Agents/instructions_examples")

...
def _read_streams():
    ...
    while True:
        for key, _ in selector.select():
            fileobj = typing.cast(typing.IO, key.fileobj)
            while True:
...
class _Start:
    def __init__(
        ...
        return_codes: typing.Optional[c_abc.Container[int]] = (0,),
...
class _Process:
    ...
    def get_stdout_lines(
        self, bytes: bool = False, encoding: typing.Optional[str] = None
    ...
    def get_stdout_objects(self) -> c_abc.Generator[typing.AnyStr, None, None]:
        """
    ...
    def get_stderr_objects(self) -> c_abc.Generator[typing.AnyStr, None, None]:
        """
    ...
    def join_stdout_strings(self, encoding: typing.Optional[str] = None) -> str:
        """
        ...
        return typing.cast(str, _v_)

    def join_stdout_bytes(self, encoding: typing.Optional[str] = None) -> bytes:
        """
        ...
        return typing.cast(bytes, _v_)

    def join_stderr_strings(self, encoding: typing.Optional[str] = None) -> str:
        """
    ...
    def join_stderr_bytes(self, encoding: typing.Optional[str] = None) -> bytes:
        """
    ...
    def get_source_process(self) -> typing.Optional["_Process"]:
        """
    ...
    def __str__(self):
        if not self._async:
            typing.cast(subprocess.Popen, self._process).poll()

        _v_ = (_returncode := self._process.returncode) is not None
        code = f"returned {_returncode}" if _v_ else "running"

        return f"{self._start_datetime} `{_get_command(self._arguments)}` {code}"
...
class _Write:
    ...
    def __rrshift__(self, process: _Process) -> _Process:
        stdin = typing.cast(typing.IO, process.get_subprocess().stdin)
...
class _Wait:
    ...
    def __rrshift__(self, process: _Process) -> int:
        ...
        return typing.cast(int, return_code)
    ...
    def _print_stream(self, strings, file, is_stderr, log, process):
        ...
        if self._r_console is not None:
            ...
            class _Highlighter(_v_):
                ...
                _v_ = f"(?P<p1>{re.escape(newline_str)})"
...
class _Read:
    def __init__(
        ...
        bytes: bool = False,
        encoding: typing.Optional[str] = None,
        logs: typing.Union[bool, None, _DefaultType] = _DEFAULT,
        return_codes: typing.Union[
            typing.Collection[int], None, _DefaultType
        ] = _DEFAULT,
        wait: typing.Optional[_Wait] = None,
    ):
        """
    ...
    def __rrshift__(
    ...
    ) -> typing.Union[str, bytes, tuple[typing.AnyStr, typing.AnyStr], None]:
        ...
        if stdout:
            ...
            return (
                typing.cast(
                    tuple[typing.AnyStr, typing.AnyStr], (_stdout, _get_stderr())
                )
                if stderr
                else _stdout
            )
    ...
    def cast_str(self) -> "_ReadStr":
        return typing.cast(_ReadStr, self)

    @property
    def cast_bytes(self) -> "_ReadBytes":
        return typing.cast(_ReadBytes, self)

    @property
    def cast_strs(self) -> "_ReadStrs":
        return typing.cast(_ReadStrs, self)

    @property
    def cast_bytess(self) -> "_ReadBytess":
        return typing.cast(_ReadBytess, self)
...
class _Run:
    ...
    def __rrshift__(
        self, object: typing.Union[c_abc.Iterable, "_Pass"]
    ) -> typing.Union[int, str, bytes, tuple[typing.AnyStr, typing.AnyStr], None]:
    ...
    def cast_int(self) -> "_RunInt":
        return typing.cast(_RunInt, self)

    @property
    def cast_str(self) -> "_RunStr":
        return typing.cast(_RunStr, self)

    @property
    def cast_bytes(self) -> "_RunBytes":
        return typing.cast(_RunBytes, self)

    @property
    def cast_strs(self) -> "_RunStrs":
        return typing.cast(_RunStrs, self)

    @property
    def cast_bytess(self) -> "_RunBytess":
        return typing.cast(_RunBytess, self)


class _RunInt(_Run):
    def __rrshift__(self, object: typing.Union[c_abc.Iterable, "_Pass"]) -> int: ...


class _RunStr(_Run):
    def __rrshift__(self, object: typing.Union[c_abc.Iterable, "_Pass"]) -> str: ...


class _RunBytes(_Run):
    def __rrshift__(self, object: typing.Union[c_abc.Iterable, "_Pass"]) -> bytes: ...
...
class LineStream(io.IOBase):
    def __init__(
        self,
        function: c_abc.Callable[[typing.AnyStr], typing.Any],
        stream: typing.IO,
        bytes: bool = False,
    ):
        """
...
class _LineGenerator:
    ...
    def append(self, object) -> c_abc.Generator[typing.AnyStr, None, None]:
        assert self._idle
        self._idle = False

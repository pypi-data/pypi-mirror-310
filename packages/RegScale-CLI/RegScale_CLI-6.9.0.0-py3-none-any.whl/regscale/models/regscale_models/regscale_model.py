...
class RegScaleModel(BaseModel, ABC):
    ...
    def __hash__(self) -> hash:
        ...
        :rtype: hash
        """
        return hash(tuple(tuple(getattr(self, field) for field in sublist) for sublist in self._unique_fields))
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return any(
            all(getattr(self, field) == getattr(other, field) for field in sublist) for sublist in self._unique_fields
        )

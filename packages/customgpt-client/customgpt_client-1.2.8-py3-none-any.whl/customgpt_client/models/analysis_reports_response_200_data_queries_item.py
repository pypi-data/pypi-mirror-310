...
T = TypeVar("T", bound="AnalysisReportsResponse200DataQueriesItem")


@attr.s(auto_attribs=True)
class AnalysisReportsResponse200DataQueriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        analysis_reports_response_200_data_queries_item = cls(
            queries_number=queries_number,
            created_at_interval=created_at_interval,
        )

        analysis_reports_response_200_data_queries_item.additional_properties = src_dict
        return analysis_reports_response_200_data_queries_item

...
T = TypeVar("T", bound="UpdateSourceResponse201DataSettings")


@attr.s(auto_attribs=True)
class UpdateSourceResponse201DataSettings:
    ...
    Attributes:
        executive_js (Union[Unset, bool]): Whether the project source should execute JavaScript Default: True. Example:
            True.
        data_refresh_frequency (Union[Unset, UpdateSourceResponse201DataSettingsDataRefreshFrequency]): The project
            source data refresh frequency Default: UpdateSourceResponse201DataSettingsDataRefreshFrequency.NEVER. Example:
            never.
        ...
        remove_unexist_pages (Union[Unset, bool]): Remove pages from project automatically during refresh project source
            Default: True.
        refresh_existing_pages (Union[Unset, UpdateSourceResponse201DataSettingsRefreshExistingPages]): Refresh existing
            page during refresh project source Default: UpdateSourceResponse201DataSettingsRefreshExistingPages.NEVER.
            Example: never.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_source_response_201_data_settings = cls(
        ...
        update_source_response_201_data_settings.additional_properties = src_dict
        return update_source_response_201_data_settings

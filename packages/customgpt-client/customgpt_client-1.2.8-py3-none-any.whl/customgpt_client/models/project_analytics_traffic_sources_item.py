...
T = TypeVar("T", bound="ProjectAnalyticsTrafficSourcesItem")


@attr.s(auto_attribs=True)
class ProjectAnalyticsTrafficSourcesItem:
    """
    Attributes:
        request_source (Union[Unset, ProjectAnalyticsTrafficSourcesItemRequestSource]):  Example: web.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_analytics_traffic_sources_item = cls(
            request_source=request_source,
            request_source_number=request_source_number,
        )

        project_analytics_traffic_sources_item.additional_properties = src_dict
        return project_analytics_traffic_sources_item

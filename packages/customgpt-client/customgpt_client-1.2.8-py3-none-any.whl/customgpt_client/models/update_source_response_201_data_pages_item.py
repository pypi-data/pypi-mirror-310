...
T = TypeVar("T", bound="UpdateSourceResponse201DataPagesItem")


@attr.s(auto_attribs=True)
class UpdateSourceResponse201DataPagesItem:
    r"""
    Attributes:
        ...
        crawl_status (Union[Unset, UpdateSourceResponse201DataPagesItemCrawlStatus]): Crawl status of the page Default:
            UpdateSourceResponse201DataPagesItemCrawlStatus.QUEUED. Example: queued.
        index_status (Union[Unset, UpdateSourceResponse201DataPagesItemIndexStatus]): Index status of the page Default:
            UpdateSourceResponse201DataPagesItemIndexStatus.QUEUED. Example: queued.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_source_response_201_data_pages_item = cls(
            id=id,
            page_url=page_url,
        ...
        update_source_response_201_data_pages_item.additional_properties = src_dict
        return update_source_response_201_data_pages_item

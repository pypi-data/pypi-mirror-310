...
T = TypeVar("T", bound="SynchronizeSourceResponse201DataSettings")


@attr.s(auto_attribs=True)
class SynchronizeSourceResponse201DataSettings:
    ...
    Attributes:
        executive_js (Union[Unset, bool]): Whether the project source should execute JavaScript Default: True. Example:
            True.
        data_refresh_frequency (Union[Unset, SynchronizeSourceResponse201DataSettingsDataRefreshFrequency]): The project
            source data refresh frequency Default: SynchronizeSourceResponse201DataSettingsDataRefreshFrequency.NEVER.
            Example: never.
        ...
        remove_unexist_pages (Union[Unset, bool]): Remove pages from project automatically during refresh project source
            Default: True.
        refresh_existing_pages (Union[Unset, SynchronizeSourceResponse201DataSettingsRefreshExistingPages]): Refresh
            existing page during refresh project source Default:
            SynchronizeSourceResponse201DataSettingsRefreshExistingPages.NEVER. Example: never.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        synchronize_source_response_201_data_settings = cls(
        ...
        synchronize_source_response_201_data_settings.additional_properties = src_dict
        return synchronize_source_response_201_data_settings

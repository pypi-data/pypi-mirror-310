...
T = TypeVar("T", bound="UpdateMetadataResponse200Data")


@attr.s(auto_attribs=True)
class UpdateMetadataResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_metadata_response_200_data = cls(
            id=id,
            url=url,
            title=title,
        ...
        update_metadata_response_200_data.additional_properties = src_dict
        return update_metadata_response_200_data

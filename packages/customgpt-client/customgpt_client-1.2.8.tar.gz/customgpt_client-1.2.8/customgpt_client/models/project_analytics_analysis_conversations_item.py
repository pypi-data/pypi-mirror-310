...
T = TypeVar("T", bound="ProjectAnalyticsAnalysisConversationsItem")


@attr.s(auto_attribs=True)
class ProjectAnalyticsAnalysisConversationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_analytics_analysis_conversations_item = cls(
            queries_number=queries_number,
            created_at_interval=created_at_interval,
        )

        project_analytics_analysis_conversations_item.additional_properties = src_dict
        return project_analytics_analysis_conversations_item

...
class ListSourcesResponse200DataSitemapsItemSettings:
    ...
    Attributes:
        executive_js (Union[Unset, bool]): Whether the project source should execute JavaScript Default: True. Example:
            True.
        data_refresh_frequency (Union[Unset, ListSourcesResponse200DataSitemapsItemSettingsDataRefreshFrequency]): The
            project source data refresh frequency Default:
            ListSourcesResponse200DataSitemapsItemSettingsDataRefreshFrequency.NEVER. Example: never.
        ...
        remove_unexist_pages (Union[Unset, bool]): Remove pages from project automatically during refresh project source
            Default: True.
        refresh_existing_pages (Union[Unset, ListSourcesResponse200DataSitemapsItemSettingsRefreshExistingPages]):
            Refresh existing page during refresh project source Default:
            ListSourcesResponse200DataSitemapsItemSettingsRefreshExistingPages.NEVER. Example: never.

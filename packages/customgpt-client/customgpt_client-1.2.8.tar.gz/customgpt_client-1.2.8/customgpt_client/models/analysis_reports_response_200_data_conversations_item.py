...
T = TypeVar("T", bound="AnalysisReportsResponse200DataConversationsItem")


@attr.s(auto_attribs=True)
class AnalysisReportsResponse200DataConversationsItem:
    """
    Attributes:
        queries_number (Union[Unset, int]):  Example: 5.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        analysis_reports_response_200_data_conversations_item = cls(
            queries_number=queries_number,
            created_at_interval=created_at_interval,
        )

        analysis_reports_response_200_data_conversations_item.additional_properties = src_dict
        return analysis_reports_response_200_data_conversations_item

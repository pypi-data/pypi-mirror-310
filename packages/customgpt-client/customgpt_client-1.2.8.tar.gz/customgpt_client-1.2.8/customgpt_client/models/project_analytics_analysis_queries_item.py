...
T = TypeVar("T", bound="ProjectAnalyticsAnalysisQueriesItem")


@attr.s(auto_attribs=True)
class ProjectAnalyticsAnalysisQueriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_analytics_analysis_queries_item = cls(
            queries_number=queries_number,
            created_at_interval=created_at_interval,
        )

        project_analytics_analysis_queries_item.additional_properties = src_dict
        return project_analytics_analysis_queries_item

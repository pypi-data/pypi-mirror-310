...
T = TypeVar("T", bound="ProjectAnalyticsConversation")


@attr.s(auto_attribs=True)
class ProjectAnalyticsConversation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_analytics_conversation = cls(
            total=total,
            average_queries_per_conversation=average_queries_per_conversation,
        )

        project_analytics_conversation.additional_properties = src_dict
        return project_analytics_conversation

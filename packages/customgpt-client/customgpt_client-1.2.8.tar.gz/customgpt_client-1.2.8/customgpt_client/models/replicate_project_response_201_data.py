...
T = TypeVar("T", bound="ReplicateProjectResponse201Data")


@attr.s(auto_attribs=True)
class ReplicateProjectResponse201Data:
    """
    Attributes:
        ...
        updated_at (Union[Unset, datetime.datetime]): Date and time when the project was last updated Default:
            isoparse('2023-05-08 13:06:55'). Example: 2021-01-01 00:00:00.
        type (Union[Unset, ReplicateProjectResponse201DataType]): Project type Default:
            ReplicateProjectResponse201DataType.SITEMAP. Example: SITEMAP.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        replicate_project_response_201_data = cls(
            id=id,
        ...
        replicate_project_response_201_data.additional_properties = src_dict
        return replicate_project_response_201_data

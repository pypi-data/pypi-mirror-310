...
T = TypeVar("T", bound="SynchronizeSourceResponse201DataPagesItem")


@attr.s(auto_attribs=True)
class SynchronizeSourceResponse201DataPagesItem:
    r"""
    Attributes:
        ...
        crawl_status (Union[Unset, SynchronizeSourceResponse201DataPagesItemCrawlStatus]): Crawl status of the page
            Default: SynchronizeSourceResponse201DataPagesItemCrawlStatus.QUEUED. Example: queued.
        index_status (Union[Unset, SynchronizeSourceResponse201DataPagesItemIndexStatus]): Index status of the page
            Default: SynchronizeSourceResponse201DataPagesItemIndexStatus.QUEUED. Example: queued.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        synchronize_source_response_201_data_pages_item = cls(
            id=id,
            page_url=page_url,
        ...
        synchronize_source_response_201_data_pages_item.additional_properties = src_dict
        return synchronize_source_response_201_data_pages_item

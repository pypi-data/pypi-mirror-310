...
class DataGenerator:
    def __init__(
        ...
        **kwargs,
        ...
        n_clusters : int, optional
            Number of clusters the latent factors, by default 1
    ...
    def generate(
        ...
        if self.n_clusters < 1:
            ...
            cluster_assignments = np.zeros(self.n_samples)
        else:
            z, cluster_assignments = make_blobs(
                self.n_samples,
                self.n_factors,
        ...
        for m in range(self.n_views):
            ...
            # sigma =  np.sqrt(rng.lognormal(0.0, 1.0, n_features))

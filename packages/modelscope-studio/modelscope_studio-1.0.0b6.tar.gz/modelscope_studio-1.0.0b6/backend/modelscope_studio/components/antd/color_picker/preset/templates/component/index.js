...
var de = K($, "WeakMap"), He = Object.create, Sn = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!B(t))
...
var ye = K($, "DataView"), be = K($, "Promise"), he = K($, "Set"), tt = "[object Map]", zi = "[object Object]", nt = "[object Promise]", rt = "[object Set]", it = "[object WeakMap]", ot = "[object DataView]", Hi = D(ye), qi = D(Y), Yi = D(be), Xi = D(he), Ji = D(de), P = N;
(ye && P(new ye(new ArrayBuffer(1))) != ot || Y && P(new Y()) != tt || be && P(be.resolve()) != nt || he && P(new he()) != rt || de && P(new de()) != it) && (P = function(e) {
...
function k(e, t, n, r, i, o) {
  ...
  var u = c ? l ? Kt : _e : l ? $e : J, g = p ? void 0 : u(e);
...
function zt(e, t, n, r, i, o) {
  ...
  if (c && p)
    return c == t && p == e;
  var d = -1, y = !0, b = n & fs ? new oe() : void 0;
...
var ps = 1, gs = 2, ds = "[object Boolean]", _s = "[object Date]", ys = "[object Error]", bs = "[object Map]", hs = "[object Number]", ms = "[object RegExp]", vs = "[object Set]", Ts = "[object String]", Os = "[object Symbol]", As = "[object ArrayBuffer]", Ps = "[object DataView]", lt = O ? O.prototype : void 0, pe = lt ? lt.valueOf : void 0;
...
function Cs(e, t, n, r, i, o) {
  var s = n & xs, a = _e(e), l = a.length, c = _e(t), p = c.length;
  if (l != p && !s)
    return !1;
  for (var d = l; d--; ) {
    var y = a[d];
...
function Es(e, t, n, r, i, o) {
  var s = w(e), a = w(t), l = s ? pt : P(e), c = a ? pt : P(t);
  ...
  return y ? (o || (o = new x()), Cs(e, t, n, r, i, o)) : !1;
}
...
function Fs(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (s[2]) {
      ...
      var p = new x(), d;
      if (!(d === void 0 ? Fe(c, l, Ms | Ls, r, p) : d))
        return !1;
    }
  }
  return !0;
...
function ha(e, t, n) {
  ...
  const a = Re(ya), l = ((y = F(a)) == null ? void 0 : y.as_item) || e.as_item, c = ge(a ? l ? ((b = F(a)) == null ? void 0 : b[l]) || {} : F(a) || {} : {}), p = (u, g) => u ? aa({
    ...u,
    ...g || {}
  }, t) : void 0, d = M({
    ...e,
  ...
  return a ? (a.subscribe((u) => {
    ...
    g && (u = u == null ? void 0 : u[g]), u = ge(u), d.update((f) => ({
      ...f,
      ...u || {},
...
function Ba(e, t, n) {
  ...
  const kt = Sa();
  return e.$$set = (_) => {
    t = _t(_t({}, t), Ma(_)), n(23, i = yt(t, r)), "gradio" in _ && n(5, d = _.gradio), "props" in _ && n(6, y = _.props), "_internal" in _ && n(7, u = _._internal), "colors" in _ && n(8, g = _.colors), "label" in _ && n(9, f = _.label), "default_open" in _ && n(10, m = _.default_open), "as_item" in _ && n(11, T = _.as_item), "visible" in _ && n(12, L = _.visible), "elem_id" in _ && n(13, S = _.elem_id), "elem_classes" in _ && n(14, C = _.elem_classes), "elem_style" in _ && n(15, W = _.elem_style), "$$scope" in _ && n(19, p = _.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    64 && b.update((_) => ({
      ..._,
    ...
    196609 && kt(a, s._internal.index || 0, {
      props: {
        style: s.elem_style,
        className: Pa(s.elem_classes, "ms-gr-antd-color-picker-preset"),
        id: s.elem_id,
        label: s.label,
        colors: s.colors,
  ...
  }, [s, b, Ne, De, Ke, d, y, u, g, f, m, T, L, S, C, W, o, a, l, p, c];
}
class qa extends Ca {
  constructor(t) {

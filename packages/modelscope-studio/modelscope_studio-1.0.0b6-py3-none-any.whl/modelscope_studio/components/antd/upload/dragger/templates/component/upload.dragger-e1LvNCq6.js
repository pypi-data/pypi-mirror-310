import { g as pe, w as S } from "./Index-B9Y56gXY.js";
  ...
  return {
    ...
    l(l) {
      t = V(l, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(t).forEach(U), r = Ee(l), n && n.l(l), s = z(), this.h();
    },
    h() {
      ee(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(l, [a]) {
      ...
      16 && F(n, 1)) : (n = H(l), n.c(), F(n, 1), n.m(s.parentNode, s)) : n && (Le(), T(n, 1, 1, () => {
        n = null;
      }), ge());
    },
    i(l) {
...
function j(e) {
  ...
  if (e._reactElement)
    return t.push(D(b.cloneElement(e._reactElement, {
...
const Ke = ae(({
  ...
  return fe(() => {
    ...
    if (t && window.MutationObserver) {
      let c = function() {
        var g, E, p;
        (g = n.current) != null && g.contains(i) && ((E = n.current) == null || E.removeChild(i));
        const {
          portals: f,
          clonedElement: I
        } = j(e);

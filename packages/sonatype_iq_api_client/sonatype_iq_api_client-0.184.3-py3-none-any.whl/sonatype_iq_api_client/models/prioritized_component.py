...
class PrioritizedComponent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "componentHash", "componentIdentifier", "dependencyType", "displayName", "hasFailActionOnComponent", "highestReachableThreat", "highestThreat", "highestThreatPolicyConstraintName", "highestThreatPolicyName", "priority", "remediationType", "remediationVersion", "securityReachable"]

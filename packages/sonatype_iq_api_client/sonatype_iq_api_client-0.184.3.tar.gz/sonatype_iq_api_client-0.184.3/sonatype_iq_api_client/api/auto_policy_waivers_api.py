...
class AutoPolicyWaiversApi:
    ...
    def add_auto_policy_waiver(
        ...
        api_auto_policy_waiver_dto: Annotated[ApiAutoPolicyWaiverDTO, Field(description="The request JSON can include the fields<ol><li>threatLevel</li><li>pathForward</li><li>reachable</li><li>durationInDays</li></ol>")],
        ...
        :type owner_id: str
        :param api_auto_policy_waiver_dto: The request JSON can include the fields<ol><li>threatLevel</li><li>pathForward</li><li>reachable</li><li>durationInDays</li></ol> (required)
    ...
    def update_auto_policy_waiver(
        ...
        api_auto_policy_waiver_dto: Annotated[ApiAutoPolicyWaiverDTO, Field(description="The request JSON can include the fields<ol><li>autoPolicyWaiverId</li><li>threatLevel</li><li>pathForward</li><li>reachable</li><li>durationInDays</li></ol>")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type auto_policy_waiver_id: str
        :param api_auto_policy_waiver_dto: The request JSON can include the fields<ol><li>autoPolicyWaiverId</li><li>threatLevel</li><li>pathForward</li><li>reachable</li><li>durationInDays</li></ol> (required)
        :type api_auto_policy_waiver_dto: ApiAutoPolicyWaiverDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of

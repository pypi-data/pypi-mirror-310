...
class SourceControlApi:
    ...
    def automatic_role_assignment(
        ...
        Use this method to automatically grant the 'developer' role to all contributors of a repository on a given application.  Prerequisites for automatic role assignment are:<ol><li>SCM configuration for the application and authentication token should exist.</li><li>The contributors to the repository should have a matching username in IQ.</li></ol>  Permissions required: Edit access control on the application.

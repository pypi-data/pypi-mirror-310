...
class ApiAutoPolicyWaiverDTO(BaseModel):
    ...
    reachable: Optional[StrictBool] = None
    threat_level: Optional[StrictInt] = Field(default=None, alias="threatLevel")
    __properties: ClassVar[List[str]] = ["autoPolicyWaiverId", "createTime", "creatorId", "creatorName", "ownerId", "pathForward", "reachable", "threatLevel"]

...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "delete",
        "url": "/projects/{project_id}/locations/{location_id}/comments/{comment_id}/likes/{like_id}".format(project_id=project_id,location_id=location_id,comment_id=comment_id,like_id=like_id,),
        "params": params,
    }

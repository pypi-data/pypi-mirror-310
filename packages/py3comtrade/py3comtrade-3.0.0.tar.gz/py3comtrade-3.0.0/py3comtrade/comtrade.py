...
from py3comtrade.computation.calculator import Calculator
...
class Comtrade:
    ...
    def calc_channel_data(self, analog: Analog, site_point: int = 0, cycle_num: float = None, mode: int = 1, primary: bool = False) -> Calculator:
        vs = self.get_instant_samples_by_analog(analog, start_point=site_point, cycle_num=cycle_num, mode=mode, primary=primary)
        return Calculator(vs[0])

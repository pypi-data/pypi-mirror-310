...
class gasket_thermal_closure(Operator):
    """Read/compute elemental gasket thermal closure by calling the readers
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket thermal closure by calling the readers
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGasketThermalClosure
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGasketThermalClosure
        """

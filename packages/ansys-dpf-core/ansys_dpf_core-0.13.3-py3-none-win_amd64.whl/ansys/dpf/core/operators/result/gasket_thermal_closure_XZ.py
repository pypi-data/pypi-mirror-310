...
class gasket_thermal_closure_XZ(Operator):
    """Read/compute elemental gasket thermal closure XZ shear component (02
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket thermal closure XZ shear component (02
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGasketThermalClosureXz
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGasketThermalClosureXz
        """

...
class gasket_thermal_closure_X(Operator):
    """Read/compute elemental gasket thermal closure XX normal component (00
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket thermal closure XX normal component (00
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGasketThermalClosureX
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGasketThermalClosureX
        """

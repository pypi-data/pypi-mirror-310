...
class gasket_stress_XY(Operator):
    """Read/compute elemental gasket stress XY shear component (01 component)
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket stress XY shear component (01 component)

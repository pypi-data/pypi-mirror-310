...
class gasket_stress_XZ(Operator):
    """Read/compute elemental gasket stress XZ shear component (02 component)
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket stress XZ shear component (02 component)

...
class plastic_strain_intensity(Operator):
    """Reads/computes element nodal component plastic strains, average it on
    ...
    @staticmethod
    def _spec():
        description = """Reads/computes element nodal component plastic strains, average it on
            nodes (by default) and computes its invariants."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsPlasticStrainIntensity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsPlasticStrainIntensity
        """

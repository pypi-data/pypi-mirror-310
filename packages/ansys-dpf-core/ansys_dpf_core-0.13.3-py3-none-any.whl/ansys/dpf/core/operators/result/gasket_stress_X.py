...
class gasket_stress_X(Operator):
    """Read/compute elemental gasket stress XX normal component (00
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket stress XX normal component (00

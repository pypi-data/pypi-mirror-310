...
class gasket_thermal_closure_XY(Operator):
    """Read/compute elemental gasket thermal closure XY shear component (01
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket thermal closure XY shear component (01
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGasketThermalClosureXy
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGasketThermalClosureXy
        """

...
class rescope_custom_type_field(Operator):
    """Rescopes a custom type field on the given scoping. If an ID does not
    exist in the original custom type field, the default value (in 2)
    ...
    @staticmethod
    def _spec():
        description = """Rescopes a custom type field on the given scoping. If an ID does not
            exist in the original custom type field, the default value
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsRescopeCustomTypeField
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsRescopeCustomTypeField
        """
...
class InputsRescopeCustomTypeField(_Inputs):
    ...
    def fields(self):
        ...
        Parameters
        ----------
        my_fields : CustomTypeFieldsContainer or CustomTypeField
    ...
    def default_value(self):
        ...
        Parameters
        ----------
        my_default_value : CustomTypeField or CustomTypeField

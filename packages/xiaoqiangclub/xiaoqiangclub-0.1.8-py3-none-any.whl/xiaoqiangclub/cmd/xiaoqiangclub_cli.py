...
def main():
    ...
    project_template.add_argument('-n', '--name', type=str, default='demo', help='项目名称，默认为demo')
    ...
    docker_template.add_argument('-n', '--name', type=str, default='git_auto_runner',
                                 help='项目名称：git_auto_runner\n默认为：git_auto_runner')  # 使用多行字符串
    docker_template.add_argument('-d', '--directory', type=str, default=None, help='项目路径，默认为当前目录')

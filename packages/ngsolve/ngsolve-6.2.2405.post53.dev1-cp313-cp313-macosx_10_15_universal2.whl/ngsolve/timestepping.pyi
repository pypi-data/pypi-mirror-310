...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfu_old', 'c', '_lin_solver_cls', 'dt', 'time', '_lin_solver_args', 'bfmstar')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfu_old', 'c', '_lin_solver_cls', 'dt', 'time', 'gfa_old', 'gfv_old', '_lin_solver_args', 'bfmstar')

...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'norm', 'innerproduct', 'restart')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'residuals', 'display', 'fig', 'plt', 'atol', 'ress', 'printrates', 'callback_sol', '_final_residual', 'mat', 'callback', 'clear_output', 'pre', 'plotrates', 'tol', 'ax', 'its', 'maxiter', 'sol')
